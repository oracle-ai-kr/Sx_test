...
(function(){
  ...
  function _poolBlock(){
    return '<div style="margin-top:8px"><button onclick="window.SXCandleBT&&SXCandleBT.runPoolCompareUI()" style="width:100%;font-size:11px;font-weight:700;padding:8px 0;border-radius:8px;cursor:pointer;color:#0ea5e9;background:var(--surface);border:1px solid #0ea5e966">🌐 다종목 풀링 뱅크 비교 (실험)</button><div id="sxPoolResult" style="margin-top:6px"></div></div>';
  }
  ...
  window.SXCandleBT = { open: open, close: _close, setThr: setThr, setKnnWin: setKnnWin, setKnnK: setKnnK, setKnnGate: setKnnGate, runKnnGrid: runKnnGrid, downloadKnnJson: downloadKnnJson, run: runBacktest, runBasket: runBasket, runBasketUI: runBasketUI, runPoolCompareUI: runPoolCompareUI, runPoolCompare: runPoolCompare, backToSingle: backToSingle, _remove: _removeOverlay };
})();
