// ════════════════════════════════════════════════════════════════
//  sx_candle_bt.js  —  [S525] 캔들 전이 미니 백테스트  (+[S530] 뒤로가기 닫기·임계값 선택)  (+[S601] 자기유사도 kNN 대안경로 비교)  (+[S603] kNN 창길이/K 토글 A/B)  (+[S604] 9조합 자동탐색·JSON 다운로드) (+[S605] 랭킹 게이트+가중에지 정렬) (+[S606] 기본 16×10) (+[S607] 룰+kNN 블렌드) (+[S608] 이웃 품질 게이팅)
...
(function(){
  ...
  // [S607] 블렌드 카드 — 룰·kNN 점수 평균. 룰/kNN/블렌드 3자 비교(승자 강조).
  ...
  window.SXCandleBT = { open: open, close: _close, setThr: setThr, setKnnWin: setKnnWin, setKnnK: setKnnK, setKnnGate: setKnnGate, runKnnGrid: runKnnGrid, downloadKnnJson: downloadKnnJson, run: runBacktest, runBasket: runBasket, runBasketUI: runBasketUI, backToSingle: backToSingle, _remove: _removeOverlay };
})();
