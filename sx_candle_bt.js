...
(function(){
  ...
  window.SXCandleBT = { open: open, close: _close, setThr: setThr, setKnnWin: setKnnWin, setKnnK: setKnnK, setKnnGate: setKnnGate, runKnnGrid: runKnnGrid, downloadKnnJson: downloadKnnJson, run: runBacktest, runBasket: runBasket, runBasketUI: runBasketUI, runPoolCompareUI: runPoolCompareUI, runPoolCompare: runPoolCompare, runPoolVerifyUI: runPoolVerifyUI, runPoolVerify: runPoolVerify, backToSingle: backToSingle, _remove: _removeOverlay };
})();
