// ════════════════════════════════════════════════════════════════
//  sx_candle_bt.js  —  [S525] 캔들 전이 미니 백테스트  (+[S530] 뒤로가기 닫기·임계값 선택)  (+[S601] 자기유사도 kNN 대안경로 비교)  (+[S603] kNN 창길이/K 토글 A/B)
...
(function(){
  ...
  function open(){
    ...
    setTimeout(function(){
      _curThr = 30; _knnWin = 8; _knnK = 25;   // [S603] kNN 토글 기본값 리셋
  ...
  window.SXCandleBT = { open: open, close: _close, setThr: setThr, setKnnWin: setKnnWin, setKnnK: setKnnK, run: runBacktest, runBasket: runBasket, runBasketUI: runBasketUI, backToSingle: backToSingle, _remove: _removeOverlay };
})();
