...
(function(){
  ...
  (typeof self !== 'undefined' ? self : window).SXKNN = { score:score, scoreAt:scoreAt, backtestHit:backtestHit, buildVecs:buildVecs, buildPoolBank:buildPoolBank, scorePooled:scorePooled, _dnum:_dnum, _vec:_vec, WIN:WIN, K:K, MIN_BANK:MIN_BANK, WINS:[8,12,16], KS:[10,25,50] };
})();
