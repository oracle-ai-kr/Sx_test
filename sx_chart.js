// ════════════════════════════════════════════════════════════
//  SX Chart Module v1.3 — S87: drawScoreSpark(구간분포추이) + drawDeltaBar(모멘텀바차트) + drawScoreGauge(미니게이지) 추가
...
return { drawMini: drawMini, openFull: openFull, closeFull: closeFull, drawFinBar: drawFinBar, drawFinTrend: drawFinTrend, drawScoreSpark: drawScoreSpark, drawDeltaBar: drawDeltaBar, drawScoreGauge: drawScoreGauge };
})();
