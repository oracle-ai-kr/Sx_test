...
(function(global){
  ...
  function _count4axisPass(scores, momDir, entryGate){
    ...
    var rebound = 0; var _cv2on=((typeof globalThis!=='undefined')&&globalThis.SX_CV2_AXES&&scores.cv2); var _rdS=_cv2on?(scores.cv2.ready||0):(scores.readyScore||0); var _enS=_cv2on?(scores.cv2.entry||0):(scores.entryScore||0);   // [S892] SX_CV2_AXES 토글 ON=레시피 접지 점수(cv2)로 반등 판정 · OFF(기본)=엔진 원점수
    if(_rs){
