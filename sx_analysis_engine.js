...
const SCR_ANAL_MARKET_DEFAULTS = {
  ...
  us:     { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:54, sellTh:10, tpMult:3.7, slMult:0.5 },
...
const SCR_ANAL_MARKET_REGIME_DEFAULTS = {
  ...
  us: {
    on:  { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:54, sellTh:10, tpMult:3.7, slMult:0.5 },
    off: { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:54, sellTh:10, tpMult:3.7, slMult:0.5 }
  },
  crypto: {
