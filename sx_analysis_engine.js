...
const SCR_ANAL_MARKET_DEFAULTS = {
  ...
  kr:     { rsiLen:14, bbLen:11, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:42, sellTh:8, tpMult:2.5, slMult:1.5 },
  us:     { rsiLen:14, bbLen:23, bbMult:1.8, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:48, sellTh:8, tpMult:2.5, slMult:1.6 },
  crypto: { rsiLen:14, bbLen:10, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:32, sellTh:8, tpMult:3.0, slMult:1.8 }
};
// S211: 시장×레짐 6개 조합별 기본값
// [S212] 단기·스윙 + 밸런스형 추천값 적용
//   ON  슬롯: 추천값 (추세장 진입)
//   OFF 슬롯: 보수적 변형 (횡보·약세장에서는 buyTh 살짝 ↑, slMult 살짝 ↑)
const SCR_ANAL_MARKET_REGIME_DEFAULTS = {
  kr: {
    on:  { rsiLen:14, bbLen:11, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:42, sellTh:8, tpMult:2.5, slMult:1.5 },
    off: { rsiLen:14, bbLen:14, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:46, sellTh:6, tpMult:2.25, slMult:1.6 }
  },
  us: {
    on:  { rsiLen:14, bbLen:23, bbMult:1.8, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:48, sellTh:8, tpMult:2.5, slMult:1.6 },
    off: { rsiLen:14, bbLen:26, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:52, sellTh:6, tpMult:2.25, slMult:1.7 }
  },
  crypto: {
    on:  { rsiLen:14, bbLen:10, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:32, sellTh:8, tpMult:3.0, slMult:1.8 },
    off: { rsiLen:14, bbLen:12, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:36, sellTh:6, tpMult:2.75, slMult:1.9 }
  }
};
