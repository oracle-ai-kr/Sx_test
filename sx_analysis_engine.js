...
const SCR_ANAL_MARKET_DEFAULTS = {
  ...
  kr:     { rsiLen:14, bbLen:14, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:53, sellTh:39, tpMult:3.9, slMult:0.8 },
  us:     { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:54, sellTh:10, tpMult:3.7, slMult:1.1 },
  crypto: { rsiLen:14, bbLen:9,  bbMult:2.1, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:43, sellTh:26, tpMult:5.3, slMult:0.6 }
};
...
const SCR_ANAL_MARKET_REGIME_DEFAULTS = {
  kr: {
    on:  { rsiLen:14, bbLen:14, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:53, sellTh:39, tpMult:3.9, slMult:0.8 },
    off: { rsiLen:14, bbLen:14, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:53, sellTh:39, tpMult:3.9, slMult:0.8 }
  },
  us: {
    on:  { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:54, sellTh:10, tpMult:3.7, slMult:1.1 },
    off: { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:54, sellTh:10, tpMult:3.7, slMult:1.1 }
  },
  crypto: {
    on:  { rsiLen:14, bbLen:9,  bbMult:2.1, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:43, sellTh:26, tpMult:5.3, slMult:0.6 },
    off: { rsiLen:14, bbLen:9,  bbMult:2.1, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:43, sellTh:26, tpMult:6.3, slMult:0.6 }
  }
};
...
SXE._btEarlyExit = (function(){
  ...
  // [S217] 기본값 변경 — 사용자 검증 패턴 반영 (전부 ON + 트레일 진입즉시)
  //   〔이력〕 이전: enabled:false, time:false, trailMode:'profit' (수정됨)
  //   현재: enabled:true (마스터 ON), 4룰 모두 ON, 트레일 진입즉시 (손실도 빠르게 차단)
  return {
    ...
    time:      true,   // maxBars 보유 + 수익률 < timeMinPnl%
    // 파라미터
    trailMult: 1.0,    // 트레일링 거리 (×ATR)
    trailMode: 'immediate', // 'immediate' = 진입 즉시 트레일링 / 'profit' = 수익권 진입 후 작동
