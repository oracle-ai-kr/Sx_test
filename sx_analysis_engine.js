...
// S100: 3모드별 기본 하드코딩 (임계값은 추후 개별 조정)
const SCR_ANAL_MODE_DEFAULTS = {
  profit:   { rsiLen: 14, bbLen: 20, bbMult: 2.0, maShort: 0, maMid: 0, maLong: 0, atrLen: 14, buyTh: 0, sellTh: 0, tpMult: 0, slMult: 0 },
  balanced: { rsiLen: 14, bbLen: 20, bbMult: 2.0, maShort: 0, maMid: 0, maLong: 0, atrLen: 14, buyTh: 0, sellTh: 0, tpMult: 0, slMult: 0 },
  safe:     { rsiLen: 14, bbLen: 20, bbMult: 2.0, maShort: 0, maMid: 0, maLong: 0, atrLen: 14, buyTh: 0, sellTh: 0, tpMult: 0, slMult: 0 }
};
