// ════════════════════════════════════════════════════════════
//  SIGNAL X — Analysis Engine v3.1 <!-- S73 -->
//  S73: crossCorrelation 종목간 상관/분산 경고 + sectorRadar 섹터 레이더 (5축④)
...
function sxRunBtEngine(rawRows, tf, params, opts = {}) {
  ...
  const baseTpMult = params.tpMult ?? 2.5;
  const baseSlMult = params.slMult ?? 1.5;
