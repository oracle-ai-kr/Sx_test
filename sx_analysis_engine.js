...
const SCR_ANAL_MARKET_DEFAULTS = {
  ...
  us:     { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:54, sellTh:10, tpMult:4.7, slMult:1.1 },
  crypto: { rsiLen:14, bbLen:9,  bbMult:2.1, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:43, sellTh:26, tpMult:6.3, slMult:0.6 }
};
...
const SCR_ANAL_MARKET_REGIME_DEFAULTS = {
  ...
  us: {
    on:  { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:54, sellTh:10, tpMult:4.7, slMult:1.1 },
    off: { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:54, sellTh:10, tpMult:4.7, slMult:1.1 }
  },
  crypto: {
    on:  { rsiLen:14, bbLen:9,  bbMult:2.1, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:43, sellTh:26, tpMult:6.3, slMult:0.6 },
