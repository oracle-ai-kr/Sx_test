// ════════════════════════════════════════════════════════════
//  SIGNAL X — Analysis Engine v4.1 <!-- S101 -->
...
// S101: 3모드 × 2레짐 = 6개 기본 하드코딩 (옵티마이저 실측 검증값 — JSON 기반)
// 공통: MA 5/20/60, RSI 14, ATR 14, SELL 5 (step=0 고정 파라미터)
const SCR_ANAL_MODE_DEFAULTS = {
  // 레짐 무관 fallback — 각 모드 score 높은 쪽
  profit:   { rsiLen:14, bbLen:10, bbMult:1.8, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:31, sellTh:5, tpMult:3.1, slMult:1.7 }, // OFF score 59.42
  balanced: { rsiLen:14, bbLen:11, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:42, sellTh:5, tpMult:2.5, slMult:1.5 }, // ON  score 57.47
...
// S101: 모드×레짐 6개 조합별 기본값 (JSON 실측치 반영)
const SCR_ANAL_MODE_REGIME_DEFAULTS = {
  profit: {
    ...
    off: { rsiLen:14, bbLen:10, bbMult:1.8, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:31, sellTh:5, tpMult:3.1, slMult:1.7 }
  },
  balanced: {
    on:  { rsiLen:14, bbLen:11, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:42, sellTh:5, tpMult:2.5, slMult:1.5 },
    off: { rsiLen:14, bbLen:27, bbMult:1.8, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:30, sellTh:5, tpMult:2.5, slMult:1.5 }
  },
  safe: {
