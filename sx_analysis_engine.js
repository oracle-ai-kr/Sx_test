...
const SCR_ANAL_MARKET_DEFAULTS = {
  // [v3.24-defaults] 시장 특성 + 코드 정합성 + 트레이딩 표준 기반 재설정
  //   기존: 임의 설정값 (저작 초기 추정치)
  //   변경 근거:
  ...
  kr:     { rsiLen:14, bbLen:14, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:45, sellTh:38, tpMult:2.5, slMult:1.5 },
  us:     { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:48, sellTh:38, tpMult:2.4, slMult:1.4 },
  crypto: { rsiLen:14, bbLen:9,  bbMult:2.1, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:38, sellTh:38, tpMult:2.8, slMult:1.7 }
};
// S211: 시장×레짐 6개 조합별 기본값
// [v3.24-defaults] 시장 특성 기반 재조정 — 기존 임의값 → 정합성 있는 표준값
//   ON  슬롯: 추세장 진입 (적극)
//   OFF 슬롯: 횡보/약세장 (보수: buyTh ↑, sellTh ↓, tpMult ↓, slMult ↑)
//   sellTh ON 38 / OFF 35 통일 (v3.17 fix 호환)
const SCR_ANAL_MARKET_REGIME_DEFAULTS = {
  kr: {
    on:  { rsiLen:14, bbLen:14, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:45, sellTh:38, tpMult:2.5, slMult:1.5 },
    off: { rsiLen:14, bbLen:14, bbMult:1.9, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:49, sellTh:35, tpMult:2.3, slMult:1.6 }
  },
  us: {
    on:  { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:48, sellTh:38, tpMult:2.4, slMult:1.4 },
    off: { rsiLen:14, bbLen:20, bbMult:2.0, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:52, sellTh:35, tpMult:2.2, slMult:1.5 }
  },
  crypto: {
    on:  { rsiLen:14, bbLen:9,  bbMult:2.1, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:38, sellTh:38, tpMult:2.8, slMult:1.7 },
    off: { rsiLen:14, bbLen:9,  bbMult:2.1, maShort:5, maMid:20, maLong:60, atrLen:14, buyTh:42, sellTh:35, tpMult:2.6, slMult:1.8 }
  }
};
