...
//  [S717] 반등 2축(aReady=①반등신호·aEntry=②반등강도·aRebound=C 반등경로·aGateRebound=H1 반등매수) — readyScore/entryScore qs서 무료. 베이스 6축 감사 완성.
...
(function () {
  ...
  var PREDICTORS = {
    ...
    aReady: {       // ①반등신호 — scrReadyScore≥60 (지지선 근접 + 반전캔들 등)
      id: 'aReady', label: '⚙반등신호(ready≥60)', eng: true,
      fire: function (c, t, p) { var e = _engAt(c, t, p); return !!(e && e.readyScore >= 60); }
    },
    aEntry: {       // ②반등강도 — scrEntryScore≥60
      id: 'aEntry', label: '⚙반등강도(entry≥60)', eng: true,
  ...
  var SXUV = {
    ...
    entryBreakdown: _entryBreakdown,   // [S723] 반등강도 재료 분해
