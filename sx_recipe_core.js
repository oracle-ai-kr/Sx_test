...
// [S865] 세트 전면 교체 — S864 지평렌즈 빔서치(스냅샷 20260701) + 통일 등록표준: 기간반분 부호일치(h1·h2·각 n≥10) + fake Δ렌즈≥5%p + 다양성(J≥0.5 클러스터당 4) + 상한130. 구세트(991개·혼재혈통)는 sx_recipes_backup_S862_20260702.json 백업. src에 lens/retLens/h1/h2 확장(표시 호환 유지).
  // [S849] 레시피 3시장 분리 — 시장특성이 달라 세트 비혼용. kr=기존311(확장풀 v34 유산)+발굴풀 신규55(중복13 제외) / us·coin=발굴풀 스냅샷(20260701) 전용. 소비처는 _R()(currentMarket 기준) 또는 recipesFor(mk). 등록 표준: 게이트(S848 상대화) + n≥30 + fake ΔN10≥5%p + 카테고리 상한 130. [S1476] coin 한정 세대 추가 — 신재료(ma51020)·3창 union·선언 게이트(real n≥50/fake n≥30·h1n/h2n≥10·Δ렌즈(기저 대비)≥5%p·다양성 J≥0.5 cap4)·Δ내림차순 상위 40/카테고리·src.win 각인·구재료 세대(deadcat·pullback)와 병존.
var RECIPES_BY_MKT = {
  kr: [
  ...
  // ── bullrun · real — [S1476] 신재료(ma51020) 세대 3창 union(스냅0830·창A 2023-04-15·창B 2021-08-16)·선언 게이트(n≥50·h1n/h2n≥10·Δ렌즈≥5%p·J0.5 cap4)·Δ내림차순 상위 40개 ──
  {"id": "br_r_G01", "pool": "bullrun", "kind": "real", "mode": "and", "label": "Stoch %K>85.68 + MA120 이격도%<-11.74 + MFI(자금흐름)>86.72", "conds": [{"key": "stochK", "type": "num", "dir": "gt", "th": 85.68}, {"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "mfi", "type": "num", "dir": "gt", "th": 86.72}], "src": {"n": 90, "late": 0.1077, "n10": 0.9111, "surv": 0.8456, "lens": 0.9444, "retLens": 0.1077, "h1": 0.7, "h2": 0.97, "win": "vin_A"}},
  {"id": "br_r_G02", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + MFI(자금흐름)>86.72 + 저항선 근접", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "mfi", "type": "num", "dir": "gt", "th": 86.72}, {"key": "nearRes", "type": "bin"}], "src": {"n": 93, "late": 0.1032, "n10": 0.9032, "surv": 0.8269, "lens": 0.9355, "retLens": 0.1032, "h1": 0.64, "h2": 0.98, "win": "vin_A"}},
  {"id": "br_r_G03", "pool": "bullrun", "kind": "real", "mode": "and", "label": "RSI>68.26 + 골든크로스 5×60 + 일목 음운", "conds": [{"key": "rsi", "type": "num", "dir": "gt", "th": 68.26}, {"key": "gx5_60", "type": "bin"}, {"key": "ichiCloudBear", "type": "bin"}], "src": {"n": 87, "late": 0.0773, "n10": 0.8966, "surv": 0.7115, "lens": 0.9195, "retLens": 0.0773, "h1": 0.45, "h2": 0.99, "win": "vin_A"}},
  {"id": "br_r_G04", "pool": "bullrun", "kind": "real", "mode": "and", "label": "RSI>68.26 + MACD 영선위 + 일목 음운", "conds": [{"key": "rsi", "type": "num", "dir": "gt", "th": 68.26}, {"key": "macdAbove0", "type": "bin"}, {"key": "ichiCloudBear", "type": "bin"}], "src": {"n": 145, "late": 0.0729, "n10": 0.8966, "surv": 0.7193, "lens": 0.9172, "retLens": 0.0729, "h1": 0.47, "h2": 0.97, "win": "vin_A"}},
  {"id": "br_r_G05", "pool": "bullrun", "kind": "real", "mode": "and", "label": "거래량 OSC>61.87 + Stoch %K>85.68 + MA120 이격도%<-11.74", "conds": [{"key": "volOsc", "type": "num", "dir": "gt", "th": 61.87}, {"key": "stochK", "type": "num", "dir": "gt", "th": 85.68}, {"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}], "src": {"n": 83, "late": 0.1021, "n10": 0.8916, "surv": 0.7964, "lens": 0.9157, "retLens": 0.1021, "h1": 0.56, "h2": 1, "win": "vin_A"}},
  {"id": "br_r_G06", "pool": "bullrun", "kind": "real", "mode": "and", "label": "RSI>68.26 + 일목 전환>기준 + 일목 음운", "conds": [{"key": "rsi", "type": "num", "dir": "gt", "th": 68.26}, {"key": "ichiTK", "type": "bin"}, {"key": "ichiCloudBear", "type": "bin"}], "src": {"n": 139, "late": 0.0681, "n10": 0.8921, "surv": 0.7158, "lens": 0.9137, "retLens": 0.0681, "h1": 0.46, "h2": 0.96, "win": "vin_A"}},
  {"id": "br_r_G07", "pool": "bullrun", "kind": "real", "mode": "and", "label": "RSI>68.26 + 돌파+거래량동반 + 일목 음운", "conds": [{"key": "rsi", "type": "num", "dir": "gt", "th": 68.26}, {"key": "volBreak", "type": "bin"}, {"key": "ichiCloudBear", "type": "bin"}], "src": {"n": 120, "late": 0.0717, "n10": 0.8833, "surv": 0.7175, "lens": 0.9083, "retLens": 0.0717, "h1": 0.47, "h2": 0.97, "win": "vin_A"}},
  {"id": "br_r_G08", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + 저점 lower-low + 일목 양운", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "swingLL", "type": "bin"}, {"key": "ichiCloudBull", "type": "bin"}], "src": {"n": 172, "late": 0.0692, "n10": 0.8837, "surv": 0.7767, "lens": 0.907, "retLens": 0.0692, "h1": 0.93, "h2": 0.77, "win": "vin_A"}},
  {"id": "br_r_G09", "pool": "bullrun", "kind": "real", "mode": "and", "label": "거래량 OSC>61.87 + RSI>68.26 + MA120 이격도%<-11.74", "conds": [{"key": "volOsc", "type": "num", "dir": "gt", "th": 61.87}, {"key": "rsi", "type": "num", "dir": "gt", "th": 68.26}, {"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}], "src": {"n": 85, "late": 0.0829, "n10": 0.9059, "surv": 0.7482, "lens": 0.9059, "retLens": 0.0829, "h1": 0.53, "h2": 1, "win": "vin_A"}},
  {"id": "br_r_G10", "pool": "bullrun", "kind": "real", "mode": "and", "label": "거래량 OSC>61.87 + MA120 이격도%<-11.74 + 저항선 근접", "conds": [{"key": "volOsc", "type": "num", "dir": "gt", "th": 61.87}, {"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "nearRes", "type": "bin"}], "src": {"n": 94, "late": 0.0973, "n10": 0.8723, "surv": 0.783, "lens": 0.9043, "retLens": 0.0973, "h1": 0.58, "h2": 0.99, "win": "vin_A"}},
  {"id": "br_r_G11", "pool": "bullrun", "kind": "real", "mode": "and", "label": "거래량 OSC<-33.7 + MA200 이격도%<-40.41 + 저점 lower-low", "conds": [{"key": "volOsc", "type": "num", "dir": "lt", "th": -33.7}, {"key": "dev200", "type": "num", "dir": "lt", "th": -40.41}, {"key": "swingLL", "type": "bin"}], "src": {"n": 53, "late": 0.025, "n10": 0.6792, "surv": 0.6358, "lens": 0.7358, "retLens": 0.025, "h1": 0.88, "h2": 0.61, "win": "snap"}},
  {"id": "br_r_G12", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + 일목 구름위 + 저점 lower-low", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "ichiCloudUp", "type": "bin"}, {"key": "swingLL", "type": "bin"}], "src": {"n": 232, "late": 0.0678, "n10": 0.8966, "surv": 0.7461, "lens": 0.9009, "retLens": 0.0678, "h1": 0.88, "h2": 0.98, "win": "vin_A"}},
  {"id": "br_r_G13", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + VR(거래량비율)>476.22 + 골든크로스 5×60", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "vr", "type": "num", "dir": "gt", "th": 476.22}, {"key": "gx5_60", "type": "bin"}], "src": {"n": 50, "late": 0.1177, "n10": 0.92, "surv": 0.758, "lens": 0.9, "retLens": 0.1177, "h1": 0.71, "h2": 0.97, "win": "vin_A"}},
  {"id": "br_r_G14", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + MFI(자금흐름)>86.72 + 가격채널 상단돌파", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "mfi", "type": "num", "dir": "gt", "th": 86.72}, {"key": "pcUp", "type": "bin"}], "src": {"n": 70, "late": 0.0771, "n10": 0.9, "surv": 0.7857, "lens": 0.9, "retLens": 0.0771, "h1": 0.45, "h2": 0.98, "win": "vin_A"}},
  {"id": "br_r_G15", "pool": "bullrun", "kind": "real", "mode": "and", "label": "ADX<17.03 + MA200 이격도%<-40.41 + 일목 전환<기준", "conds": [{"key": "adx", "type": "num", "dir": "lt", "th": 17.03}, {"key": "dev200", "type": "num", "dir": "lt", "th": -40.41}, {"key": "ichiTKDn", "type": "bin"}], "src": {"n": 56, "late": 0.0509, "n10": 0.7143, "surv": 0.6286, "lens": 0.7321, "retLens": 0.0509, "h1": 0.57, "h2": 0.79, "win": "snap"}},
  {"id": "br_r_G16", "pool": "bullrun", "kind": "real", "mode": "and", "label": "거래량 OSC>61.87 + MA120 이격도%<-11.74 + 일목 구름위", "conds": [{"key": "volOsc", "type": "num", "dir": "gt", "th": 61.87}, {"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "ichiCloudUp", "type": "bin"}], "src": {"n": 206, "late": 0.0868, "n10": 0.8544, "surv": 0.733, "lens": 0.8981, "retLens": 0.0868, "h1": 0.8, "h2": 0.98, "win": "vin_A"}},
  {"id": "br_r_G17", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + 골든크로스 5×60 + 삼선전환 반전", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "gx5_60", "type": "bin"}, {"key": "tlbRev", "type": "bin"}], "src": {"n": 74, "late": 0.0568, "n10": 0.8649, "surv": 0.7149, "lens": 0.8919, "retLens": 0.0568, "h1": 0.87, "h2": 0.95, "win": "vin_A"}},
  {"id": "br_r_G18", "pool": "bullrun", "kind": "real", "mode": "and", "label": "거래량 OSC>61.87 + MA60 이격도%>-2.98 + MA120 이격도%<-11.74", "conds": [{"key": "volOsc", "type": "num", "dir": "gt", "th": 61.87}, {"key": "dev60", "type": "num", "dir": "gt", "th": -2.98}, {"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}], "src": {"n": 328, "late": 0.0933, "n10": 0.8659, "surv": 0.7521, "lens": 0.8902, "retLens": 0.0933, "h1": 0.8, "h2": 0.97, "win": "vin_A"}},
  {"id": "br_r_G19", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA20 이격도%<3.99 + MFI(자금흐름)<58.92 + MA 수렴", "conds": [{"key": "dev20", "type": "num", "dir": "lt", "th": 3.99}, {"key": "mfi", "type": "num", "dir": "lt", "th": 58.92}, {"key": "maConv", "type": "bin"}], "src": {"n": 64, "late": 0.0155, "n10": 0.7031, "surv": 0.6, "lens": 0.7188, "retLens": 0.0155, "h1": 0.57, "h2": 0.76, "win": "snap"}},
  {"id": "br_r_G20", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA20 이격도%<3.99 + PSAR 하락 + MA 수렴", "conds": [{"key": "dev20", "type": "num", "dir": "lt", "th": 3.99}, {"key": "sarBear", "type": "bin"}, {"key": "maConv", "type": "bin"}], "src": {"n": 60, "late": 0.0212, "n10": 0.7167, "surv": 0.6183, "lens": 0.7167, "retLens": 0.0212, "h1": 0.38, "h2": 0.81, "win": "snap"}},
  {"id": "br_r_G21", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + 저점 lower-low + MACD 영선위", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "swingLL", "type": "bin"}, {"key": "macdAbove0", "type": "bin"}], "src": {"n": 356, "late": 0.0705, "n10": 0.8764, "surv": 0.7236, "lens": 0.882, "retLens": 0.0705, "h1": 0.89, "h2": 0.84, "win": "vin_A"}},
  {"id": "br_r_G22", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + 골든크로스 5×60 + 슬로우스토 데드", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "gx5_60", "type": "bin"}, {"key": "stochSlowDead", "type": "bin"}], "src": {"n": 67, "late": 0.067, "n10": 0.9403, "surv": 0.6821, "lens": 0.8806, "retLens": 0.067, "h1": 0.86, "h2": 0.94, "win": "vin_A"}},
  {"id": "br_r_G23", "pool": "bullrun", "kind": "real", "mode": "and", "label": "PSAR 하락 + MA 수렴", "conds": [{"key": "sarBear", "type": "bin"}, {"key": "maConv", "type": "bin"}], "src": {"n": 62, "late": 0.0218, "n10": 0.7097, "surv": 0.6129, "lens": 0.7097, "retLens": 0.0218, "h1": 0.38, "h2": 0.8, "win": "snap"}},
  {"id": "br_r_G24", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA5 기울기%<3.17 + PSAR 하락 + MA 수렴", "conds": [{"key": "ma5slope", "type": "num", "dir": "lt", "th": 3.17}, {"key": "sarBear", "type": "bin"}, {"key": "maConv", "type": "bin"}], "src": {"n": 62, "late": 0.0218, "n10": 0.7097, "surv": 0.6129, "lens": 0.7097, "retLens": 0.0218, "h1": 0.38, "h2": 0.8, "win": "snap"}},
  {"id": "br_r_G25", "pool": "bullrun", "kind": "real", "mode": "and", "label": "CCI<157.5 + PSAR 하락 + MA 수렴", "conds": [{"key": "cci", "type": "num", "dir": "lt", "th": 157.5}, {"key": "sarBear", "type": "bin"}, {"key": "maConv", "type": "bin"}], "src": {"n": 55, "late": 0.0229, "n10": 0.7091, "surv": 0.6127, "lens": 0.7091, "retLens": 0.0229, "h1": 0.38, "h2": 0.81, "win": "snap"}},
  {"id": "br_r_G26", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MFI(자금흐름)<58.92 + MA 수렴", "conds": [{"key": "mfi", "type": "num", "dir": "lt", "th": 58.92}, {"key": "maConv", "type": "bin"}], "src": {"n": 65, "late": 0.0151, "n10": 0.6923, "surv": 0.5908, "lens": 0.7077, "retLens": 0.0151, "h1": 0.57, "h2": 0.75, "win": "snap"}},
  {"id": "br_r_G27", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA5 기울기%<3.17 + MFI(자금흐름)<58.92 + MA 수렴", "conds": [{"key": "ma5slope", "type": "num", "dir": "lt", "th": 3.17}, {"key": "mfi", "type": "num", "dir": "lt", "th": 58.92}, {"key": "maConv", "type": "bin"}], "src": {"n": 65, "late": 0.0151, "n10": 0.6923, "surv": 0.5908, "lens": 0.7077, "retLens": 0.0151, "h1": 0.57, "h2": 0.75, "win": "snap"}},
  {"id": "br_r_G28", "pool": "bullrun", "kind": "real", "mode": "and", "label": "거래량 OSC<-33.7 + MA200 이격도%<-40.41 + 캔들 약세패턴", "conds": [{"key": "volOsc", "type": "num", "dir": "lt", "th": -33.7}, {"key": "dev200", "type": "num", "dir": "lt", "th": -40.41}, {"key": "candleBear", "type": "bin"}], "src": {"n": 58, "late": 0.0567, "n10": 0.6207, "surv": 0.5983, "lens": 0.7069, "retLens": 0.0567, "h1": 0.73, "h2": 0.69, "win": "snap"}},
  {"id": "br_r_G29", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA60 이격도%>-2.98 + MA120 이격도%<-11.74 + 저점 lower-low", "conds": [{"key": "dev60", "type": "num", "dir": "gt", "th": -2.98}, {"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "swingLL", "type": "bin"}], "src": {"n": 379, "late": 0.0719, "n10": 0.8865, "surv": 0.7219, "lens": 0.8707, "retLens": 0.0719, "h1": 0.86, "h2": 0.93, "win": "vin_A"}},
  {"id": "br_r_G30", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + 골든크로스 5×60 + PSAR 상승", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "gx5_60", "type": "bin"}, {"key": "sarBull", "type": "bin"}], "src": {"n": 292, "late": 0.0715, "n10": 0.8801, "surv": 0.6839, "lens": 0.8699, "retLens": 0.0715, "h1": 0.84, "h2": 0.95, "win": "vin_A"}},
  {"id": "br_r_G31", "pool": "bullrun", "kind": "real", "mode": "and", "label": "거래량 OSC>61.87 + 골든크로스 5×20 + 저항선 근접", "conds": [{"key": "volOsc", "type": "num", "dir": "gt", "th": 61.87}, {"key": "gx5_20", "type": "bin"}, {"key": "nearRes", "type": "bin"}], "src": {"n": 53, "late": 0.1177, "n10": 0.8679, "surv": 0.8113, "lens": 0.8679, "retLens": 0.1177, "h1": 0.64, "h2": 0.95, "win": "vin_A"}},
  {"id": "br_r_G32", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + 일목 구름위 + 일목 음운", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "ichiCloudUp", "type": "bin"}, {"key": "ichiCloudBear", "type": "bin"}], "src": {"n": 210, "late": 0.0794, "n10": 0.8476, "surv": 0.7062, "lens": 0.8667, "retLens": 0.0794, "h1": 0.74, "h2": 0.97, "win": "vin_A"}},
  {"id": "br_r_G33", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + MACD 영선위 + 차이킨 데드", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "macdAbove0", "type": "bin"}, {"key": "chaikinDead", "type": "bin"}], "src": {"n": 79, "late": 0.0728, "n10": 0.8228, "surv": 0.7215, "lens": 0.8608, "retLens": 0.0728, "h1": 0.83, "h2": 0.95, "win": "vin_A"}},
  {"id": "br_r_G34", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + MACD 영선위 + 삼선전환 하락반전", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "macdAbove0", "type": "bin"}, {"key": "tlbRevDn", "type": "bin"}], "src": {"n": 77, "late": 0.0865, "n10": 0.7532, "surv": 0.7545, "lens": 0.8571, "retLens": 0.0865, "h1": 0.78, "h2": 0.93, "win": "vin_A"}},
  {"id": "br_r_G35", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA60 이격도%>-2.98 + MA120 이격도%<-11.74 + 삼선전환 하락반전", "conds": [{"key": "dev60", "type": "num", "dir": "gt", "th": -2.98}, {"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "tlbRevDn", "type": "bin"}], "src": {"n": 69, "late": 0.0834, "n10": 0.7536, "surv": 0.7319, "lens": 0.8551, "retLens": 0.0834, "h1": 0.74, "h2": 0.97, "win": "vin_A"}},
  {"id": "br_r_G36", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + MACD 골든크로스 + OBV 하락다이버전스", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "macdGc", "type": "bin"}, {"key": "obvDivBear", "type": "bin"}], "src": {"n": 61, "late": 0.08, "n10": 0.8689, "surv": 0.7115, "lens": 0.8525, "retLens": 0.08, "h1": 0.88, "h2": 0.73, "win": "vin_A"}},
  {"id": "br_r_G37", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA200 이격도%<-40.41 + MFI(자금흐름)<58.92 + BB 스퀴즈", "conds": [{"key": "dev200", "type": "num", "dir": "lt", "th": -40.41}, {"key": "mfi", "type": "num", "dir": "lt", "th": 58.92}, {"key": "squeeze", "type": "bin"}], "src": {"n": 54, "late": 0.0176, "n10": 0.5926, "surv": 0.5611, "lens": 0.6852, "retLens": 0.0176, "h1": 0.56, "h2": 0.74, "win": "snap"}},
  {"id": "br_r_G38", "pool": "bullrun", "kind": "real", "mode": "and", "label": "거래량 OSC<-33.7 + MA200 이격도%<-40.41 + 고점 higher-high", "conds": [{"key": "volOsc", "type": "num", "dir": "lt", "th": -33.7}, {"key": "dev200", "type": "num", "dir": "lt", "th": -40.41}, {"key": "swingHH", "type": "bin"}], "src": {"n": 85, "late": 0.0479, "n10": 0.6118, "surv": 0.6376, "lens": 0.6824, "retLens": 0.0479, "h1": 0.8, "h2": 0.58, "win": "snap"}},
  {"id": "br_r_G39", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA60 이격도%>-2.98 + MFI(자금흐름)>86.72 + MACD 영선아래", "conds": [{"key": "dev60", "type": "num", "dir": "gt", "th": -2.98}, {"key": "mfi", "type": "num", "dir": "gt", "th": 86.72}, {"key": "macdBelow0", "type": "bin"}], "src": {"n": 59, "late": 0.1121, "n10": 0.8305, "surv": 0.8051, "lens": 0.8475, "retLens": 0.1121, "h1": 0.5, "h2": 0.94, "win": "vin_A"}},
  {"id": "br_r_G40", "pool": "bullrun", "kind": "real", "mode": "and", "label": "MA120 이격도%<-11.74 + MACD 영선위 + 일목 음운", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "macdAbove0", "type": "bin"}, {"key": "ichiCloudBear", "type": "bin"}], "src": {"n": 458, "late": 0.0708, "n10": 0.8559, "surv": 0.6723, "lens": 0.8472, "retLens": 0.0708, "h1": 0.82, "h2": 0.91, "win": "vin_A"}},
  // ── bullrun · fake — [S1476] 신재료(ma51020) 세대 3창 union(스냅0830·창A 2023-04-15·창B 2021-08-16)·선언 게이트(n≥30·h1n/h2n≥10·Δ렌즈≥5%p·J0.5 cap4)·Δ내림차순 상위 40개 ──
  {"id": "br_f_G01", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-11.74 + 일목 전환<기준 + 삼선전환 하락반전", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "ichiTKDn", "type": "bin"}, {"key": "tlbRevDn", "type": "bin"}], "src": {"n": 39, "late": -0.0566, "n10": 0.2308, "surv": 0.3231, "lens": 0.1795, "retLens": -0.0566, "h1": 0.29, "h2": 0.12, "win": "vin_A"}},
  {"id": "br_f_G02", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "골든크로스 5×9 + MA20 이탈안착(하락)", "conds": [{"key": "gx5_9", "type": "bin"}, {"key": "settle20Dn", "type": "bin"}], "src": {"n": 31, "late": -0.0623, "n10": 0.2903, "surv": 0.3161, "lens": 0.2258, "retLens": -0.0623, "h1": 0.17, "h2": 0.31, "win": "vin_A"}},
  {"id": "br_f_G03", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "BB %B>0.67 + 일목 전환>기준 + 바이너리웨이브 중립", "conds": [{"key": "bbPctB", "type": "num", "dir": "gt", "th": 0.67}, {"key": "ichiTK", "type": "bin"}, {"key": "bwNeutral", "type": "bin"}], "src": {"n": 54, "late": -0.068, "n10": 0.2778, "surv": 0.3759, "lens": 0.2407, "retLens": -0.068, "h1": 0.08, "h2": 0.56, "win": "vin_A"}},
  {"id": "br_f_G04", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "CCI>94.04 + 거래량패턴 강세 + 일목 구름아래", "conds": [{"key": "cci", "type": "num", "dir": "gt", "th": 94.04}, {"key": "volPatBull", "type": "bin"}, {"key": "ichiCloudDn", "type": "bin"}], "src": {"n": 54, "late": -0.066, "n10": 0.2963, "surv": 0.3685, "lens": 0.2407, "retLens": -0.066, "h1": 0.19, "h2": 0.3, "win": "vin_A"}},
  {"id": "br_f_G05", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "BB %B>0.67 + MACD 영선아래 + 바이너리웨이브 중립", "conds": [{"key": "bbPctB", "type": "num", "dir": "gt", "th": 0.67}, {"key": "macdBelow0", "type": "bin"}, {"key": "bwNeutral", "type": "bin"}], "src": {"n": 51, "late": -0.0684, "n10": 0.3137, "surv": 0.3706, "lens": 0.2549, "retLens": -0.0684, "h1": 0.27, "h2": 0.2, "win": "vin_A"}},
  {"id": "br_f_G06", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "BB %B>0.67 + BB 스퀴즈 + 바이너리웨이브 중립", "conds": [{"key": "bbPctB", "type": "num", "dir": "gt", "th": 0.67}, {"key": "squeeze", "type": "bin"}, {"key": "bwNeutral", "type": "bin"}], "src": {"n": 65, "late": -0.0546, "n10": 0.3231, "surv": 0.3862, "lens": 0.2615, "retLens": -0.0546, "h1": 0.27, "h2": 0.25, "win": "vin_A"}},
  {"id": "br_f_G07", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "BB %B>0.67 + 거래량패턴 강세 + 일목 구름아래", "conds": [{"key": "bbPctB", "type": "num", "dir": "gt", "th": 0.67}, {"key": "volPatBull", "type": "bin"}, {"key": "ichiCloudDn", "type": "bin"}], "src": {"n": 56, "late": -0.057, "n10": 0.3214, "surv": 0.3732, "lens": 0.2679, "retLens": -0.057, "h1": 0.22, "h2": 0.33, "win": "vin_A"}},
  {"id": "br_f_G08", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MA60 이격도%>-2.98 + 골든크로스 5×20 + OBV 하락추세", "conds": [{"key": "dev60", "type": "num", "dir": "gt", "th": -2.98}, {"key": "gx5_20", "type": "bin"}, {"key": "obvDown", "type": "bin"}], "src": {"n": 37, "late": -0.0272, "n10": 0.4324, "surv": 0.3649, "lens": 0.2703, "retLens": -0.0272, "h1": 0.14, "h2": 0.44, "win": "vin_A"}},
  {"id": "br_f_G09", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "BB %B>0.67 + 바이너리웨이브 중립 + 일목 음운", "conds": [{"key": "bbPctB", "type": "num", "dir": "gt", "th": 0.67}, {"key": "bwNeutral", "type": "bin"}, {"key": "ichiCloudBear", "type": "bin"}], "src": {"n": 59, "late": -0.0601, "n10": 0.3559, "surv": 0.3797, "lens": 0.2712, "retLens": -0.0601, "h1": 0.29, "h2": 0.2, "win": "vin_A"}},
  {"id": "br_f_G10", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "CCI>94.04 + OBV 하락다이버전스 + MA 정배열", "conds": [{"key": "cci", "type": "num", "dir": "gt", "th": 94.04}, {"key": "obvDivBear", "type": "bin"}, {"key": "maAlignBull", "type": "bin"}], "src": {"n": 51, "late": -0.012, "n10": 0.2745, "surv": 0.3863, "lens": 0.2745, "retLens": -0.012, "h1": 0.37, "h2": 0.22, "win": "vin_A"}},
  {"id": "br_f_G11", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-11.74 + BB 스퀴즈 + DI 하락우위", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "squeeze", "type": "bin"}, {"key": "diBear", "type": "bin"}], "src": {"n": 154, "late": -0.0387, "n10": 0.3052, "surv": 0.3877, "lens": 0.2792, "retLens": -0.0387, "h1": 0.33, "h2": 0.24, "win": "vin_A"}},
  {"id": "br_f_G12", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "ADX<17.03 + MACD 영선아래 + 삼선전환 하락반전", "conds": [{"key": "adx", "type": "num", "dir": "lt", "th": 17.03}, {"key": "macdBelow0", "type": "bin"}, {"key": "tlbRevDn", "type": "bin"}], "src": {"n": 50, "late": -0.0643, "n10": 0.2, "surv": 0.288, "lens": 0.12, "retLens": -0.0643, "h1": 0, "h2": 0.4, "win": "snap"}},
  {"id": "br_f_G13", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "DI 하락우위 + 고점 higher-high", "conds": [{"key": "diBear", "type": "bin"}, {"key": "swingHH", "type": "bin"}], "src": {"n": 222, "late": -0.0486, "n10": 0.2928, "surv": 0.3649, "lens": 0.2883, "retLens": -0.0486, "h1": 0.33, "h2": 0.24, "win": "vin_A"}},
  {"id": "br_f_G14", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "OBV 하락다이버전스 + 삼선전환 하락반전", "conds": [{"key": "obvDivBear", "type": "bin"}, {"key": "tlbRevDn", "type": "bin"}], "src": {"n": 32, "late": -0.0555, "n10": 0.0938, "surv": 0.3375, "lens": 0.125, "retLens": -0.0555, "h1": 0.1, "h2": 0.17, "win": "snap"}},
  {"id": "br_f_G15", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "CCI<157.5 + OBV 하락다이버전스 + 삼선전환 하락반전", "conds": [{"key": "cci", "type": "num", "dir": "lt", "th": 157.5}, {"key": "obvDivBear", "type": "bin"}, {"key": "tlbRevDn", "type": "bin"}], "src": {"n": 32, "late": -0.0555, "n10": 0.0938, "surv": 0.3375, "lens": 0.125, "retLens": -0.0555, "h1": 0.1, "h2": 0.17, "win": "snap"}},
  {"id": "br_f_G16", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "ADX<17.03 + 골든크로스 5×20 + 삼선전환 하락반전", "conds": [{"key": "adx", "type": "num", "dir": "lt", "th": 17.03}, {"key": "gx5_20", "type": "bin"}, {"key": "tlbRevDn", "type": "bin"}], "src": {"n": 40, "late": -0.0543, "n10": 0.225, "surv": 0.2875, "lens": 0.125, "retLens": -0.0543, "h1": 0.05, "h2": 0.2, "win": "snap"}},
  {"id": "br_f_G17", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "ADX>47.27 + 고점 higher-high + 일목 전환<기준", "conds": [{"key": "adx", "type": "num", "dir": "gt", "th": 47.27}, {"key": "swingHH", "type": "bin"}, {"key": "ichiTKDn", "type": "bin"}], "src": {"n": 72, "late": -0.0359, "n10": 0.2639, "surv": 0.3708, "lens": 0.2917, "retLens": -0.0359, "h1": 0.13, "h2": 0.33, "win": "vin_A"}},
  {"id": "br_f_G18", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "거래량 OSC<-33.7 + PSAR 하락 + OBV 하락다이버전스", "conds": [{"key": "volOsc", "type": "num", "dir": "lt", "th": -33.7}, {"key": "sarBear", "type": "bin"}, {"key": "obvDivBear", "type": "bin"}], "src": {"n": 30, "late": -0.0445, "n10": 0.1667, "surv": 0.28, "lens": 0.1333, "retLens": -0.0445, "h1": 0.06, "h2": 0.23, "win": "snap"}},
  {"id": "br_f_G19", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "BB %B>0.67 + OBV 하락다이버전스 + MA 정배열", "conds": [{"key": "bbPctB", "type": "num", "dir": "gt", "th": 0.67}, {"key": "obvDivBear", "type": "bin"}, {"key": "maAlignBull", "type": "bin"}], "src": {"n": 50, "late": -0.0096, "n10": 0.3, "surv": 0.414, "lens": 0.3, "retLens": -0.0096, "h1": 0.37, "h2": 0.26, "win": "vin_A"}},
  {"id": "br_f_G20", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-11.74 + MA20 돌파안착(상승) + RSI 50 상향", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "settle20", "type": "bin"}, {"key": "rsi50up", "type": "bin"}], "src": {"n": 86, "late": -0.0407, "n10": 0.4651, "surv": 0.4035, "lens": 0.3023, "retLens": -0.0407, "h1": 0.17, "h2": 0.65, "win": "vin_A"}},
  {"id": "br_f_G21", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MA200 이격도%<-34.39 + 골든크로스 5×9 + MACD 영선아래", "conds": [{"key": "dev200", "type": "num", "dir": "lt", "th": -34.39}, {"key": "gx5_9", "type": "bin"}, {"key": "macdBelow0", "type": "bin"}], "src": {"n": 181, "late": -0.0459, "n10": 0.4586, "surv": 0.389, "lens": 0.3039, "retLens": -0.0459, "h1": 0.31, "h2": 0.2, "win": "vin_A"}},
  {"id": "br_f_G22", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-11.74 + BB 스퀴즈 + RSI 50 상향", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "squeeze", "type": "bin"}, {"key": "rsi50up", "type": "bin"}], "src": {"n": 59, "late": -0.0429, "n10": 0.5085, "surv": 0.4424, "lens": 0.3051, "retLens": -0.0429, "h1": 0.23, "h2": 0.53, "win": "vin_A"}},
  {"id": "br_f_G23", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "CCI>94.04 + 일목 양운 + OBV 하락다이버전스", "conds": [{"key": "cci", "type": "num", "dir": "gt", "th": 94.04}, {"key": "ichiCloudBull", "type": "bin"}, {"key": "obvDivBear", "type": "bin"}], "src": {"n": 58, "late": -0.0328, "n10": 0.2931, "surv": 0.3879, "lens": 0.3103, "retLens": -0.0328, "h1": 0.25, "h2": 0.33, "win": "vin_A"}},
  {"id": "br_f_G24", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "OBV 상승추세 + DI 하락우위", "conds": [{"key": "obvUp", "type": "bin"}, {"key": "diBear", "type": "bin"}], "src": {"n": 287, "late": -0.0303, "n10": 0.3206, "surv": 0.376, "lens": 0.3136, "retLens": -0.0303, "h1": 0.32, "h2": 0.31, "win": "vin_A"}},
  {"id": "br_f_G25", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-11.74 + 거래량패턴 강세 + 일목 구름아래", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "volPatBull", "type": "bin"}, {"key": "ichiCloudDn", "type": "bin"}], "src": {"n": 38, "late": -0.0577, "n10": 0.3158, "surv": 0.4184, "lens": 0.3158, "retLens": -0.0577, "h1": 0.33, "h2": 0.29, "win": "vin_A"}},
  {"id": "br_f_G26", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "OBV 하락다이버전스 + MA 정배열", "conds": [{"key": "obvDivBear", "type": "bin"}, {"key": "maAlignBull", "type": "bin"}], "src": {"n": 95, "late": -0.0196, "n10": 0.3053, "surv": 0.4137, "lens": 0.3158, "retLens": -0.0196, "h1": 0.35, "h2": 0.3, "win": "vin_A"}},
  {"id": "br_f_G27", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "DI 하락우위 + 일목 전환<기준", "conds": [{"key": "diBear", "type": "bin"}, {"key": "ichiTKDn", "type": "bin"}], "src": {"n": 219, "late": -0.0199, "n10": 0.3425, "surv": 0.3982, "lens": 0.3196, "retLens": -0.0199, "h1": 0.28, "h2": 0.36, "win": "vin_A"}},
  {"id": "br_f_G28", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "거래량 OSC<-33.7 + OBV 하락다이버전스 + 일목 전환<기준", "conds": [{"key": "volOsc", "type": "num", "dir": "lt", "th": -33.7}, {"key": "obvDivBear", "type": "bin"}, {"key": "ichiTKDn", "type": "bin"}], "src": {"n": 39, "late": -0.0374, "n10": 0.2051, "surv": 0.2821, "lens": 0.1538, "retLens": -0.0374, "h1": 0.12, "h2": 0.17, "win": "snap"}},
  {"id": "br_f_G29", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MACD 영선아래 + DI 하락우위", "conds": [{"key": "macdBelow0", "type": "bin"}, {"key": "diBear", "type": "bin"}], "src": {"n": 332, "late": -0.0287, "n10": 0.3434, "surv": 0.3928, "lens": 0.3223, "retLens": -0.0287, "h1": 0.32, "h2": 0.32, "win": "vin_A"}},
  {"id": "br_f_G30", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "BB %B>0.67 + DI 하락우위 + 고점 higher-high", "conds": [{"key": "bbPctB", "type": "num", "dir": "gt", "th": 0.67}, {"key": "diBear", "type": "bin"}, {"key": "swingHH", "type": "bin"}], "src": {"n": 37, "late": -0.0422, "n10": 0.2432, "surv": 0.3811, "lens": 0.3243, "retLens": -0.0422, "h1": 0.36, "h2": 0.25, "win": "vin_A"}},
  {"id": "br_f_G31", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-11.74 + 골든크로스 5×20 + 삼선전환 하락반전", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -11.74}, {"key": "gx5_20", "type": "bin"}, {"key": "tlbRevDn", "type": "bin"}], "src": {"n": 37, "late": -0.0268, "n10": 0.3514, "surv": 0.3757, "lens": 0.3243, "retLens": -0.0268, "h1": 0.39, "h2": 0.26, "win": "vin_A"}},
  {"id": "br_f_G32", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "DI 하락우위 + 바이너리웨이브 중립", "conds": [{"key": "diBear", "type": "bin"}, {"key": "bwNeutral", "type": "bin"}], "src": {"n": 163, "late": -0.0397, "n10": 0.3252, "surv": 0.4104, "lens": 0.3252, "retLens": -0.0397, "h1": 0.31, "h2": 0.34, "win": "vin_A"}},
  {"id": "br_f_G33", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "ADX<17.03 + BB 스퀴즈 + OBV 하락다이버전스", "conds": [{"key": "adx", "type": "num", "dir": "lt", "th": 17.03}, {"key": "squeeze", "type": "bin"}, {"key": "obvDivBear", "type": "bin"}], "src": {"n": 44, "late": -0.0388, "n10": 0.1364, "surv": 0.2977, "lens": 0.1591, "retLens": -0.0388, "h1": 0.03, "h2": 0.43, "win": "snap"}},
  {"id": "br_f_G34", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "일목 양운 + OBV 하락다이버전스", "conds": [{"key": "ichiCloudBull", "type": "bin"}, {"key": "obvDivBear", "type": "bin"}], "src": {"n": 104, "late": -0.0283, "n10": 0.3269, "surv": 0.4077, "lens": 0.3269, "retLens": -0.0283, "h1": 0.29, "h2": 0.34, "win": "vin_A"}},
  {"id": "br_f_G35", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MA60 이격도%>-2.98 + 일목 양운 + OBV 하락다이버전스", "conds": [{"key": "dev60", "type": "num", "dir": "gt", "th": -2.98}, {"key": "ichiCloudBull", "type": "bin"}, {"key": "obvDivBear", "type": "bin"}], "src": {"n": 104, "late": -0.0283, "n10": 0.3269, "surv": 0.4077, "lens": 0.3269, "retLens": -0.0283, "h1": 0.29, "h2": 0.34, "win": "vin_A"}},
  {"id": "br_f_G36", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "DI 하락우위 + 일목 음운", "conds": [{"key": "diBear", "type": "bin"}, {"key": "ichiCloudBear", "type": "bin"}], "src": {"n": 354, "late": -0.0279, "n10": 0.3503, "surv": 0.3941, "lens": 0.3277, "retLens": -0.0279, "h1": 0.31, "h2": 0.35, "win": "vin_A"}},
  {"id": "br_f_G37", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "골든크로스 5×20 + 바이너리웨이브 중립", "conds": [{"key": "gx5_20", "type": "bin"}, {"key": "bwNeutral", "type": "bin"}], "src": {"n": 259, "late": -0.0309, "n10": 0.3707, "surv": 0.4015, "lens": 0.332, "retLens": -0.0309, "h1": 0.34, "h2": 0.32, "win": "vin_A"}},
  {"id": "br_f_G38", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "MA5 기울기%>4.32 + BB 스퀴즈 + MACD 영선아래", "conds": [{"key": "ma5slope", "type": "num", "dir": "gt", "th": 4.32}, {"key": "squeeze", "type": "bin"}, {"key": "macdBelow0", "type": "bin"}], "src": {"n": 57, "late": -0.032, "n10": 0.4211, "surv": 0.4158, "lens": 0.3333, "retLens": -0.032, "h1": 0.19, "h2": 0.73, "win": "vin_A"}},
  {"id": "br_f_G39", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "BB %B>0.67 + 일목 양운 + OBV 하락다이버전스", "conds": [{"key": "bbPctB", "type": "num", "dir": "gt", "th": 0.67}, {"key": "ichiCloudBull", "type": "bin"}, {"key": "obvDivBear", "type": "bin"}], "src": {"n": 54, "late": -0.0266, "n10": 0.3148, "surv": 0.4185, "lens": 0.3333, "retLens": -0.0266, "h1": 0.25, "h2": 0.37, "win": "vin_A"}},
  {"id": "br_f_G40", "pool": "bullrun", "kind": "fake", "mode": "and", "label": "BB %B>0.67 + BB 스퀴즈 + DI 하락우위", "conds": [{"key": "bbPctB", "type": "num", "dir": "gt", "th": 0.67}, {"key": "squeeze", "type": "bin"}, {"key": "diBear", "type": "bin"}], "src": {"n": 57, "late": -0.0221, "n10": 0.3158, "surv": 0.3877, "lens": 0.3333, "retLens": -0.0221, "h1": 0.3, "h2": 0.38, "win": "vin_A"}},
  // ── sidebear · real — [S1476] 신재료(ma51020) 세대 3창 union(스냅0830·창A 2023-04-15·창B 2021-08-16)·선언 게이트(n≥50·h1n/h2n≥10·Δ렌즈≥5%p·J0.5 cap4)·Δ내림차순 상위 40개 ──
  {"id": "sb_r_G01", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA60 이격도%<-21.92 + MA5 기울기%<-6.11 + 거래량패턴 약세", "conds": [{"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "ma5slope", "type": "num", "dir": "lt", "th": -6.11}, {"key": "volPatBear", "type": "bin"}], "src": {"n": 67, "late": 0.0656, "n10": 0.7015, "surv": 0.7134, "lens": 0.8358, "retLens": 0.0656, "h1": 0.79, "h2": 0.87, "win": "snap"}},
  {"id": "sb_r_G02", "pool": "sidebear", "kind": "real", "mode": "and", "label": "CCI<-149.48 + MA60 이격도%<-21.92 + 거래량패턴 약세", "conds": [{"key": "cci", "type": "num", "dir": "lt", "th": -149.48}, {"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "volPatBear", "type": "bin"}], "src": {"n": 104, "late": 0.0634, "n10": 0.6442, "surv": 0.7269, "lens": 0.8269, "retLens": 0.0634, "h1": 0.83, "h2": 0.82, "win": "snap"}},
  {"id": "sb_r_G03", "pool": "sidebear", "kind": "real", "mode": "and", "label": "CCI<-149.48 + MA5 기울기%<-6.11 + MFI(자금흐름)<24.69", "conds": [{"key": "cci", "type": "num", "dir": "lt", "th": -149.48}, {"key": "ma5slope", "type": "num", "dir": "lt", "th": -6.11}, {"key": "mfi", "type": "num", "dir": "lt", "th": 24.69}], "src": {"n": 94, "late": 0.0451, "n10": 0.734, "surv": 0.6968, "lens": 0.8191, "retLens": 0.0451, "h1": 1, "h2": 0.79, "win": "snap"}},
  {"id": "sb_r_G04", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA60 이격도%<-21.92 + MFI(자금흐름)<24.69 + 거래량패턴 약세", "conds": [{"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "mfi", "type": "num", "dir": "lt", "th": 24.69}, {"key": "volPatBear", "type": "bin"}], "src": {"n": 55, "late": 0.0578, "n10": 0.6, "surv": 0.6782, "lens": 0.8182, "retLens": 0.0578, "h1": 1, "h2": 0.77, "win": "snap"}},
  {"id": "sb_r_G05", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA60 이격도%<-21.92 + 거래량패턴 약세 + MACD 데드크로스", "conds": [{"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "volPatBear", "type": "bin"}, {"key": "macdDead", "type": "bin"}], "src": {"n": 109, "late": 0.0569, "n10": 0.6239, "surv": 0.711, "lens": 0.8165, "retLens": 0.0569, "h1": 0.81, "h2": 0.82, "win": "snap"}},
  {"id": "sb_r_G06", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<31.48 + RSI 상승다이버전스 + MA20 이탈안착(하락)", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 31.48}, {"key": "rsiDiv", "type": "bin"}, {"key": "settle20Dn", "type": "bin"}], "src": {"n": 53, "late": 0.0687, "n10": 0.6226, "surv": 0.6623, "lens": 0.8113, "retLens": 0.0687, "h1": 0.83, "h2": 0.8, "win": "snap"}},
  {"id": "sb_r_G07", "pool": "sidebear", "kind": "real", "mode": "and", "label": "CCI<-149.48 + MA60 이격도%<-21.92 + MFI(자금흐름)<24.69", "conds": [{"key": "cci", "type": "num", "dir": "lt", "th": -149.48}, {"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "mfi", "type": "num", "dir": "lt", "th": 24.69}], "src": {"n": 103, "late": 0.0493, "n10": 0.6699, "surv": 0.7097, "lens": 0.8058, "retLens": 0.0493, "h1": 1, "h2": 0.77, "win": "snap"}},
  {"id": "sb_r_G08", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<33.58 + 저점 lower-low + 데드크로스 5×60", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 33.58}, {"key": "swingLL", "type": "bin"}, {"key": "dx5_60", "type": "bin"}], "src": {"n": 65, "late": 0.1216, "n10": 0.8923, "surv": 0.8369, "lens": 0.8923, "retLens": 0.1216, "h1": 0.3, "h2": 1, "win": "vin_A"}},
  {"id": "sb_r_G09", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<33.58 + ADX>25.19 + 데드크로스 5×60", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 33.58}, {"key": "adx", "type": "num", "dir": "gt", "th": 25.19}, {"key": "dx5_60", "type": "bin"}], "src": {"n": 83, "late": 0.1255, "n10": 0.8916, "surv": 0.8289, "lens": 0.8916, "retLens": 0.1255, "h1": 0.38, "h2": 0.99, "win": "vin_A"}},
  {"id": "sb_r_G10", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA60 이격도%<-21.92 + MFI(자금흐름)<24.69 + VR(거래량비율)<42.91", "conds": [{"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "mfi", "type": "num", "dir": "lt", "th": 24.69}, {"key": "vr", "type": "num", "dir": "lt", "th": 42.91}], "src": {"n": 150, "late": 0.041, "n10": 0.6533, "surv": 0.7267, "lens": 0.7933, "retLens": 0.041, "h1": 0.75, "h2": 0.8, "win": "snap"}},
  {"id": "sb_r_G11", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<33.58 + 캔들 약세패턴 + 데드크로스 5×60", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 33.58}, {"key": "candleBear", "type": "bin"}, {"key": "dx5_60", "type": "bin"}], "src": {"n": 68, "late": 0.1091, "n10": 0.8824, "surv": 0.8103, "lens": 0.8824, "retLens": 0.1091, "h1": 0.46, "h2": 0.98, "win": "vin_A"}},
  {"id": "sb_r_G12", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<31.48 + RSI 상승다이버전스", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 31.48}, {"key": "rsiDiv", "type": "bin"}], "src": {"n": 57, "late": 0.064, "n10": 0.5965, "surv": 0.6596, "lens": 0.7895, "retLens": 0.064, "h1": 0.83, "h2": 0.77, "win": "snap"}},
  {"id": "sb_r_G13", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<31.48 + RSI 상승다이버전스 + MACD 영선아래", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 31.48}, {"key": "rsiDiv", "type": "bin"}, {"key": "macdBelow0", "type": "bin"}], "src": {"n": 57, "late": 0.064, "n10": 0.5965, "surv": 0.6596, "lens": 0.7895, "retLens": 0.064, "h1": 0.83, "h2": 0.77, "win": "snap"}},
  {"id": "sb_r_G14", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<31.48 + RSI 상승다이버전스 + 엔벨로프 하단이탈", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 31.48}, {"key": "rsiDiv", "type": "bin"}, {"key": "envDn", "type": "bin"}], "src": {"n": 57, "late": 0.064, "n10": 0.5965, "surv": 0.6596, "lens": 0.7895, "retLens": 0.064, "h1": 0.83, "h2": 0.77, "win": "snap"}},
  {"id": "sb_r_G15", "pool": "sidebear", "kind": "real", "mode": "and", "label": "거래량 OSC<-52.86 + MA5 기울기%<-6.58 + 데드크로스 5×60", "conds": [{"key": "volOsc", "type": "num", "dir": "lt", "th": -52.86}, {"key": "ma5slope", "type": "num", "dir": "lt", "th": -6.58}, {"key": "dx5_60", "type": "bin"}], "src": {"n": 74, "late": 0.1214, "n10": 0.8784, "surv": 0.8041, "lens": 0.8784, "retLens": 0.1214, "h1": 0.36, "h2": 1, "win": "vin_A"}},
  {"id": "sb_r_G16", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<33.58 + OBV 상승다이버전스 + 데드크로스 5×60", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 33.58}, {"key": "obvDiv", "type": "bin"}, {"key": "dx5_60", "type": "bin"}], "src": {"n": 80, "late": 0.1136, "n10": 0.875, "surv": 0.7962, "lens": 0.875, "retLens": 0.1136, "h1": 0.33, "h2": 1, "win": "vin_A"}},
  {"id": "sb_r_G17", "pool": "sidebear", "kind": "real", "mode": "and", "label": "ADX>25.19 + MA20 이격도%<-15.29 + 데드크로스 5×60", "conds": [{"key": "adx", "type": "num", "dir": "gt", "th": 25.19}, {"key": "dev20", "type": "num", "dir": "lt", "th": -15.29}, {"key": "dx5_60", "type": "bin"}], "src": {"n": 102, "late": 0.1223, "n10": 0.8824, "surv": 0.8078, "lens": 0.8725, "retLens": 0.1223, "h1": 0.38, "h2": 0.97, "win": "vin_A"}},
  {"id": "sb_r_G18", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA60 이격도%<-21.92 + VR(거래량비율)<42.91 + 슬로우스토 데드", "conds": [{"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "vr", "type": "num", "dir": "lt", "th": 42.91}, {"key": "stochSlowDead", "type": "bin"}], "src": {"n": 50, "late": 0.0472, "n10": 0.66, "surv": 0.734, "lens": 0.78, "retLens": 0.0472, "h1": 0.9, "h2": 0.75, "win": "snap"}},
  {"id": "sb_r_G19", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<31.48 + MA5 기울기%<-6.11 + MFI(자금흐름)<24.69", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 31.48}, {"key": "ma5slope", "type": "num", "dir": "lt", "th": -6.11}, {"key": "mfi", "type": "num", "dir": "lt", "th": 24.69}], "src": {"n": 158, "late": 0.0375, "n10": 0.7152, "surv": 0.6722, "lens": 0.7785, "retLens": 0.0375, "h1": 0.79, "h2": 0.78, "win": "snap"}},
  {"id": "sb_r_G20", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MFI(자금흐름)<24.69 + 거래량 5×20 데드", "conds": [{"key": "mfi", "type": "num", "dir": "lt", "th": 24.69}, {"key": "volMaDead", "type": "bin"}], "src": {"n": 58, "late": 0.0227, "n10": 0.6897, "surv": 0.6707, "lens": 0.7759, "retLens": 0.0227, "h1": 0.88, "h2": 0.71, "win": "snap"}},
  {"id": "sb_r_G21", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA20 이격도%<-15.29 + 데드크로스 5×60 + 가격채널 하단이탈", "conds": [{"key": "dev20", "type": "num", "dir": "lt", "th": -15.29}, {"key": "dx5_60", "type": "bin"}, {"key": "pcDn", "type": "bin"}], "src": {"n": 51, "late": 0.1018, "n10": 0.8627, "surv": 0.7451, "lens": 0.8627, "retLens": 0.1018, "h1": 0.46, "h2": 1, "win": "vin_A"}},
  {"id": "sb_r_G22", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA200 이격도%<-30.9 + MA5 기울기%<-6.11 + VR(거래량비율)<42.91", "conds": [{"key": "dev200", "type": "num", "dir": "lt", "th": -30.9}, {"key": "ma5slope", "type": "num", "dir": "lt", "th": -6.11}, {"key": "vr", "type": "num", "dir": "lt", "th": 42.91}], "src": {"n": 108, "late": 0.0363, "n10": 0.6852, "surv": 0.6806, "lens": 0.7593, "retLens": 0.0363, "h1": 0.52, "h2": 0.82, "win": "snap"}},
  {"id": "sb_r_G23", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA20 이격도%<-15.29 + OBV 상승다이버전스 + 데드크로스 5×60", "conds": [{"key": "dev20", "type": "num", "dir": "lt", "th": -15.29}, {"key": "obvDiv", "type": "bin"}, {"key": "dx5_60", "type": "bin"}], "src": {"n": 99, "late": 0.1182, "n10": 0.8788, "surv": 0.7909, "lens": 0.8485, "retLens": 0.1182, "h1": 0.33, "h2": 0.96, "win": "vin_A"}},
  {"id": "sb_r_G24", "pool": "sidebear", "kind": "real", "mode": "and", "label": "CCI<-147.97 + MA20 이격도%<-15.29 + 데드크로스 5×60", "conds": [{"key": "cci", "type": "num", "dir": "lt", "th": -147.97}, {"key": "dev20", "type": "num", "dir": "lt", "th": -15.29}, {"key": "dx5_60", "type": "bin"}], "src": {"n": 90, "late": 0.111, "n10": 0.8556, "surv": 0.7722, "lens": 0.8444, "retLens": 0.111, "h1": 0.43, "h2": 0.97, "win": "vin_A"}},
  {"id": "sb_r_G25", "pool": "sidebear", "kind": "real", "mode": "and", "label": "CCI<-149.48 + MA60 이격도%<-21.92 + VR(거래량비율)<42.91", "conds": [{"key": "cci", "type": "num", "dir": "lt", "th": -149.48}, {"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "vr", "type": "num", "dir": "lt", "th": 42.91}], "src": {"n": 130, "late": 0.0549, "n10": 0.6385, "surv": 0.6969, "lens": 0.7538, "retLens": 0.0549, "h1": 0.72, "h2": 0.78, "win": "snap"}},
  {"id": "sb_r_G26", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<31.48 + MA20 이격도%<-13.01 + 슬로우스토 데드", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 31.48}, {"key": "dev20", "type": "num", "dir": "lt", "th": -13.01}, {"key": "stochSlowDead", "type": "bin"}], "src": {"n": 65, "late": 0.0354, "n10": 0.5538, "surv": 0.7, "lens": 0.7538, "retLens": 0.0354, "h1": 0.83, "h2": 0.74, "win": "snap"}},
  {"id": "sb_r_G27", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<34.58 + ADX>36.11 + VR(거래량비율)<65.01", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 34.58}, {"key": "adx", "type": "num", "dir": "gt", "th": 36.11}, {"key": "vr", "type": "num", "dir": "lt", "th": 65.01}], "src": {"n": 61, "late": 0.2311, "n10": 1, "surv": 0.8754, "lens": 1, "retLens": 0.2311, "h1": 1, "h2": 1, "win": "vin_B"}},
  {"id": "sb_r_G28", "pool": "sidebear", "kind": "real", "mode": "and", "label": "Stoch %K>37.5 + 일목 전환>기준 + MA 역배열", "conds": [{"key": "stochK", "type": "num", "dir": "gt", "th": 37.5}, {"key": "ichiTK", "type": "bin"}, {"key": "maAlignBear", "type": "bin"}], "src": {"n": 101, "late": 0.0421, "n10": 0.8317, "surv": 0.7168, "lens": 0.8416, "retLens": 0.0421, "h1": 0.47, "h2": 0.91, "win": "vin_A"}},
  {"id": "sb_r_G29", "pool": "sidebear", "kind": "real", "mode": "and", "label": "ADX>25.19 + MA5 기울기%<-6.58 + 데드크로스 5×60", "conds": [{"key": "adx", "type": "num", "dir": "gt", "th": 25.19}, {"key": "ma5slope", "type": "num", "dir": "lt", "th": -6.58}, {"key": "dx5_60", "type": "bin"}], "src": {"n": 126, "late": 0.1079, "n10": 0.8492, "surv": 0.7944, "lens": 0.8413, "retLens": 0.1079, "h1": 0.33, "h2": 0.98, "win": "vin_A"}},
  {"id": "sb_r_G30", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<31.48 + MA120 이격도%<-15.73 + 거래량패턴 약세", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 31.48}, {"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "volPatBear", "type": "bin"}], "src": {"n": 149, "late": 0.0464, "n10": 0.6107, "surv": 0.6544, "lens": 0.7517, "retLens": 0.0464, "h1": 0.83, "h2": 0.7, "win": "snap"}},
  {"id": "sb_r_G31", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<31.48 + MFI(자금흐름)<24.69 + VR(거래량비율)<42.91", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 31.48}, {"key": "mfi", "type": "num", "dir": "lt", "th": 24.69}, {"key": "vr", "type": "num", "dir": "lt", "th": 42.91}], "src": {"n": 197, "late": 0.0322, "n10": 0.6396, "surv": 0.6731, "lens": 0.7513, "retLens": 0.0322, "h1": 0.83, "h2": 0.74, "win": "snap"}},
  {"id": "sb_r_G32", "pool": "sidebear", "kind": "real", "mode": "and", "label": "CCI<-149.48 + MA120 이격도%<-15.73 + 거래량패턴 약세", "conds": [{"key": "cci", "type": "num", "dir": "lt", "th": -149.48}, {"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "volPatBear", "type": "bin"}], "src": {"n": 144, "late": 0.0467, "n10": 0.6042, "surv": 0.6611, "lens": 0.75, "retLens": 0.0467, "h1": 0.83, "h2": 0.68, "win": "snap"}},
  {"id": "sb_r_G33", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA20 이격도%<-13.01 + DI 투매소진(강추세) + 캔들 약세패턴", "conds": [{"key": "dev20", "type": "num", "dir": "lt", "th": -13.01}, {"key": "diRebound", "type": "bin"}, {"key": "candleBear", "type": "bin"}], "src": {"n": 56, "late": 0.0451, "n10": 0.6071, "surv": 0.7125, "lens": 0.75, "retLens": 0.0451, "h1": 0.47, "h2": 0.85, "win": "snap"}},
  {"id": "sb_r_G34", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA20 이격도%<-13.01 + MA60 이격도%<-21.92 + 슬로우스토 데드", "conds": [{"key": "dev20", "type": "num", "dir": "lt", "th": -13.01}, {"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "stochSlowDead", "type": "bin"}], "src": {"n": 72, "late": 0.0396, "n10": 0.5833, "surv": 0.7111, "lens": 0.75, "retLens": 0.0396, "h1": 0.67, "h2": 0.78, "win": "snap"}},
  {"id": "sb_r_G35", "pool": "sidebear", "kind": "real", "mode": "and", "label": "RSI<31.48 + MA200 이격도%<-30.9 + VR(거래량비율)<42.91", "conds": [{"key": "rsi", "type": "num", "dir": "lt", "th": 31.48}, {"key": "dev200", "type": "num", "dir": "lt", "th": -30.9}, {"key": "vr", "type": "num", "dir": "lt", "th": 42.91}], "src": {"n": 192, "late": 0.0389, "n10": 0.6719, "surv": 0.6792, "lens": 0.75, "retLens": 0.0389, "h1": 0.65, "h2": 0.76, "win": "snap"}},
  {"id": "sb_r_G36", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA20 이격도%<-13.01 + MA5 기울기%<-6.11 + MFI(자금흐름)<24.69", "conds": [{"key": "dev20", "type": "num", "dir": "lt", "th": -13.01}, {"key": "ma5slope", "type": "num", "dir": "lt", "th": -6.11}, {"key": "mfi", "type": "num", "dir": "lt", "th": 24.69}], "src": {"n": 156, "late": 0.0318, "n10": 0.6795, "surv": 0.666, "lens": 0.75, "retLens": 0.0318, "h1": 0.69, "h2": 0.76, "win": "snap"}},
  {"id": "sb_r_G37", "pool": "sidebear", "kind": "real", "mode": "and", "label": "ADX<18.44 + MFI(자금흐름)<24.69 + MA 역배열", "conds": [{"key": "adx", "type": "num", "dir": "lt", "th": 18.44}, {"key": "mfi", "type": "num", "dir": "lt", "th": 24.69}, {"key": "maAlignBear", "type": "bin"}], "src": {"n": 55, "late": 0.0407, "n10": 0.6909, "surv": 0.7018, "lens": 0.7455, "retLens": 0.0407, "h1": 0.83, "h2": 0.68, "win": "snap"}},
  {"id": "sb_r_G38", "pool": "sidebear", "kind": "real", "mode": "and", "label": "MA120 이격도%<-15.73 + VR(거래량비율)<42.91 + 거래량패턴 약세", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "vr", "type": "num", "dir": "lt", "th": 42.91}, {"key": "volPatBear", "type": "bin"}], "src": {"n": 102, "late": 0.0488, "n10": 0.5588, "surv": 0.6657, "lens": 0.7451, "retLens": 0.0488, "h1": 0.75, "h2": 0.75, "win": "snap"}},
  {"id": "sb_r_G39", "pool": "sidebear", "kind": "real", "mode": "and", "label": "CCI<-149.48 + MA120 이격도%<-15.73 + 슬로우스토 데드", "conds": [{"key": "cci", "type": "num", "dir": "lt", "th": -149.48}, {"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "stochSlowDead", "type": "bin"}], "src": {"n": 51, "late": 0.0288, "n10": 0.4706, "surv": 0.6961, "lens": 0.7451, "retLens": 0.0288, "h1": 0.9, "h2": 0.63, "win": "snap"}},
  {"id": "sb_r_G40", "pool": "sidebear", "kind": "real", "mode": "and", "label": "ADX<18.44 + 데드크로스 5×60 + OBV 하락추세", "conds": [{"key": "adx", "type": "num", "dir": "lt", "th": 18.44}, {"key": "dx5_60", "type": "bin"}, {"key": "obvDown", "type": "bin"}], "src": {"n": 94, "late": 0.0237, "n10": 0.8191, "surv": 0.6021, "lens": 0.7447, "retLens": 0.0237, "h1": 0.81, "h2": 0.47, "win": "snap"}},
  // ── sidebear · fake — [S1476] 신재료(ma51020) 세대 3창 union(스냅0830·창A 2023-04-15·창B 2021-08-16)·선언 게이트(n≥30·h1n/h2n≥10·Δ렌즈≥5%p·J0.5 cap4)·Δ내림차순 상위 40개 ──
  {"id": "sb_f_G01", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "Stoch %K>37.5 + OBV 상승다이버전스 + MACD 시그널 골든", "conds": [{"key": "stochK", "type": "num", "dir": "gt", "th": 37.5}, {"key": "obvDiv", "type": "bin"}, {"key": "macdSigGc", "type": "bin"}], "src": {"n": 57, "late": -0.033, "n10": 0.1579, "surv": 0.3035, "lens": 0.1579, "retLens": -0.033, "h1": 0.15, "h2": 0.17, "win": "vin_A"}},
  {"id": "sb_f_G02", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "Stoch %K>37.5 + 일목 양운 + OBV 하락추세", "conds": [{"key": "stochK", "type": "num", "dir": "gt", "th": 37.5}, {"key": "ichiCloudBull", "type": "bin"}, {"key": "obvDown", "type": "bin"}], "src": {"n": 45, "late": -0.0481, "n10": 0.1111, "surv": 0.3311, "lens": 0.2, "retLens": -0.0481, "h1": 0.27, "h2": 0.18, "win": "vin_A"}},
  {"id": "sb_f_G03", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "거래량 OSC>-14.08 + 일목 전환>기준 + N봉 신고가", "conds": [{"key": "volOsc", "type": "num", "dir": "gt", "th": -14.08}, {"key": "ichiTK", "type": "bin"}, {"key": "newHighN", "type": "bin"}], "src": {"n": 33, "late": -0.017, "n10": 0.4848, "surv": 0.4424, "lens": 0.3636, "retLens": -0.017, "h1": 0.33, "h2": 0.42, "win": "vin_B"}},
  {"id": "sb_f_G04", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "OBV 하락추세 + MA 정배열", "conds": [{"key": "obvDown", "type": "bin"}, {"key": "maAlignBull", "type": "bin"}], "src": {"n": 59, "late": -0.0554, "n10": 0.2034, "surv": 0.3203, "lens": 0.2203, "retLens": -0.0554, "h1": 0.28, "h2": 0.2, "win": "vin_A"}},
  {"id": "sb_f_G05", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "Stoch %K>37.5 + 엔벨로프 상단이탈 + MACD 데드크로스", "conds": [{"key": "stochK", "type": "num", "dir": "gt", "th": 37.5}, {"key": "envUp", "type": "bin"}, {"key": "macdDead", "type": "bin"}], "src": {"n": 50, "late": -0.0679, "n10": 0.22, "surv": 0.31, "lens": 0.24, "retLens": -0.0679, "h1": 0.29, "h2": 0.22, "win": "vin_A"}},
  {"id": "sb_f_G06", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "Stoch %K>37.5 + 엔벨로프 상단이탈 + MACD 히스토 음", "conds": [{"key": "stochK", "type": "num", "dir": "gt", "th": 37.5}, {"key": "envUp", "type": "bin"}, {"key": "macdHistDn", "type": "bin"}], "src": {"n": 50, "late": -0.0679, "n10": 0.22, "surv": 0.31, "lens": 0.24, "retLens": -0.0679, "h1": 0.29, "h2": 0.22, "win": "vin_A"}},
  {"id": "sb_f_G07", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "일목 전환>기준 + N봉 신고가", "conds": [{"key": "ichiTK", "type": "bin"}, {"key": "newHighN", "type": "bin"}], "src": {"n": 35, "late": -0.0105, "n10": 0.4857, "surv": 0.46, "lens": 0.4, "retLens": -0.0105, "h1": 0.39, "h2": 0.42, "win": "vin_B"}},
  {"id": "sb_f_G08", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA60 이격도%<-21.92 + MACD 골든크로스 + 삼선전환 반전", "conds": [{"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "macdGc", "type": "bin"}, {"key": "tlbRev", "type": "bin"}], "src": {"n": 65, "late": -0.0681, "n10": 0.0923, "surv": 0.26, "lens": 0.1538, "retLens": -0.0681, "h1": 0.06, "h2": 0.19, "win": "snap"}},
  {"id": "sb_f_G09", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "ADX>25.19 + 일목 양운 + 거래량 5×20 데드", "conds": [{"key": "adx", "type": "num", "dir": "gt", "th": 25.19}, {"key": "ichiCloudBull", "type": "bin"}, {"key": "volMaDead", "type": "bin"}], "src": {"n": 34, "late": -0.0864, "n10": 0.2353, "surv": 0.3265, "lens": 0.2647, "retLens": -0.0864, "h1": 0.45, "h2": 0.17, "win": "vin_A"}},
  {"id": "sb_f_G10", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-15.73 + DI 투매소진(강추세) + 차이킨 골든", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "diRebound", "type": "bin"}, {"key": "chaikinGc", "type": "bin"}], "src": {"n": 34, "late": -0.0567, "n10": 0.1176, "surv": 0.2912, "lens": 0.1765, "retLens": -0.0567, "h1": 0.25, "h2": 0.14, "win": "snap"}},
  {"id": "sb_f_G11", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "Stoch %K<8.74 + 골든크로스 5×9 + N봉 신저가", "conds": [{"key": "stochK", "type": "num", "dir": "lt", "th": 8.74}, {"key": "gx5_9", "type": "bin"}, {"key": "newLowN", "type": "bin"}], "src": {"n": 39, "late": -0.0594, "n10": 0.1795, "surv": 0.3077, "lens": 0.1795, "retLens": -0.0594, "h1": 0.4, "h2": 0.1, "win": "snap"}},
  {"id": "sb_f_G12", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "BB %B<0.1 + 골든크로스 5×9 + N봉 신저가", "conds": [{"key": "bbPctB", "type": "num", "dir": "lt", "th": 0.1}, {"key": "gx5_9", "type": "bin"}, {"key": "newLowN", "type": "bin"}], "src": {"n": 66, "late": -0.057, "n10": 0.2121, "surv": 0.3061, "lens": 0.1818, "retLens": -0.057, "h1": 0.14, "h2": 0.2, "win": "snap"}},
  {"id": "sb_f_G13", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "Stoch %K>37.5 + OBV 상승다이버전스 + 거래량 5×20 골든", "conds": [{"key": "stochK", "type": "num", "dir": "gt", "th": 37.5}, {"key": "obvDiv", "type": "bin"}, {"key": "volMaGc", "type": "bin"}], "src": {"n": 51, "late": -0.037, "n10": 0.2157, "surv": 0.3725, "lens": 0.2745, "retLens": -0.037, "h1": 0.22, "h2": 0.32, "win": "vin_A"}},
  {"id": "sb_f_G14", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "Stoch %K>37.5 + 골든크로스 5×60 + 저점 lower-low", "conds": [{"key": "stochK", "type": "num", "dir": "gt", "th": 37.5}, {"key": "gx5_60", "type": "bin"}, {"key": "swingLL", "type": "bin"}], "src": {"n": 102, "late": -0.0254, "n10": 0.2941, "surv": 0.349, "lens": 0.2745, "retLens": -0.0254, "h1": 0.25, "h2": 0.28, "win": "vin_A"}},
  {"id": "sb_f_G15", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-15.73 + MACD 시그널 골든 + 바이너리웨이브 중립", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "macdSigGc", "type": "bin"}, {"key": "bwNeutral", "type": "bin"}], "src": {"n": 70, "late": -0.062, "n10": 0.2, "surv": 0.2671, "lens": 0.1857, "retLens": -0.062, "h1": 0.12, "h2": 0.22, "win": "snap"}},
  {"id": "sb_f_G16", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "골든크로스 5×60 + 저점 lower-low", "conds": [{"key": "gx5_60", "type": "bin"}, {"key": "swingLL", "type": "bin"}], "src": {"n": 105, "late": -0.0242, "n10": 0.2952, "surv": 0.3505, "lens": 0.2762, "retLens": -0.0242, "h1": 0.21, "h2": 0.29, "win": "vin_A"}},
  {"id": "sb_f_G17", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA60 이격도%<-21.92 + 저점 lower-low + PSAR 상승", "conds": [{"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "swingLL", "type": "bin"}, {"key": "sarBull", "type": "bin"}], "src": {"n": 112, "late": -0.078, "n10": 0.1518, "surv": 0.2723, "lens": 0.1875, "retLens": -0.078, "h1": 0, "h2": 0.22, "win": "snap"}},
  {"id": "sb_f_G18", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-15.73 + 거래량패턴 강세 + 바이너리웨이브 중립", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "volPatBull", "type": "bin"}, {"key": "bwNeutral", "type": "bin"}], "src": {"n": 32, "late": -0.0735, "n10": 0.25, "surv": 0.2188, "lens": 0.1875, "retLens": -0.0735, "h1": 0.14, "h2": 0.22, "win": "snap"}},
  {"id": "sb_f_G19", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-15.73 + RSI 상승다이버전스 + 심리가격 근접", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "rsiDiv", "type": "bin"}, {"key": "psychNear", "type": "bin"}], "src": {"n": 48, "late": -0.0445, "n10": 0.1875, "surv": 0.3167, "lens": 0.1875, "retLens": -0.0445, "h1": 0.25, "h2": 0.14, "win": "snap"}},
  {"id": "sb_f_G20", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "거래량 OSC<-53.87 + OBV 상승추세 + PSAR 상승", "conds": [{"key": "volOsc", "type": "num", "dir": "lt", "th": -53.87}, {"key": "obvUp", "type": "bin"}, {"key": "sarBull", "type": "bin"}], "src": {"n": 37, "late": -0.0669, "n10": 0.1081, "surv": 0.2649, "lens": 0.1892, "retLens": -0.0669, "h1": 0.21, "h2": 0.17, "win": "snap"}},
  {"id": "sb_f_G21", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-15.73 + 차이킨 골든 + MA 역배열", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "chaikinGc", "type": "bin"}, {"key": "maAlignBear", "type": "bin"}], "src": {"n": 74, "late": -0.0564, "n10": 0.1622, "surv": 0.2851, "lens": 0.1892, "retLens": -0.0564, "h1": 0.23, "h2": 0.16, "win": "snap"}},
  {"id": "sb_f_G22", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "Stoch %K>37.5 + OBV 하락추세 + MACD 영선위", "conds": [{"key": "stochK", "type": "num", "dir": "gt", "th": 37.5}, {"key": "obvDown", "type": "bin"}, {"key": "macdAbove0", "type": "bin"}], "src": {"n": 50, "late": -0.0335, "n10": 0.22, "surv": 0.352, "lens": 0.28, "retLens": -0.0335, "h1": 0.25, "h2": 0.29, "win": "vin_A"}},
  {"id": "sb_f_G23", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-15.73 + DI 하락우위 + 차이킨 골든", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "diBear", "type": "bin"}, {"key": "chaikinGc", "type": "bin"}], "src": {"n": 73, "late": -0.0549, "n10": 0.1644, "surv": 0.2877, "lens": 0.1918, "retLens": -0.0549, "h1": 0.23, "h2": 0.16, "win": "snap"}},
  {"id": "sb_f_G24", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA60 이격도%<-21.92 + 골든크로스 5×9 + MA20 이탈안착(하락)", "conds": [{"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "gx5_9", "type": "bin"}, {"key": "settle20Dn", "type": "bin"}], "src": {"n": 99, "late": -0.0797, "n10": 0.2222, "surv": 0.2576, "lens": 0.1919, "retLens": -0.0797, "h1": 0.18, "h2": 0.2, "win": "snap"}},
  {"id": "sb_f_G25", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "거래량 OSC<-52.86 + MACD 골든크로스 + 일목 전환>기준", "conds": [{"key": "volOsc", "type": "num", "dir": "lt", "th": -52.86}, {"key": "macdGc", "type": "bin"}, {"key": "ichiTK", "type": "bin"}], "src": {"n": 53, "late": -0.0459, "n10": 0.3208, "surv": 0.3642, "lens": 0.283, "retLens": -0.0459, "h1": 0.21, "h2": 0.32, "win": "vin_A"}},
  {"id": "sb_f_G26", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-15.73 + 차이킨 골든", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -15.73}, {"key": "chaikinGc", "type": "bin"}], "src": {"n": 77, "late": -0.0552, "n10": 0.1688, "surv": 0.2935, "lens": 0.1948, "retLens": -0.0552, "h1": 0.23, "h2": 0.17, "win": "snap"}},
  {"id": "sb_f_G27", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "ADX>25.19 + MACD 영선위 + 거래량 5×20 데드", "conds": [{"key": "adx", "type": "num", "dir": "gt", "th": 25.19}, {"key": "macdAbove0", "type": "bin"}, {"key": "volMaDead", "type": "bin"}], "src": {"n": 49, "late": -0.0712, "n10": 0.3061, "surv": 0.3327, "lens": 0.2857, "retLens": -0.0712, "h1": 0.44, "h2": 0.21, "win": "vin_A"}},
  {"id": "sb_f_G28", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "Stoch %K>37.5 + OBV 상승다이버전스 + RSI 50 상향", "conds": [{"key": "stochK", "type": "num", "dir": "gt", "th": 37.5}, {"key": "obvDiv", "type": "bin"}, {"key": "rsi50up", "type": "bin"}], "src": {"n": 63, "late": -0.027, "n10": 0.2063, "surv": 0.3556, "lens": 0.2857, "retLens": -0.027, "h1": 0.22, "h2": 0.33, "win": "vin_A"}},
  {"id": "sb_f_G29", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "OBV 상승추세 + 가격채널 하단이탈", "conds": [{"key": "obvUp", "type": "bin"}, {"key": "pcDn", "type": "bin"}], "src": {"n": 56, "late": -0.0456, "n10": 0.2321, "surv": 0.2946, "lens": 0.1964, "retLens": -0.0456, "h1": 0.27, "h2": 0.18, "win": "snap"}},
  {"id": "sb_f_G30", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "BB 스퀴즈 + DI 상승과열(강추세)", "conds": [{"key": "squeeze", "type": "bin"}, {"key": "diOverheat", "type": "bin"}], "src": {"n": 61, "late": -0.0378, "n10": 0.1475, "surv": 0.3098, "lens": 0.1967, "retLens": -0.0378, "h1": 0.18, "h2": 0.25, "win": "snap"}},
  {"id": "sb_f_G31", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "골든크로스 5×20 + 슬로우스토 데드", "conds": [{"key": "gx5_20", "type": "bin"}, {"key": "stochSlowDead", "type": "bin"}], "src": {"n": 66, "late": -0.0578, "n10": 0.1515, "surv": 0.3091, "lens": 0.197, "retLens": -0.0578, "h1": 0.19, "h2": 0.22, "win": "snap"}},
  {"id": "sb_f_G32", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA60 이격도%<-21.92 + BB 스퀴즈 + 골든크로스 5×9", "conds": [{"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "squeeze", "type": "bin"}, {"key": "gx5_9", "type": "bin"}], "src": {"n": 71, "late": -0.0704, "n10": 0.2394, "surv": 0.2563, "lens": 0.1972, "retLens": -0.0704, "h1": 0.04, "h2": 0.27, "win": "snap"}},
  {"id": "sb_f_G33", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA60 이격도%<-21.92 + 골든크로스 5×9 + 삼선전환 반전", "conds": [{"key": "dev60", "type": "num", "dir": "lt", "th": -21.92}, {"key": "gx5_9", "type": "bin"}, {"key": "tlbRev", "type": "bin"}], "src": {"n": 30, "late": -0.0687, "n10": 0.1333, "surv": 0.3067, "lens": 0.2, "retLens": -0.0687, "h1": 0.31, "h2": 0.07, "win": "snap"}},
  {"id": "sb_f_G34", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "골든크로스 5×9 + N봉 신저가", "conds": [{"key": "gx5_9", "type": "bin"}, {"key": "newLowN", "type": "bin"}], "src": {"n": 90, "late": -0.0497, "n10": 0.2222, "surv": 0.3156, "lens": 0.2, "retLens": -0.0497, "h1": 0.18, "h2": 0.21, "win": "snap"}},
  {"id": "sb_f_G35", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "거래량 OSC<-53.87 + 엔벨로프 하단이탈 + 바이너리웨이브 중립", "conds": [{"key": "volOsc", "type": "num", "dir": "lt", "th": -53.87}, {"key": "envDn", "type": "bin"}, {"key": "bwNeutral", "type": "bin"}], "src": {"n": 35, "late": -0.0477, "n10": 0.2571, "surv": 0.2943, "lens": 0.2, "retLens": -0.0477, "h1": 0.12, "h2": 0.26, "win": "snap"}},
  {"id": "sb_f_G36", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "OBV 상승다이버전스 + RSI 50 상향", "conds": [{"key": "obvDiv", "type": "bin"}, {"key": "rsi50up", "type": "bin"}], "src": {"n": 65, "late": -0.0263, "n10": 0.2154, "surv": 0.3569, "lens": 0.2923, "retLens": -0.0263, "h1": 0.25, "h2": 0.32, "win": "vin_A"}},
  {"id": "sb_f_G37", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "BB %B<0.11 + BB 스퀴즈 + PSAR 상승", "conds": [{"key": "bbPctB", "type": "num", "dir": "lt", "th": 0.11}, {"key": "squeeze", "type": "bin"}, {"key": "sarBull", "type": "bin"}], "src": {"n": 41, "late": -0.0412, "n10": 0.2683, "surv": 0.422, "lens": 0.2927, "retLens": -0.0412, "h1": 0.4, "h2": 0.23, "win": "vin_A"}},
  {"id": "sb_f_G38", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "슬로우스토 데드 + 삼선전환 하락반전", "conds": [{"key": "stochSlowDead", "type": "bin"}, {"key": "tlbRevDn", "type": "bin"}], "src": {"n": 54, "late": -0.0516, "n10": 0.2222, "surv": 0.3185, "lens": 0.2037, "retLens": -0.0516, "h1": 0.22, "h2": 0.18, "win": "snap"}},
  {"id": "sb_f_G39", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "심리가격 근접 + RSI 50 상향", "conds": [{"key": "psychNear", "type": "bin"}, {"key": "rsi50up", "type": "bin"}], "src": {"n": 44, "late": -0.0581, "n10": 0.25, "surv": 0.3114, "lens": 0.2045, "retLens": -0.0581, "h1": 0.18, "h2": 0.25, "win": "snap"}},
  {"id": "sb_f_G40", "pool": "sidebear", "kind": "fake", "mode": "and", "label": "MA120 이격도%<-28.07 + BB 스퀴즈 + 심리가격 근접", "conds": [{"key": "dev120", "type": "num", "dir": "lt", "th": -28.07}, {"key": "squeeze", "type": "bin"}, {"key": "psychNear", "type": "bin"}], "src": {"n": 34, "late": -0.0424, "n10": 0.3235, "surv": 0.3765, "lens": 0.2941, "retLens": -0.0424, "h1": 0.35, "h2": 0.21, "win": "vin_A"}},
  ],
};
...
//   2풀+[S1476] bullrun/sidebear 각 40) / V2=_sxCellSignalCore가 칸 게이트(S1178 발굴이 칸 단위 게이트 통과 →
...
//   [S1476] coin bullrun·sidebear 레거시 4카테고리 각 40 등록(신재료 ma51020 세대·3창 union) — 레시피 경로 침묵 해소. V2 규칙층은 여전히 좁음(S1475 각인).
