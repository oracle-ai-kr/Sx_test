...
var RECIPES_BY_MKT = {
  ...
  {id:'dc_r_L89', pool:'deadcat', kind:'real', mode:'and', label:'RSI<36.8 + MA200 이격도%<-28.66 + PSAR 하락',
   conds:[{key:'rsi',type:'num',dir:'lt',th:36.8}, {key:'dev200',type:'num',dir:'lt',th:-28.66}, {key:'sarBear',type:'bin'}], src:{n:306,late:0.0742,n10:0.7516,surv:0.6657,lens:0.7484,retLens:0.0929,h1:0.79,h2:0.68}},
  ...
  {id:'dc_r_L119', pool:'deadcat', kind:'real', mode:'and', label:'거래량 OSC>10.9 + VR(거래량비율)<60.95 + 지지선 근접',
   conds:[{key:'volOsc',type:'num',dir:'gt',th:10.9}, {key:'vr',type:'num',dir:'lt',th:60.95}, {key:'nearSup',type:'bin'}], src:{n:193,late:0.0689,n10:0.8031,surv:0.7,lens:0.7927,retLens:0.0848,h1:0.87,h2:0.73}},
  ...
  {id:'dc_r_L141', pool:'deadcat', kind:'real', mode:'and', label:'ADX>23.35 + 골든크로스 5×9 + 골든크로스 5×20',
   conds:[{key:'adx',type:'num',dir:'gt',th:23.35}, {key:'gx5_9',type:'bin'}, {key:'gx5_20',type:'bin'}], src:{n:91,late:0.0722,n10:0.7692,surv:0.7088,lens:0.7802,retLens:0.0786,h1:0.71,h2:0.86}},
  ...
  {id:'dc_r_L143', pool:'deadcat', kind:'real', mode:'and', label:'거래량 OSC>10.9 + ADX>23.35 + 골든크로스 5×20',
   conds:[{key:'volOsc',type:'num',dir:'gt',th:10.9}, {key:'adx',type:'num',dir:'gt',th:23.35}, {key:'gx5_20',type:'bin'}], src:{n:98,late:0.0789,n10:0.7449,surv:0.7255,lens:0.7347,retLens:0.0776,h1:0.67,h2:0.8}},
  ...
  {id:'dc_r_L148', pool:'deadcat', kind:'real', mode:'and', label:'MA200 이격도%<-28.66 + RSI 상승다이버전스 + PSAR 하락',
   conds:[{key:'dev200',type:'num',dir:'lt',th:-28.66}, {key:'rsiDiv',type:'bin'}, {key:'sarBear',type:'bin'}], src:{n:133,late:0.0539,n10:0.7519,surv:0.6504,lens:0.7444,retLens:0.076,h1:0.69,h2:0.8}},
  ...
  {id:'dc_r_L156', pool:'deadcat', kind:'real', mode:'and', label:'CCI<-135.72 + MA5 기울기%<-3.61 + RSI 상승다이버전스',
   conds:[{key:'cci',type:'num',dir:'lt',th:-135.72}, {key:'ma5slope',type:'num',dir:'lt',th:-3.61}, {key:'rsiDiv',type:'bin'}], src:{n:80,late:0.0545,n10:0.7875,surv:0.6875,lens:0.8,retLens:0.0725,h1:0.84,h2:0.77}},
  {id:'dc_r_L157', pool:'deadcat', kind:'real', mode:'and', label:'거래량 OSC>10.9 + MFI(자금흐름)<35.82 + 지지선 근접',
   conds:[{key:'volOsc',type:'num',dir:'gt',th:10.9}, {key:'mfi',type:'num',dir:'lt',th:35.82}, {key:'nearSup',type:'bin'}], src:{n:235,late:0.0596,n10:0.7489,surv:0.6711,lens:0.7362,retLens:0.0725,h1:0.83,h2:0.67}},
  ...
  {id:'dc_r_L163', pool:'deadcat', kind:'real', mode:'and', label:'CCI<-135.72 + RSI 상승다이버전스 + 지지선 근접',
   conds:[{key:'cci',type:'num',dir:'lt',th:-135.72}, {key:'rsiDiv',type:'bin'}, {key:'nearSup',type:'bin'}], src:{n:107,late:0.0436,n10:0.7477,surv:0.6776,lens:0.757,retLens:0.0694,h1:0.83,h2:0.71}},
  ...
  {id:'dc_r_L166', pool:'deadcat', kind:'real', mode:'and', label:'MA200 이격도%<-28.66 + MA5 기울기%<-3.61 + RSI 상승다이버전스',
   conds:[{key:'dev200',type:'num',dir:'lt',th:-28.66}, {key:'ma5slope',type:'num',dir:'lt',th:-3.61}, {key:'rsiDiv',type:'bin'}], src:{n:68,late:0.0522,n10:0.7647,surv:0.65,lens:0.7647,retLens:0.0684,h1:0.8,h2:0.73}},
  ...
  {id:'dc_r_L173', pool:'deadcat', kind:'real', mode:'and', label:'Stoch %K<7.95 + MA60 이격도%<-12.44 + DI 하락우위',
   conds:[{key:'stochK',type:'num',dir:'lt',th:7.95}, {key:'dev60',type:'num',dir:'lt',th:-12.44}, {key:'diBear',type:'bin'}], src:{n:324,late:0.0533,n10:0.7346,surv:0.6614,lens:0.7346,retLens:0.067,h1:0.83,h2:0.64}},
  ...
  {id:'dc_r_L178', pool:'deadcat', kind:'real', mode:'and', label:'MA60 이격도%<-12.44 + VR(거래량비율)<60.95 + 골든크로스 5×9',
   conds:[{key:'dev60',type:'num',dir:'lt',th:-12.44}, {key:'vr',type:'num',dir:'lt',th:60.95}, {key:'gx5_9',type:'bin'}], src:{n:53,late:0.0584,n10:0.7925,surv:0.6962,lens:0.7925,retLens:0.0661,h1:0.94,h2:0.59}},
  {id:'dc_r_L179', pool:'deadcat', kind:'real', mode:'and', label:'RSI<36.8 + Stoch %K<7.95 + RSI 상승다이버전스',
   conds:[{key:'rsi',type:'num',dir:'lt',th:36.8}, {key:'stochK',type:'num',dir:'lt',th:7.95}, {key:'rsiDiv',type:'bin'}], src:{n:98,late:0.0484,n10:0.7653,surv:0.7184,lens:0.7449,retLens:0.0657,h1:0.77,h2:0.73}},
  ...
  {id:'dc_r_L184', pool:'deadcat', kind:'real', mode:'and', label:'MA20 이격도%<-7.12 + MA120 이격도%<-20.38 + RSI 상승다이버전스',
   conds:[{key:'dev20',type:'num',dir:'lt',th:-7.12}, {key:'dev120',type:'num',dir:'lt',th:-20.38}, {key:'rsiDiv',type:'bin'}], src:{n:94,late:0.0534,n10:0.766,surv:0.7138,lens:0.7553,retLens:0.0654,h1:0.76,h2:0.75}},
  {id:'dc_r_L185', pool:'deadcat', kind:'real', mode:'and', label:'RSI<36.8 + RSI 상승다이버전스 + VR(거래량비율)<60.95',
   conds:[{key:'rsi',type:'num',dir:'lt',th:36.8}, {key:'rsiDiv',type:'bin'}, {key:'vr',type:'num',dir:'lt',th:60.95}], src:{n:61,late:0.0605,n10:0.7705,surv:0.7541,lens:0.7869,retLens:0.0651,h1:0.94,h2:0.72}},
  ...
  {id:'dc_r_L188', pool:'deadcat', kind:'real', mode:'and', label:'RSI<36.8 + MA5 기울기%<-3.61 + RSI 상승다이버전스',
   conds:[{key:'rsi',type:'num',dir:'lt',th:36.8}, {key:'ma5slope',type:'num',dir:'lt',th:-3.61}, {key:'rsiDiv',type:'bin'}], src:{n:86,late:0.0548,n10:0.7209,surv:0.6988,lens:0.7442,retLens:0.0645,h1:0.74,h2:0.75}},
  ...
  {id:'dc_r_L190', pool:'deadcat', kind:'real', mode:'and', label:'Stoch %K<7.95 + MA20 이격도%<-7.12 + RSI 상승다이버전스',
   conds:[{key:'stochK',type:'num',dir:'lt',th:7.95}, {key:'dev20',type:'num',dir:'lt',th:-7.12}, {key:'rsiDiv',type:'bin'}], src:{n:79,late:0.0537,n10:0.7722,surv:0.7051,lens:0.7468,retLens:0.0635,h1:0.73,h2:0.76}},
  {id:'dc_r_L191', pool:'deadcat', kind:'real', mode:'and', label:'RSI<36.8 + MA20 이격도%<-7.12 + RSI 상승다이버전스',
   conds:[{key:'rsi',type:'num',dir:'lt',th:36.8}, {key:'dev20',type:'num',dir:'lt',th:-7.12}, {key:'rsiDiv',type:'bin'}], src:{n:109,late:0.0555,n10:0.7248,surv:0.7165,lens:0.7339,retLens:0.0633,h1:0.74,h2:0.73}},
  {id:'dc_r_L192', pool:'deadcat', kind:'real', mode:'and', label:'RSI<36.8 + RSI 상승다이버전스 + 지지선 근접',
   conds:[{key:'rsi',type:'num',dir:'lt',th:36.8}, {key:'rsiDiv',type:'bin'}, {key:'nearSup',type:'bin'}], src:{n:134,late:0.048,n10:0.7463,surv:0.7164,lens:0.7313,retLens:0.0631,h1:0.74,h2:0.73}},
  {id:'dc_r_L193', pool:'deadcat', kind:'real', mode:'and', label:'RSI 상승다이버전스 + VR(거래량비율)<60.95 + 지지선 근접',
   conds:[{key:'rsiDiv',type:'bin'}, {key:'vr',type:'num',dir:'lt',th:60.95}, {key:'nearSup',type:'bin'}], src:{n:60,late:0.0575,n10:0.8333,surv:0.7617,lens:0.8167,retLens:0.062,h1:0.9,h2:0.78}},
  ...
  {id:'dc_r_L196', pool:'deadcat', kind:'real', mode:'and', label:'ADX>23.35 + VR(거래량비율)<60.95 + 골든크로스 5×9',
   conds:[{key:'adx',type:'num',dir:'gt',th:23.35}, {key:'vr',type:'num',dir:'lt',th:60.95}, {key:'gx5_9',type:'bin'}], src:{n:126,late:0.049,n10:0.754,surv:0.7317,lens:0.7381,retLens:0.0613,h1:0.79,h2:0.67}},
  {id:'dc_r_L197', pool:'deadcat', kind:'real', mode:'and', label:'MA20 이격도%<-7.12 + RSI 상승다이버전스 + VR(거래량비율)<60.95',
   conds:[{key:'dev20',type:'num',dir:'lt',th:-7.12}, {key:'rsiDiv',type:'bin'}, {key:'vr',type:'num',dir:'lt',th:60.95}], src:{n:52,late:0.0627,n10:0.75,surv:0.7423,lens:0.75,retLens:0.0612,h1:0.92,h2:0.69}},
  {id:'dc_r_L198', pool:'deadcat', kind:'real', mode:'and', label:'거래량 OSC>10.9 + RSI 상승다이버전스 + PSAR 하락',
   conds:[{key:'volOsc',type:'num',dir:'gt',th:10.9}, {key:'rsiDiv',type:'bin'}, {key:'sarBear',type:'bin'}], src:{n:163,late:0.049,n10:0.7607,surv:0.6785,lens:0.7423,retLens:0.0611,h1:0.77,h2:0.71}},
  ...
  {id:'pb_r_L13', pool:'pullback', kind:'real', mode:'and', tradable:false, label:'ADX<14.11 + MA20 이격도%>4.03 + 골든크로스 5×20',
   conds:[{key:'adx',type:'num',dir:'lt',th:14.11}, {key:'dev20',type:'num',dir:'gt',th:4.03}, {key:'gx5_20',type:'bin'}], src:{n:149,late:0.0879,n10:0.7047,surv:0.6725,lens:0.7852,retLens:0.1365,h1:0.8,h2:0.78}},
  ...
  {id:'pb_r_L16', pool:'pullback', kind:'real', mode:'and', tradable:false, label:'CCI>51.82 + 골든크로스 5×20 + PSAR 하락',
   conds:[{key:'cci',type:'num',dir:'gt',th:51.82}, {key:'gx5_20',type:'bin'}, {key:'sarBear',type:'bin'}], src:{n:64,late:0.0791,n10:0.75,surv:0.6953,lens:0.75,retLens:0.1277,h1:0.62,h2:0.79}},
  {id:'pb_r_L17', pool:'pullback', kind:'real', mode:'and', tradable:false, label:'BB %B>0.82 + ADX<14.11 + 골든크로스 5×20',
   conds:[{key:'bbPctB',type:'num',dir:'gt',th:0.82}, {key:'adx',type:'num',dir:'lt',th:14.11}, {key:'gx5_20',type:'bin'}], src:{n:195,late:0.0859,n10:0.6718,surv:0.6656,lens:0.7538,retLens:0.1276,h1:0.69,h2:0.8}},
  ...
  {id:'pb_r_L19', pool:'pullback', kind:'real', mode:'and', tradable:false, label:'CCI>51.82 + MACD 영선아래 + PSAR 하락',
   conds:[{key:'cci',type:'num',dir:'gt',th:51.82}, {key:'macdBelow0',type:'bin'}, {key:'sarBear',type:'bin'}], src:{n:120,late:0.074,n10:0.7917,surv:0.6667,lens:0.8083,retLens:0.1223,h1:0.78,h2:0.83}},
  {id:'pb_r_L20', pool:'pullback', kind:'real', mode:'and', tradable:false, label:'MA60 이격도%<-6.55 + RSI 상승다이버전스 + PSAR 하락',
   conds:[{key:'dev60',type:'num',dir:'lt',th:-6.55}, {key:'rsiDiv',type:'bin'}, {key:'sarBear',type:'bin'}], src:{n:257,late:0.067,n10:0.7821,surv:0.6626,lens:0.7626,retLens:0.1217,h1:0.71,h2:0.79}},
  {id:'pb_r_L21', pool:'pullback', kind:'real', mode:'and', tradable:false, label:'MA60 이격도%<-6.55 + RSI 상승다이버전스 + 지지선 근접',
   conds:[{key:'dev60',type:'num',dir:'lt',th:-6.55}, {key:'rsiDiv',type:'bin'}, {key:'nearSup',type:'bin'}], src:{n:144,late:0.0716,n10:0.7847,surv:0.6771,lens:0.7569,retLens:0.1174,h1:0.68,h2:0.83}},
  ...
  {id:'pb_r_L26', pool:'pullback', kind:'real', mode:'and', tradable:false, label:'ADX<14.11 + MA60 이격도%<-6.55 + RSI 상승다이버전스',
   conds:[{key:'adx',type:'num',dir:'lt',th:14.11}, {key:'dev60',type:'num',dir:'lt',th:-6.55}, {key:'rsiDiv',type:'bin'}], src:{n:56,late:0.0938,n10:0.6964,surv:0.6464,lens:0.7679,retLens:0.1096,h1:0.67,h2:0.88}},
  ...
  {id:'pb_r_L29', pool:'pullback', kind:'real', mode:'and', tradable:false, label:'MA20 이격도%>4.03 + MACD 영선아래 + PSAR 하락',
   conds:[{key:'dev20',type:'num',dir:'gt',th:4.03}, {key:'macdBelow0',type:'bin'}, {key:'sarBear',type:'bin'}], src:{n:56,late:0.0601,n10:0.8214,surv:0.6661,lens:0.75,retLens:0.1082,h1:0.85,h2:0.72}},
  {id:'pb_r_L30', pool:'pullback', kind:'real', mode:'and', tradable:false, label:'RSI 상승다이버전스 + 지지선 근접 + PSAR 하락',
   conds:[{key:'rsiDiv',type:'bin'}, {key:'nearSup',type:'bin'}, {key:'sarBear',type:'bin'}], src:{n:157,late:0.0659,n10:0.7771,surv:0.6675,lens:0.7516,retLens:0.1072,h1:0.68,h2:0.83}},
