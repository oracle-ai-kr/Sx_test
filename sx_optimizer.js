...
const _OPT_MODE_WEIGHTS = {
  ...
  balanced: { pnl:30,  trades:5, mdd:20, wr:40, pf:5  },  // [S292] 승률·수익률·MDD 균형
  safe:     { pnl:20,  trades:5, mdd:40, wr:30, pf:5  }   // [S292] MDD 단독 1위, 승률 2위
};
...
const _OPT_MODE_TIEBREAK_DEFAULTS = {
  profit:   { pnl:1, trades:2, mdd:4, wr:3, pf:5 },
