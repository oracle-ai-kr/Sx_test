...
function _optRenderBestCards(){
  ...
  if(!mkt || Object.keys(mkt).length===0){
    area.innerHTML=html+'<div style="font-size:10px;color:var(--text3,#999);padding:6px 0;text-align:center">최고기록 없음 — 고정 적용 시 자동 기록</div>';
    return;
  }
  const tfLabels={};
  ...
  html+='<div style="font-size:11px;font-weight:700;color:var(--text,#222);margin-bottom:6px">🏆 최고기록 (시장×TF×모드×레짐)</div>';
