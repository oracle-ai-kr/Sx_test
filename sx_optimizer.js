...
function openOptimizer(){
  ...
  // [S352] 기본 활성 TF: 코인=4시간(240m), 그 외(국내/해외)=일봉(day)
  const _optDefTf = market==='coin' ? '240m' : 'day';
...
function _optSwitchMarket(m){
  ...
  if(tfGrid){
    ...
    // [S352] 시장 전환 시 기본 TF: 코인=4시간(240m), 그 외=일봉(day)
    const _optDefTf2 = m==='coin' ? '240m' : 'day';
