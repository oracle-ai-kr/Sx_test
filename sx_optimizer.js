...
const OPT_MARKET_MODE_RANGES = {
  ...
  profit: {
    kr:   { bbLen:{min:14, max:14, step:0}, bbMult:{min:1.9, max:1.9, step:0}, buyTh:{min:35, max:50, step:1}, sellTh:{min:20, max:35, step:1}, tpMult:{min:1.0, max:1.5, step:0.1}, slMult:{min:0.5, max:0.7, step:0.1} },
    ...
    coin: { bbLen:{min: 9, max: 9, step:0}, bbMult:{min:2.1, max:2.1, step:0}, buyTh:{min:40, max:55, step:1}, sellTh:{min:25, max:40, step:1}, tpMult:{min:1.5, max:2.5, step:0.1}, slMult:{min:0.7, max:1.2, step:0.1} },
  },
  // ⚖️ 스윙 (balanced): 중간 여유
  balanced: {
    ...
    us:   { bbLen:{min:20, max:20, step:0}, bbMult:{min:2.0, max:2.0, step:0}, buyTh:{min:40, max:55, step:1}, sellTh:{min:25, max:40, step:1}, tpMult:{min:3.0, max:5.0, step:0.1}, slMult:{min:1.5, max:2.5, step:0.1} },
    coin: { bbLen:{min: 9, max: 9, step:0}, bbMult:{min:2.1, max:2.1, step:0}, buyTh:{min:50, max:65, step:1}, sellTh:{min:35, max:50, step:1}, tpMult:{min:5.0, max:8.0, step:0.1}, slMult:{min:2.5, max:4.0, step:0.1} },
  },
  // 🛡️ 중기 (safe): 넓은 여유
  safe: {
    kr:   { bbLen:{min:14, max:14, step:0}, bbMult:{min:1.9, max:1.9, step:0}, buyTh:{min:50, max:65, step:1}, sellTh:{min:35, max:50, step:1}, tpMult:{min:6.0,  max:9.0,  step:0.1}, slMult:{min:2.0, max:3.0, step:0.1} },
    us:   { bbLen:{min:20, max:20, step:0}, bbMult:{min:2.0, max:2.0, step:0}, buyTh:{min:45, max:60, step:1}, sellTh:{min:30, max:45, step:1}, tpMult:{min:6.0,  max:9.0,  step:0.1}, slMult:{min:2.0, max:3.0, step:0.1} },
    coin: { bbLen:{min: 9, max: 9, step:0}, bbMult:{min:2.1, max:2.1, step:0}, buyTh:{min:55, max:70, step:1}, sellTh:{min:40, max:55, step:1}, tpMult:{min:12.0, max:18.0, step:0.1}, slMult:{min:4.0, max:6.0, step:0.1} },
  },
};
