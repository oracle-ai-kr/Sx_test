...
//             단, 거래수만은 일봉 추천값 20을 기본 표시 (사용자가 빈칸으로 비우거나 다른 값 입력 가능)
//   〔이력〕
...
let _optMinTrades = 20; // S86: 최소 거래수 필터 (v3.19: 일봉 추천값 20 기본 / 빈칸=OFF=0)
    ...
    <div class="opt-body">
      ...
      <div class="opt-section" id="optControlSection">
        ...
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;padding:6px 10px;background:var(--surface2,#f5f5f5);border-radius:6px;border:1px solid var(--border,#e0e0e0)">
          <div style="flex:1">
            <span style="font-size:10px;color:var(--text,#222);font-weight:600">거래수 <input type="number" id="optMinTradesInput" value="20" min="1" max="999" step="1" placeholder="-" style="width:42px;padding:1px 3px;border:1px solid var(--border);border-radius:3px;font-size:10px;text-align:center;font-weight:600" onchange="_optUpdateMinTrades()">건 미만 결과 제외</span><br>
