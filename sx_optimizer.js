...
const _OPT_MODE_WEIGHTS = {
  profit:   { pnl:35, trades:5,  mdd:15, wr:20, pf:25 },  // 수익률·PF 1~2위
  balanced: { pnl:20, trades:10, mdd:25, wr:25, pf:20 },  // 5지표 균형 (mdd/wr 동률 1위, pnl/pf 동률 3위)
  safe:     { pnl:10, trades:5,  mdd:35, wr:25, pf:25 }   // MDD 단독 1위, PF·승률 동률 2위
};
...
// [S275] 새 비중에 맞춰 순위 재정렬:
//   수익형: pnl 1 / pf 2 / wr 3 / mdd 4 / trades 5
//   안정형: mdd 1 / wr 2 / pnl 3 / pf 4 / trades 5 ("안정"이라는 이름에 맞게 mdd 시각적 1위)
//   보수형: mdd 1 / pf 2 / wr 3 / pnl 4 / trades 5 (자본 보존 + 손익비)
const _OPT_MODE_TIEBREAK_DEFAULTS = {
  profit:   { pnl:1, trades:5, mdd:4, wr:3, pf:2 },
  balanced: { pnl:3, trades:5, mdd:1, wr:2, pf:4 },
  safe:     { pnl:4, trades:5, mdd:1, wr:3, pf:2 }
};
