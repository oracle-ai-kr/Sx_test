    ...
    <div class="opt-body">
      ...
      <div class="opt-section" id="optControlSection">
        ...
        <div style="display:flex;align-items:center;gap:6px;margin-bottom:8px;flex-wrap:wrap">
          ...
          <!-- [S169] 새 버튼 2개 — 수동탐색용 (최소값 정렬 + 결과보기) -->
          <span style="font-size:9px;padding:3px 8px;border-radius:4px;cursor:pointer;background:var(--surface2,#f0f0f0);color:var(--text2,#666);border:1px solid var(--border,#ddd);white-space:nowrap" onclick="_optMinValueAlign()" title="11개 파라미터 max를 min으로 자동 정렬 (단일값)">📐 최소값 정렬</span>
          <span style="font-size:9px;padding:3px 8px;border-radius:4px;cursor:pointer;background:var(--accent,#2563eb);color:#fff;border:1px solid var(--accent,#2563eb);white-space:nowrap" onclick="_optShowMinValueResult()" title="최소값 정렬 + 즉시 BT 실행 (수동탐색)">▶ 결과보기</span>
