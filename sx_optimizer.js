...
const _OPT_MODE_WEIGHTS = {
  profit:   { pnl:40, trades:5, mdd:30, wr:20, pf:5 },  // [S311] 사용자 사진: 수익률40·MDD30·승률20 강조
  balanced: { pnl:40, trades:5, mdd:30, wr:20, pf:5 },  // [S311] 3모드 동일 가중치
  safe:     { pnl:40, trades:5, mdd:30, wr:20, pf:5 }   // [S311] 모드 차별성은 타이브레이커(순위)로만
};
...
const _OPT_MODE_TIEBREAK_DEFAULTS = {
  ...
  balanced: { pnl:1, trades:4, mdd:2, wr:3, pf:5 },
  safe:     { pnl:1, trades:4, mdd:2, wr:3, pf:5 }
};
...
function _optResetWeights(){
  _optVib(15);
  const defaults = {
    profit:   { pnl:40, trades:5, mdd:30, wr:20, pf:5 },
    balanced: { pnl:40, trades:5, mdd:30, wr:20, pf:5 },
    safe:     { pnl:40, trades:5, mdd:30, wr:20, pf:5 }
  };
