...
// [S548] 추세별 랭킹 — 선택 추세(들)의 버킷 성과로 필터·랭킹. 레짐 탐색 OFF일 때만 활성. 빈 배열=전체(기본).
...
function openOptimizer(){
  ...
  if(typeof _optRenderRegimeSelGate === 'function') _optRenderRegimeSelGate(); // [S548] 추세별 랭킹 게이트
...
// [S548] 추세별 랭킹 게이트 렌더 (2그룹 × 단일/2선택). 레짐 탐색 OFF일 때만 활성.
