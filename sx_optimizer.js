// ════════════════════════════════════════════════════════════
//  sx_optimizer.js v3.9 — 파라미터 자동 최적화 모듈
//  S113-b: 스톱워치 추가 — 논스톱 실행 중 경과 시간 실시간 표시 (1초 갱신)
//    - 시작 시각 저장 → setInterval로 progText에 "⏱ M:SS" 추가
//    - 완료/취소 시 clearInterval + 총 경과시간 메시지에 포함
//    - 채희창 요청: "남은 시간보다 얼마나 지났나를 보게"
//  v3.8 <!-- S113: 600봉 확장 수집 전환 (_fetchExtCandles 활용) — 분석탭/단일검증과 KV 양방향 공유
