...
// ── 기본 설정 (최적화 우선순위 순) ──
const OPT_DEFAULTS = {
  atrLen:  { min:10,  max:50,  step:1,   enabled:false },  // 1. 변동성 기반
  bbMult:  { min:1.5, max:3.5, step:0.1, enabled:false },  // 2. 진입 기준 폭
  tpMult:  { min:2.0, max:3.5, step:0.1, enabled:false },  // 3. 익절폭
  slMult:  { min:1.0, max:2.0, step:0.1, enabled:false },  // 4. 손절폭
  rsiLen:  { min:7,   max:21,  step:1,   enabled:false },   // 5. 시그널 감도
  buyTh:   { min:25,  max:55,  step:1,   enabled:false },   // 6. 진입 점수
  sellTh:  { min:5,   max:25,  step:1,   enabled:false },   // 7. 청산 점수
  ...
  maLong:  { min:20,  max:100, step:1,   enabled:false },   // 11. MA 장기
};
