...
function _optRenderBestCards(){
  ...
  // 초기화 버튼
  html += `<div style="text-align:right;margin-top:4px"><span style="font-size:9px;color:var(--text3,#999);cursor:pointer;text-decoration:underline" onclick="_optClearBest()">기록 초기화</span></div>`;
  area.innerHTML = html;
}
