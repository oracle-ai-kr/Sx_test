...
const OPT_MARKET_MODE_RANGES = {
  ...
  safe: {
    kr:   { bbLen:{min:14, max:14, step:0}, bbMult:{min:1.9, max:1.9, step:0}, buyTh:{min:60, max:75, step:1}, sellTh:{min:45, max:60, step:1}, tpMult:{min:6.0,  max:9.0,  step:0.1}, slMult:{min:2.0, max:3.0, step:0.1} },
    us:   { bbLen:{min:20, max:20, step:0}, bbMult:{min:2.0, max:2.0, step:0}, buyTh:{min:60, max:75, step:1}, sellTh:{min:45, max:60, step:1}, tpMult:{min:6.0,  max:9.0,  step:0.1}, slMult:{min:2.0, max:3.0, step:0.1} },
    coin: { bbLen:{min: 9, max: 9, step:0}, bbMult:{min:2.1, max:2.1, step:0}, buyTh:{min:65, max:80, step:1}, sellTh:{min:50, max:65, step:1}, tpMult:{min:12.0, max:18.0, step:0.1}, slMult:{min:4.0, max:6.0, step:0.1} },
  },
};
