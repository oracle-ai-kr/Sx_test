    ...
    <div class="anal-header-card">
      ...
      <div style="margin-top:10px;padding:10px 12px;background:var(--surface2);border-radius:10px;border-left:3px solid ${
        ...
        ${(()=>{
          ...
          return `<div style="margin-bottom:8px"><span style="display:inline-flex;align-items:center;padding:2px 8px;background:var(--surface);border:1px solid ${_c};border-radius:10px;font-size:9.5px;font-weight:700;color:${_c};white-space:nowrap">${_t}</span></div>`;
        })()}
