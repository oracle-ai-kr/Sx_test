...
function _buildChartPredictCard(stock, indicators){
  ...
  // [S663] 차트확인 버튼 + 제목 그룹 — 활성/비활성 카드 공용
  ...
  const _titleGroup = `<div style="display:flex;align-items:center;gap:6px"><span style="font-size:13px;font-weight:800;color:var(--text)">🔮 차트예측</span><span style="font-size:9px;padding:2px 6px;border-radius:4px;background:var(--surface2);color:var(--text3);border:1px solid var(--border)">실험</span>${_chartBtn}</div>`;
...
if(typeof window!=='undefined'){ if(window._sxCpRegimeOn===undefined) window._sxCpRegimeOn=true; window._cpRegimeToggle=_cpRegimeToggle; window._cpRerenderCard=_cpRerenderCard; }
