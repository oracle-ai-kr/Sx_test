    ...
    <div class="anal-header-card">
      ...
      <div style="margin-top:10px;padding:10px 12px;background:var(--surface2);border-radius:10px;border-left:3px solid ${
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;flex-wrap:wrap;gap:4px">
          <div style="font-size:11px;color:var(--text2);font-weight:700;letter-spacing:-.3px">📊 엔진판단 검증 결과${(()=>{
            // [S424] 진입 기준 배지 — 표시된 BT 결과가 어느 진입 모드로 산출됐는지 표기 (현재 설정이 아닌 결과 기준).
            ...
            return `<span style="display:inline-flex;align-items:center;padding:1px 7px;background:var(--surface);border:1px solid ${_c};border-radius:10px;font-size:9px;font-weight:700;color:${_c};margin-left:6px;white-space:nowrap">${_t}</span>`;
          })()}${_robBadge}</div>
