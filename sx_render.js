...
var _DISCRIM_FEATS = [
  ...
  { key:'settle20',label:'MA20 돌파안착(2봉)', type:'bool' },
...
function _extractFeats733(ind, rows, idx){
  ...
  f.adx    = (typeof ind.adx==='number') ? ind.adx : null;
  ...
  if(cl && cl.length >= 2){
    ...
    var cN=cl[cl.length-1], cP=cl[cl.length-2];
    f.settle20 = (ma20n!=null && ma20p!=null && cN>ma20n && cP>ma20p) ? 1 : 0;   // 2봉 연속 MA20 위 = 돌파 안착(1봉 스파이크 배제)
    ...
    f.volBreak = (f.settle20 && vol!=null && volMA!=null && volMA>0 && vol>volMA) ? 1 : 0;   // 안착 + 거래량 > 평균 = 매수세 확인
  } else { f.gx5_9=0; f.gx5_20=0; f.gx5_60=0; f.settle20=0; f.volBreak=0; }
  return f;
}
