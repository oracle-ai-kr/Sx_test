// ════════════════════════════════════════════════════════════
//  SIGNAL X — Render Engine v7.10  [S807 · build 20260629-1145 cache-bust]
// ════════════════════════════════════════════════════════════
...
function _reboundCycleCalc(adv, stock, mkt){
  ...
  // [거래량 소진] BT착시로 약화(+25→+8). 보조 신호로만.
  if(typeof adv.volOsc === 'number' && adv.volOsc < -37){ y += 8; yPos.push('거래량OSC ' + adv.volOsc.toFixed(0) + '(매도 소진)'); }
  // [보조 과매도] CCI — 약하게
  if(typeof adv.cci === 'number' && adv.cci < -100){ y += 6; yPos.push('CCI ' + adv.cci.toFixed(0) + '(과매도권)'); }
