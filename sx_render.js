      ...
      return `<div class="anal-section">
        ...
        ${(()=>{
          ...
          return `<div style="margin-top:8px;padding:6px 8px;background:var(--surface2);border-left:2px solid var(--accent);border-radius:4px;font-size:9px;color:var(--text3);line-height:1.5">
            ...
            <div style="margin-top:3px;color:var(--text2)">최신 분기 데이터는 <a onclick="_sxVib(8);_sxGotoFinReportSetting()" style="color:var(--accent);font-weight:600;cursor:pointer;text-decoration:underline">⚙ 설정 → 재무 보고서 종류</a>에서 1분기/반기/3분기로 변경 가능</div>
          </div>`;
        })()}
