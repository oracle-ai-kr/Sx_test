...
function _buildResultHeaderHTML(cntText){
  return `<div class="result-summary">
    ${cntText}
    <button class="btn-diag" onclick="_sxVib(12);openScanDiagModal()" style="margin-left:auto;padding:3px 10px;border-radius:6px;background:var(--surface2);color:var(--text);border:1px solid var(--border);font-size:9px;font-weight:700;cursor:pointer;font-family:inherit;flex-shrink:0;letter-spacing:.2px">📊 진단</button>
