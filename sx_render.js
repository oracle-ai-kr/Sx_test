...
const _SXB_PARAM = new Set(['추세방향','추세신호','변동성','가격모멘텀','반등신호','반등강도','눌림목','볼린저%B','골든크로스','데드크로스']);
...
function openScoreWeightModal(){
  ...
  _swRender();
  const m = document.getElementById('scoreWeightModal'); if(m) m.style.display = 'flex';
}
