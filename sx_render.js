...
var _sxvPredsOn = { slope:1, slopeTurn:1, rsiGc:1, obv:1, macd:1, closeVsMa:1, rsi50:1, macdCross:1, slopeOrRsi:1, slopeAndRsi:1, resBreak:1, hhBreak:1, volSurge:1, align3:1, adx:1, bandWalk:1, andCore:1, andStrong:1, upsideMix:1, aGate:0, aBuy:0, momUp:0, aGateMom:0 };   // [S709→S710] 신호 on/off · [S715] 엔진결합 4종 추가(기본 OFF=무거움)
var _sxvEngPreds = { aGate:1, aBuy:1, momUp:1, aGateMom:1 };   // [S715] 엔진결합 신호 id 집합(봉별 scrQuickScore) — 켜지면 자동 캡+warmup
