// ════════════════════════════════════════════════════════════
//  SIGNAL X — Render Engine v7.10  [S828 · build 20260630-2120 cache-bust]
// ════════════════════════════════════════════════════════════
...
if(typeof window!=='undefined'){ window._btDiscrimRun=_btDiscrimRun; window._btGateAuditRun=_btGateAuditRun; window._recipeOverlapRun=_recipeOverlapRun; window._volRegimeRun=_volRegimeRun; window._volPoolShow=_volPoolShow; window._deadcatShortRun=_deadcatShortRun; window._deadcatTrajRun=_deadcatTrajRun; }
// [S804] 배포 확인용 빌드 식별자(SSOT) — 배포마다 이 값을 갱신. 화면 배지에 찍혀 '실제 로드된 render.js 버전'을 노출(캐시 구버전이면 안 채워지거나 옛 값 → 즉시 진단).
if(typeof window!=='undefined'){
  window.SX_BUILD='S828';
