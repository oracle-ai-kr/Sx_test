// ════════════════════════════════════════════════════════════
//  SIGNAL X — Render Engine v4.3 <!-- S103-fix5 분석탭 TF칩/모드칩/연관키워드 진동 3종 추가 --> v4.2 <!-- S103 분석탭 동적 삼각형 토글 24개 + 차트전체화면 진동 추가 --> v4.1 <!-- S103 결과탭 관심목록(12)/초기화(15) 진동 추가 --> v4.0 <!-- S103 _stratDetailId 스코프버그 수정 (IIFE 안 선언→함수 본체 호이스팅) --> v3.9 <!-- S100 -->
