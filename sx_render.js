  ...
  body.innerHTML = `
    ...
    <div class="anal-header-card">
      ...
      ${(()=>{
        ...
        return `<div class="anal-fair-price" style="margin-top:3px;font-size:10px;font-weight:600;color:${_v.perColor};opacity:${_v.perOpacity};letter-spacing:-.2px">`
          + `적정주가 ${_fpStr} `
          + `<span style="color:var(--text3);font-weight:400">(PER ${_v.benchPer}배 기준 · </span>`
          + `${_sign}${_v.diffPct.toFixed(1)}% ${_v.perLabel}`
