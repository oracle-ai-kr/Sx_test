  ...
  body.innerHTML = `
    ...
    <div class="anal-header-card">
      ...
      ${(()=>{
        ...
        //   유력(실선진한색): 매수→반등유력 / 즉시청산·회피→하락유력 (차트마커 ▲▼과 동기화)
        //   조짐(실선연한색): 관심→반등조짐 / 청산준비·검토→하락조짐 (예고 단계)
        //   그 외(보유유지·관망·대기): 배지 없음
        let _verdictBadgeTop = '';
        {
          ...
          if(_svV && _svV.action){
            ...
            else if(a === '즉시 청산' || a === '회피')      _verdictBadgeTop = '<span class="tx-badge down">하락유력</span>';
          }
        }
