...
function _buildMaCrossCard(stock, indicators){
  ...
  try { window._sxMxLast = { stock: stock, indicators: indicators }; } catch(_e){}
  ...
  const _ctrlRow = '<div style="display:flex;align-items:center;gap:6px;margin-bottom:8px">' + _dirBtn + _nBtn + '</div>';
...
if(typeof window !== 'undefined'){ window._mxToggleDir = _mxToggleDir; window._mxCycleN = _mxCycleN; window._mxRerenderCard = _mxRerenderCard; window._buildMaCrossCard = _buildMaCrossCard; }
