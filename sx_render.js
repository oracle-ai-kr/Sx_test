...
var _BUILDER_DEFAULTS = { volOsc:{dir:'lt',th:-39.6}, cci:{dir:'lt',th:143}, rsi:{dir:'lt',th:61}, bbPctB:{dir:'lt',th:1}, stochK:{dir:'lt',th:83}, adx:{dir:'gt',th:20} };
function _btBuilderRun(){
  ...
  _sxBuilderPreset('rsibb520');   // 요청한 조합 미리 로드
}
function _btBuilderUI(){
  ...
  h+='<button onclick="_sxBuilderPreset(\'volonly\')" style="font-size:9px;padding:4px 8px;border-radius:6px;border:1px solid var(--border);background:var(--surface);color:var(--text2)">거래량OSC 단독</button>';
  h+='<button onclick="_sxBuilderPreset(\'rsibb520\')" style="font-size:9px;padding:4px 8px;border-radius:6px;border:1px solid var(--border);background:var(--surface);color:var(--text2)">RSI+BB+5×20</button>';
  h+='<button onclick="_sxBuilderPreset(\'clear\')" style="font-size:9px;padding:4px 8px;border-radius:6px;border:1px solid var(--border);background:var(--surface);color:var(--text2)">초기화</button>';
  h+='</div>';
  ...
  numF.forEach(function(D){
    var d=_BUILDER_DEFAULTS[D.key]||{dir:'lt',th:0};
