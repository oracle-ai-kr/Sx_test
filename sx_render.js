// ════════════════════════════════════════════════════════════
//  SIGNAL X — Render Engine v2.7 <!-- S86 -->
...
function renderAnalysisResult(stock, scores, indicators, qs, analTime, sectorItp, maAlignItp, basicItp){
  ...
  body.innerHTML = `
    ...
    <div class="anal-header-card">
      ...
      ${(()=>{
        const _analSc = qs ? (qs.readyScore ?? qs.score) : scores.total; // S86: 메인=준비(진입타이밍) 점수
        ...
        return `<div class="anal-score-wrap" style="flex-direction:column;gap:8px">
          <div style="display:flex;justify-content:center;gap:8px;width:100%">
            <div class="anal-score-box" style="flex:1;cursor:pointer" onclick="var el=document.getElementById('${_3stageId}');el.style.display=el.style.display==='none'?'block':'none'">
              ...
              <div class="score-label" style="font-size:9px">진입타이밍</div>
              <div style="font-size:7px;color:var(--accent);margin-top:2px">▶ 전이상세</div>
            </div>
        ...
        ${(()=>{
          ...
          if(stock._btTransitionStats && stock._btTransitionStats.timeline && stock._btTransitionStats.timeline.length >= 3) {
            ...
            html += '<span style="color:var(--accent,#7c5cff)">■ 진입타이밍</span>';
            html += '<span style="color:var(--buy,#e8365a);opacity:.7">■ 강세</span>';
