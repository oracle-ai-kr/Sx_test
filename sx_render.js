 ...
 try{ // S63: 전체 try-catch — 에러 시 무한로딩 방지
  ...
  if(!indicators){
    try{
      ...
      // S108 Phase 3-B-9a-ext: 수동 확장(? 버튼) 기준 데이터로 보존 (초기 200봉)
      if(candles && candles.length > 0) stock._lastAnalCandles = candles;
