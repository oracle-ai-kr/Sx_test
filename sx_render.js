// ════════════════════════════════════════════════════════════
//  SIGNAL X — Render Engine v7.10  [S815 · build 20260630-1345 cache-bust]
// ════════════════════════════════════════════════════════════
...
function _trendRenderInner(){
  ...
  return head+`<div id="sxTrendBody" style="display:${_trOpen?'block':'none'}" data-loaded="1">`+maRow+chipBuy+chipSell+predRow+_guardBadge+stateRow+grid+note+batchSection+`</div>`;   // [S699] 접기 래퍼 · [S752] 실험 칩을 매수/매도 섹션 body 안으로(접으면 같이 감춤) · 🔮크로스 예측만 매도 섹션 다음 별도(항상 보임)
}
...
if(typeof window!=='undefined'){ window._trendOpenDetail=_trendOpenDetail; window._trendDetailClose=_trendDetailClose; window._trendCycleWtMode=_trendCycleWtMode; window._trendToggleWtExclBear=_trendToggleWtExclBear; }
