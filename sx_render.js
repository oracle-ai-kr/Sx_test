...
function _extractFeats733(ind, rows, idx){
  ...
  f.macdGc     = (ind.macd && typeof ind.macd.macd==='number' && typeof ind.macd.signal==='number' && ind.macd.macd>ind.macd.signal) ? 1 : 0;   // MACD>시그널(골든)
  f.macdHistUp = (ind.macd && typeof ind.macd.hist==='number' && ind.macd.hist>0) ? 1 : 0;   // 히스토그램 양(+)
  f.macdBelow0 = (ind.macd && typeof ind.macd.macd==='number' && ind.macd.macd<0) ? 1 : 0;    // 영선 아래(약세구간)
