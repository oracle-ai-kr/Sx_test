// ════════════════════════════════════════════════════════════
//  SIGNAL X — Render Engine v7.10  [S827 · build 20260630-2050 cache-bust]
// ════════════════════════════════════════════════════════════
...
async function _deadcatTrajBracket(mk, onProgress){
  ...
  return { ok:true, rSum:rSum, rCnt:rCnt, rN:rN, fSum:fSum, fCnt:fCnt, fN:fN, stocksUsed:stocksUsed };
}
