...
function _trendRenderInner(){
  ...
  const maRow=`<div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-bottom:8px;font-size:11px;color:var(--text2)">
    ...
    <span onclick="window._trendApply&&_trendApply()" style="margin-left:auto;font-size:11px;font-weight:800;padding:5px 12px;border-radius:7px;background:#2563eb;color:#fff;cursor:pointer">적용</span>
  </div>`;
  // 보조지표 토글 칩
...
if(typeof window!=='undefined'){ window._trendApply=_trendApply; window._trendToggleAux=_trendToggleAux; }
