...
async function _cvPoolRun(){
  ...
  el.innerHTML=_cvPoolRender(rep, watch, mk, _abMode);
}
function _cvPoolRender(rep, watch, mk, abMode){
  ...
  out+='<div style="font-size:11px;font-weight:800;color:'+PUR+';margin-bottom:2px">🔬 점수·등급 풀링 · '+String(mk).toUpperCase()+(abMode?' · <span style="color:#e3493b">🧪 MACD전환 빼고</span>':'')+'</div>';
...
if(typeof window!=='undefined'){ window._cvToggle=_cvToggle; window._cvRunValidation=_cvRunValidation; window._cvRender=_cvRender; window._cvPoolRun=_cvPoolRun; window._cvMacdAbToggle=_cvMacdAbToggle; }
