...
function _trendRenderInner(){
  ...
  return head+`<div id="sxTrendBody" style="display:${_trOpen?'block':'none'}" data-loaded="1">`+maRow+chipRow+reChip+predRow+entryRow+exitRow+_guardBadge+stateRow+grid+note+batchSection+`</div>`;   // [S699] 본문 접기 래퍼(data-loaded=1: C검증 로더 차단)
}
