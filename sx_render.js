  ...
  if(typeof SXI!=='undefined' && qs && indicators){
    ...
    if(summary){
      summaryHTML = `<div class="itp-summary">
        ...
        ${summary.regimeAdvice?`<div style="font-size:10px;padding:8px 10px;background:#eff6ff;border:1px solid #93c5fd;border-radius:6px;margin:6px 0;line-height:1.55"><div style="font-weight:700;color:#1e40af;margin-bottom:4px">💡 시장 환경 고려</div><div style="color:#475569;font-size:9.5px;margin-bottom:4px">${summary.regimeAdvice.reasonSummary}</div><div style="color:var(--text2)">${summary.regimeAdvice.text}</div></div>`:''}
    ...
    if(summaryEl && qs && indicators){
      ...
      if(baseSummary){
        ...
        summaryEl.innerHTML = `
          ...
          ${overridden.regimeAdvice?`<div style="font-size:10px;padding:8px 10px;background:#eff6ff;border:1px solid #93c5fd;border-radius:6px;margin:6px 0;line-height:1.55"><div style="font-weight:700;color:#1e40af;margin-bottom:4px">💡 시장 환경 고려</div><div style="color:#475569;font-size:9.5px;margin-bottom:4px">${overridden.regimeAdvice.reasonSummary}</div><div style="color:var(--text2)">${overridden.regimeAdvice.text}</div></div>`:''}
