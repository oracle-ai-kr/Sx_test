...
function _sxvResultHtml(){
  ...
  var _engOn = preds.some(function(id){ return _sxvEngPreds[id]; });
...
function _sxvRenderResult(R, isPool){
  ...
  var _engMode = (typeof _sxvEngPreds !== 'undefined') && _sxvActivePreds().some(function(id){ return _sxvEngPreds[id]; });
