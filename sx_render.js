...
function _sxPoolHSet(v, el){
  _sxPoolHVal=(+v)||10;
  try{ var row=document.getElementById('sxPoolHRow'); if(row){ var bs=row.querySelectorAll('[data-ph]'); for(var i=0;i<bs.length;i++){ var b=bs[i], on=(+b.getAttribute('data-ph')===_sxPoolHVal); b.style.background=on?'#a855f7':'var(--surface2)'; b.style.color=on?'#fff':'var(--text3)'; b.style.borderColor=on?'#a855f7':'var(--border)'; } } }catch(_e){}
}
