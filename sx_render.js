  ...
  body.innerHTML = `
    ...
    <div class="anal-header-card">
      ...
      ${(()=>{
        ...
        //   _entryEval은 상위 IIFE에서 계산됨 (SXC.calcEntryEvaluation)
