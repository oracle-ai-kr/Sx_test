// ════════════════════════════════════════════════════════════
//  SIGNAL X — Render Engine v2.9 <!-- S88 -->
//  S88: 강세·추세 추이 미니 바차트 추가 (drawDeltaBar 재활용, entryScore/trendScore 매핑)
  ...
  body.innerHTML = `
    ...
    <div class="anal-header-card">
      ...
      ${(()=>{
        ...
        // S79→S87: 모멘텀 변화량 (삼각형 이모지 제거, 숫자만)
        ...
        if(_mom && _mom.history.length >= 2){
          ...
          _momArrow = `<span style="font-size:10px;color:${color};font-weight:700;margin-left:4px">${sign}${_mom.delta}</span>`;
        }
