...
var _sxvPredsOn = { slope:1, slopeTurn:1, rsiGc:1, obv:1, macd:1, closeVsMa:1, rsi50:1, macdCross:1, slopeOrRsi:1, slopeAndRsi:1, resBreak:1, hhBreak:1, volSurge:1, upsideMix:1 };   // [S709] 신호 on/off (기본 전체 on — 14종)
...
var _sxvMixThr = 45;   // [S708] 'C상승 조합' 점화 임계(측정가능 8조건 가중합 85점 기준 · C게이트 60/114≈45)
function _sxvCycleMixThr(){ _sxvMixThr = (_sxvMixThr === 35) ? 45 : (_sxvMixThr === 45) ? 55 : 35; _sxvRerender(); }   // [S708] 조합 임계 35→45→55
...
function _buildValidatorCard(stock, indicators){
  ...
  var mixBn = _sxvPredsOn.upsideMix ? '<span onclick="_sxVib(10);window._sxvCycleMixThr&&_sxvCycleMixThr()" title="C상승 조합 점화 임계(측정가능 8조건 가중합 85점 중). 35→45→55. 기본 45 ≈ C 실제 게이트(60/114 점)." style="font-size:10px;font-weight:800;padding:4px 9px;border-radius:13px;cursor:pointer;border:1px solid #7c3aed55;background:#7c3aed14;color:#7c3aed">조합임계 ' + _sxvMixThr + ' ⟳</span>' : '';
