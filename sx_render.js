...
function _cvRender(R){
  ...
  var _bearGate = (typeof globalThis!=='undefined') && !!globalThis.SX_REBOUND_BEARGATE; // [S726] 약세 rebound 게이트 토글 상태
...
// [S726] 약세 rebound 게이트 A/B 토글 — C globalThis.SX_REBOUND_BEARGATE 플래그를 켜고/끔.
...
function _cvBearGateToggle(el){
  var v = !((typeof globalThis!=='undefined') && globalThis.SX_REBOUND_BEARGATE);
  if(typeof globalThis!=='undefined') globalThis.SX_REBOUND_BEARGATE = v;
  if(el){
    el.textContent = '🚪 약세rebound게이트 ' + (v?'ON':'OFF');
...
async function _cvPoolRun(){
  ...
  var _gateMode=(typeof globalThis!=='undefined') && !!globalThis.SX_REBOUND_BEARGATE; // [S726] 약세 rebound 게이트 모드 캡처
...
function _cvPoolRender(rep, watch, mk, abMode, gateMode){
  ...
  out+='<div style="font-size:11px;font-weight:800;color:'+PUR+';margin-bottom:2px">🔬 점수·등급 풀링 · '+String(mk).toUpperCase()+(abMode?' · <span style="color:#e3493b">🧪 MACD전환 빼고</span>':'')+(gateMode?' · <span style="color:#0d9488">🚪 약세게이트 ON</span>':'')+'</div>';
