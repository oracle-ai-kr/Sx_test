...
function _buildChartPredictCard(stock, indicators){
  ...
  const _titleGroup = `<div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap"><span style="font-size:13px;font-weight:800;color:var(--text)">🔮 차트예측</span><span style="font-size:9px;padding:2px 6px;border-radius:4px;background:var(--surface2);color:var(--text3);border:1px solid var(--border)">실험</span>${_chartBtn}${_btBtn}</div>`;
