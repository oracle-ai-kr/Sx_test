      ...
      ${(()=>{
        ...
        ${(()=>{
          ...
          if(_sr4Tier){
            ...
            html += '<div onclick="_sxVib(8);window._sxbStructRiskWhy&&_sxbStructRiskWhy()" style="cursor:pointer;font-size:10px;font-weight:800;color:'+_sr4Col+';background:'+_sr4Col+'14;border:1px solid '+_sr4Col+'55;border-radius:7px;padding:6px 9px;margin-bottom:9px;line-height:1.4">'+_sr4Txt+'</div>';
          }
          // S86: 변화량 표시 헬퍼
