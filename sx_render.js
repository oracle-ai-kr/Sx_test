...
function _sxModeBarRender(){
  ...
  host.innerHTML='<div style="display:flex;flex-wrap:wrap;align-items:center;gap:6px;padding:8px 10px;background:var(--surface);border:1px solid var(--border);border-radius:12px">'
    ...
    +pill('snap')+pill('recipe')+pill('gate')+pill('macd')
...
if(typeof window!=='undefined'){
  ...
  if(typeof document!=='undefined'){
    if(document.readyState!=='loading') setTimeout(_sxModeBarRender,0); else document.addEventListener('DOMContentLoaded', function(){ setTimeout(_sxModeBarRender,0); });
  }
}
...
var _sxMeasStore={};
function _sxMeasStash(key, data){ try{ _sxMeasStore[key]={ ts:new Date().toISOString(), build:(window.SX_BUILD||''), market:(typeof currentMarket!=='undefined'?currentMarket:''), data:data }; }catch(_e){} }
