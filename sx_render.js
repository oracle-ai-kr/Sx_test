...
function _buildBtBanner(stock, qs){
  ...
  // 데이터 부족 시 간단한 안내 문구 추가 (카드 아래)
  const _insufficientNote = _insufficient
    ? `<div style="margin-top:6px;font-size:10px;color:var(--sell);text-align:center">거래 ${trades}회 / 최소 ${BT_MIN_TRADES}회 필요 — 신뢰도 주의</div>`
    : '';
