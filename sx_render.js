...
function _cvRender(R){
  ...
  h+='<div style="margin-top:10px;border-top:1px dashed var(--border);padding-top:9px">'
    ...
    +'</div>'
    +'<button onclick="_sxVib(12);window._cvPoolRun&&_cvPoolRun()" style="width:100%;font-size:11px;font-weight:800;padding:9px 0;border-radius:8px;cursor:pointer;color:#a855f7;background:var(--surface);border:1px solid #a855f766">🔬 점수·등급 풀링 (대표 vs 관심 · ~3분)</button><div id="sxCvPoolResult" style="margin-top:8px"></div></div>';
  return h;
}
