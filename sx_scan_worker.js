      ...
      for (let bi = 0; bi < batch.length; bi++) {
        ...
        if (indicators && indicators._advanced) {
          ...
          const _sfW = (typeof SXE !== 'undefined' && SXE._safetyFlags && Object.keys(SXE._safetyFlags).length)
            ? SXE._safetyFlags
            : {threshold:true,volExtreme:true,volHigh:true,rsiDiv:true,stochRsi:true,macdNeg:true,ma60resist:true,bbUpper:true,resistNear:true,chaseGuard:true,dumpWarn:true,deadCrossGuard:true,debtRatio:true,foreignSell:true,highBeta:true};
