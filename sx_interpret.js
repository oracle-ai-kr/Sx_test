// ════════════════════════════════════════════════════════════
//  SIGNAL X — Interpret Engine v4.8 <!-- S99 -->
 ...
 */
SXI.threeStageReport = function(qs, scoreMom, btResult, btScore, lastCandleDate, btTransitionStats, verdictAction) {
  if (!qs) return null;
  ...
  if (verdictAction) {
    ...
    if (_va === '매수' || _va === '관심' || _va === '대기') _tone = 'entry';
    else if (_va === '보유 유지' || _va === '관망' || _va === '청산 준비') _tone = 'caution';
    else if (_va === '회피' || _va === '즉시 청산' || _va === '청산 검토' || _va === '매도 완료') _tone = 'exit';
  }
