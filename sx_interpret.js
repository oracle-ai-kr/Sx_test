// ════════════════════════════════════════════════════════════
//  SIGNAL X — Interpret Engine v5.1 <!-- S103-fix7 Phase3-B-1 practicalGuide C화(btAction 4종 → verdictAction 9종 직접수신, 신규 5종 가이드: 보유유지/청산준비/청산검토/즉시청산/매도완료) --> v5.0 <!-- S103-fix7 Phase3-A-3 _buildVerdict 감독관기반 전면재작성(점수stage 폐기, verdictAction 9종 직접매핑 → 배너와 완전정합) + threeStageReport 8th param btStateObj 추가 → 매도완료 익절/손절/수익률/진입가 본문 표시 --> v4.9 <!-- S103-fix7 Phase3-A-2 threeStageReport 톤 매핑 재조정("대기"폐지, "관망"→entry(비보유 관찰), "회피"→entry(진입안함), caution=보유중+아직청산X, exit=매도확정) --> v4.8 <!-- S99 -->
