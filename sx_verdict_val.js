...
(function(){
  ...
  function run(rows, tf, market, opts){
    ...
    for(var e = warmup; e <= lastE; e += step){
      ...
      if(records){ var _rec = { p:pass, path:path, lt:(sc.ltAlign||'off'), act:act, ret:retC, retO:retO, cap:_capped?1:0, viol:_hasViol?1:0, rd:_ax.rd, en:_ax.en, tr:_ax.tr, up:_ax.up }; if(_rab) _rec.rab = _rab; if(_uab) _rec.uab = _uab; if(_tab) _rec.tab = _tab; if(_eab) _rec.eab = _eab; records.push(_rec); } // [S691] lt · [S721-723] rab/uab/tab/eab
    }
  ...
  function pool(records){
    ...
    var gate = { bull:_gateCell(function(r){ return r.lt === 'bull'; }), nonbull:_gateCell(function(r){ return r.lt !== 'bull'; }), bear:_gateCell(function(r){ return r.lt === 'bear'; }), off:_gateCell(function(r){ return r.lt !== 'bull' && r.lt !== 'bear'; }) }; // [S692] off=중립 분해
    return {
