...
const SX_CONDITIONS = [
  ...
  {id:'engine_verdict',name:'엔진 판정',phase:'p3',groups:[
    {id:'ta_signal',name:'분석 판정',conditions:[
      ...
      {axis4:'buy',id:'_engine_buy',name:'매수 배지',type:'select',options:['설정안함','매수 판정'],default:'설정안함',source:'calc_candle',desc:'엔진 4축 판정 결과가 매수인 종목 - 결과탭 상단 🟢매수 배지와 동일',recommend:'매수 판정 → 4축 전부 합격 종목만 필터'},
    ]},
  ]},
