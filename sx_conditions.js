...
const PRESETS_US_P2 = [
  ...
  {id:'p2_us_bear_env',name:'약세장 방어',phase:'p2',desc:'시장약세 + RSI과매도 + MACD골든 + BB하단',locked:true,conditions:{mkt_env_state:'약세 포함 (mild_bear+bear)',rsi_value:{min:0,max:30},macd_signal:'골든크로스 (3일 이내)',bb_position:'하단 이탈'}},
];
