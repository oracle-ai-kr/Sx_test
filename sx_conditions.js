...
const SX_CONDITIONS = [
  ...
  {id:'engine_verdict',name:'엔진 판정',phase:'p3',groups:[
    ...
    {id:'pat_trend',name:'단기추세 매매 (실험)',conditions:[
      ...
      {id:'knn_dday',name:'kNN 크로스 임박 (D-day)',type:'select',options:['설정안함','골든크로스 임박','데드크로스 임박'],default:'설정안함',source:'calc_candle',desc:'kNN+MA수렴으로 골든/데드 크로스가 3봉 내 임박(과거 유사패턴 적중 50%↑)한 종목. 분석탭 단기추세 D-day와 동일 엔진 · 5×9 · 룩어헤드 차단. [S633]',recommend:'골든크로스 임박 → 곧 진입 신호 나올 후보 선점'},
    ]},
  ]},
