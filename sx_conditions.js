...
const PRESETS_COIN_P2 = [
  ...
  {id:'p2_coin_squeeze',name:'변동성 폭발 대기',phase:'p2',desc:'BB 스퀴즈 + VHF 횡보 + 거래량 연속증가 + OBV 상승',locked:true,conditions:{bb_width:'스퀴즈 (수축)',vhf_state:'횡보장 (<0.3)',volume_consec_inc:{min:3,max:null},obv_trend:'상승 추세'}},
...
const PRESETS_US_P2 = [
  ...
  {id:'p2_us_candle_rev',name:'캔들 반전',phase:'p2',desc:'반전패턴 + RSI 과매도 + 거래량↑',locked:true,conditions:{reversal_pattern:['morning_star','bullish_engulfing','morning_doji_star','abandoned_baby_bull','hammer'],rsi_value:{min:null,max:35},volume_avg20_ratio:{min:150,max:null}}},
  // ── 준비 (S161-2: 신규) ──
  ...
  {id:'p2_us_squeeze',name:'변동성 폭발 대기',phase:'p2',desc:'BB 스퀴즈 + VHF 횡보 + 거래량 연속증가 + OBV 상승',locked:true,conditions:{bb_width:'스퀴즈 (수축)',vhf_state:'횡보장 (<0.3)',volume_consec_inc:{min:3,max:null},obv_trend:'상승 추세'}},
  ...
  // ── 환경 ──
  {id:'p2_us_bull_env',name:'강세장 공격',phase:'p2',desc:'시장강세 + 정배열 + MACD매수 + HH/HL + VWAP위 + 거래량폭발',locked:true,conditions:{mkt_env_state:'강세 (bull)',ma_arrangement:'정배열 (3개)',macd_signal:'MACD > Signal (매수)',swing_structure:'HH+HL (상승구조)',vwap_position:'VWAP 위 (강세)',volume_avg20_ratio:{min:200,max:null}}},
  {id:'p2_us_bear_env',name:'약세장 방어',phase:'p2',desc:'시장약세 + RSI과매도 + MACD골든 + BB하단 + PER저평가 + 배당',locked:true,conditions:{mkt_env_state:'약세 (bear)',rsi_value:{min:0,max:30},macd_signal:'골든크로스 (3일 이내)',bb_position:'하단 이탈',per:{min:0,max:15},dividend_yield:{min:2,max:null}}},
];
