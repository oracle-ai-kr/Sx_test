...
const PRESETS_KR_P3 = [
  ...
  {id:'p3_kr_c_buy',  name:'매수',phase:'p3',desc:'C판정 = 매수 (A긍정 × B매수신호)',locked:true,conditions:{_bt_action:'매수'}},
  {id:'p3_kr_c_watch',name:'관심',phase:'p3',desc:'C판정 = 관심 (A긍정 × B대기, 선행 포착)',locked:true,conditions:{_bt_action:'관심'}},
  // [2026-04] BT 손익비 세트 프리셋 (기본 1.5 이상 — 평균이익/평균손실 ≥ 1.5)
  {id:'p3_kr_bt_pf',  name:'BT 손익비',phase:'p3',desc:'BT 손익비 1.5 이상 (평균이익/평균손실)',locked:true,conditions:{_bt_pf:{min:1.5,max:null}}},
];
...
const PRESETS_COIN_P3 = [
  ...
  {id:'p3_coin_c_buy',  name:'매수',phase:'p3',desc:'C판정 = 매수 (A긍정 × B매수신호)',locked:true,conditions:{_bt_action:'매수'}},
  {id:'p3_coin_c_watch',name:'관심',phase:'p3',desc:'C판정 = 관심 (A긍정 × B대기, 선행 포착)',locked:true,conditions:{_bt_action:'관심'}},
  // [2026-04] BT 손익비 세트 프리셋
  {id:'p3_coin_bt_pf',  name:'BT 손익비',phase:'p3',desc:'BT 손익비 1.5 이상 (평균이익/평균손실)',locked:true,conditions:{_bt_pf:{min:1.5,max:null}}},
];
...
const PRESETS_US_P3 = [
  ...
  {id:'p3_us_c_buy',  name:'매수',phase:'p3',desc:'C판정 = 매수 (A긍정 × B매수신호)',locked:true,conditions:{_bt_action:'매수'}},
  {id:'p3_us_c_watch',name:'관심',phase:'p3',desc:'C판정 = 관심 (A긍정 × B대기, 선행 포착)',locked:true,conditions:{_bt_action:'관심'}},
];
