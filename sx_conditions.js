...
const PRESETS_KR_P3 = [
  // [v2.5] 4축 점수 + 방향 전이(모멘텀) 5조건 프리셋
  //   v2.0 4축 룰 + 모멘텀 보정 사상 그대로 반영 — 점수 합격 + 모멘텀 ↑ 동반 시 진입
  //   매수 (4합격 + 상승): 바닥≥60, 반등≥60, 추세≥50, 전략≥60, 방향=상승 전이중
  //   관심 (3합격 + 상승): 바닥≥50, 반등≥50, 추세≥40, 전략≥50, 방향=상승 전이중
  //   관망 (2합격 + 상승): 바닥≥40, 반등≥40, 추세≥30, 전략≥40, 방향=상승 전이중
  //   세 칩 모두 '상승 전이중' 동반 — 점수 합격 + 모멘텀 살아있는 종목만 추출
  //     (점수만 보면 꺾이는 종목 잡는 함정 발생 → 모멘텀으로 한 번 더 차단)
  //   기존 _bt_action/_bt_pf/_bt_mdd 필터는 제거 — 매매전략 점수(_bt_score)에 PF/MDD 다 녹아있음
  {id:'p3_kr_c_buy',  name:'매수',phase:'p3',desc:'4축 점수 매수급 + 상승 전이중 — 반등≥60·강도≥60·추세≥50·전략≥60',locked:true,conditions:{_ready_score:{min:60,max:100},_entry_score:{min:60,max:100},score_range:{min:50,max:100},_bt_score:{min:60,max:100},_dir_mom:'상승 전이중'}},
  {id:'p3_kr_c_watch',name:'관심',phase:'p3',desc:'4축 점수 관심급 + 상승 전이중 — 반등≥50·강도≥50·추세≥40·전략≥50',locked:true,conditions:{_ready_score:{min:50,max:100},_entry_score:{min:50,max:100},score_range:{min:40,max:100},_bt_score:{min:50,max:100},_dir_mom:'상승 전이중'}},
  {id:'p3_kr_c_observe',name:'관망',phase:'p3',desc:'4축 점수 관망급 + 상승 전이중 — 반등≥40·강도≥40·추세≥30·전략≥40',locked:true,conditions:{_ready_score:{min:40,max:100},_entry_score:{min:40,max:100},score_range:{min:30,max:100},_bt_score:{min:40,max:100},_dir_mom:'상승 전이중'}},
];
...
const PRESETS_COIN_P3 = [
  // [v2.5] 4축 점수 + 방향 전이(모멘텀) 5조건 프리셋
  //   KR과 동일 기준 — 점수/모멘텀은 시장 무관하게 정규화되어 있어 동일 임계 적용
  {id:'p3_coin_c_buy',  name:'매수',phase:'p3',desc:'4축 점수 매수급 + 상승 전이중 — 반등≥60·강도≥60·추세≥50·전략≥60',locked:true,conditions:{_ready_score:{min:60,max:100},_entry_score:{min:60,max:100},score_range:{min:50,max:100},_bt_score:{min:60,max:100},_dir_mom:'상승 전이중'}},
  {id:'p3_coin_c_watch',name:'관심',phase:'p3',desc:'4축 점수 관심급 + 상승 전이중 — 반등≥50·강도≥50·추세≥40·전략≥50',locked:true,conditions:{_ready_score:{min:50,max:100},_entry_score:{min:50,max:100},score_range:{min:40,max:100},_bt_score:{min:50,max:100},_dir_mom:'상승 전이중'}},
  {id:'p3_coin_c_observe',name:'관망',phase:'p3',desc:'4축 점수 관망급 + 상승 전이중 — 반등≥40·강도≥40·추세≥30·전략≥40',locked:true,conditions:{_ready_score:{min:40,max:100},_entry_score:{min:40,max:100},score_range:{min:30,max:100},_bt_score:{min:40,max:100},_dir_mom:'상승 전이중'}},
];
...
const PRESETS_US_P3 = [
  // [v2.5] 4축 점수 + 방향 전이(모멘텀) 5조건 프리셋
  //   KR/COIN과 동일 기준 — 점수/모멘텀은 시장 무관하게 정규화되어 있어 동일 임계 적용
  {id:'p3_us_c_buy',  name:'매수',phase:'p3',desc:'4축 점수 매수급 + 상승 전이중 — 반등≥60·강도≥60·추세≥50·전략≥60',locked:true,conditions:{_ready_score:{min:60,max:100},_entry_score:{min:60,max:100},score_range:{min:50,max:100},_bt_score:{min:60,max:100},_dir_mom:'상승 전이중'}},
  {id:'p3_us_c_watch',name:'관심',phase:'p3',desc:'4축 점수 관심급 + 상승 전이중 — 반등≥50·강도≥50·추세≥40·전략≥50',locked:true,conditions:{_ready_score:{min:50,max:100},_entry_score:{min:50,max:100},score_range:{min:40,max:100},_bt_score:{min:50,max:100},_dir_mom:'상승 전이중'}},
  {id:'p3_us_c_observe',name:'관망',phase:'p3',desc:'4축 점수 관망급 + 상승 전이중 — 반등≥40·강도≥40·추세≥30·전략≥40',locked:true,conditions:{_ready_score:{min:40,max:100},_entry_score:{min:40,max:100},score_range:{min:30,max:100},_bt_score:{min:40,max:100},_dir_mom:'상승 전이중'}},
];
