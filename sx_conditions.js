...
const SX_CONDITIONS = [
  ...
  {id:'technical',name:'기술적분석',phase:'p2',groups:[
    {id:'ta_ma',name:'이동평균선',conditions:[
      ...
      {id:'_recent_n_bars',name:'최근 N봉',type:'range',unit:'봉',min:1,max:60,default:{min:1,max:1},source:'calc_candle',desc:'기술적/패턴 조건의 평가 대상 봉 범위 (예: 5 입력 시 최근 5봉 중 한 봉이라도 조건 동시 충족 시 통과)'},
