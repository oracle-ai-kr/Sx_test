...
const SX_CONDITIONS = [
  ...
  {id:'engine_verdict',name:'엔진 판정',phase:'p3',groups:[
    {id:'ta_signal',name:'분석 판정',conditions:[
      ...
      {axis4:'buy',id:'_c_buy_marker',name:'매수마커 ▲',type:'select',options:['설정안함','매수마커 있음'],default:'설정안함',source:'calc_candle',desc:'C 매수마커(▲) — 통합판정(C) 매수 = 차트 보라 ▲와 정확히 동일. 안전필터 등급캡·매도전환 반영(매수→관망/청산 시 자동 제외). 보유중 매수도 인정 [S474]',recommend:'매수마커 있음 → 분석엔진 매수 후보 (안전필터 통과)'},
    ]},
  ]},
