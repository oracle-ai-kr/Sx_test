...
const PRESETS_KR_P3 = [
  // [v2.4] 4축 점수 기반 매수/관심/관망 3개 (희창 리퀘스트)
  //   v2.0 4축 룰의 핵심 점수를 직접 노출 — 사용자가 보는 점수 = 칩 조건 (UI 일관성)
  //   매수 (4축 합격 4/4 기준):  바닥≥60, 반등≥60, 추세≥50, 전략≥60
  //   관심 (4축 합격 3/4 기준):  바닥≥50, 반등≥50, 추세≥40, 전략≥50
  //   관망 (4축 합격 2/4 기준):  바닥≥40, 반등≥40, 추세≥30, 전략≥40
  //   기존 _bt_action/_dir_mom/_bt_pf/_bt_mdd 필터는 제거 — 매매전략 점수(_bt_score)에 PF/MDD 다 녹아있음
  {id:'p3_kr_c_buy',  name:'매수',phase:'p3',desc:'4축 점수 매수급 — 반등≥60·강도≥60·추세≥50·전략≥60',locked:true,conditions:{_ready_score:{min:60,max:100},_entry_score:{min:60,max:100},score_range:{min:50,max:100},_bt_score:{min:60,max:100}}},
  {id:'p3_kr_c_watch',name:'관심',phase:'p3',desc:'4축 점수 관심급 — 반등≥50·강도≥50·추세≥40·전략≥50',locked:true,conditions:{_ready_score:{min:50,max:100},_entry_score:{min:50,max:100},score_range:{min:40,max:100},_bt_score:{min:50,max:100}}},
  {id:'p3_kr_c_observe',name:'관망',phase:'p3',desc:'4축 점수 관망급 — 반등≥40·강도≥40·추세≥30·전략≥40',locked:true,conditions:{_ready_score:{min:40,max:100},_entry_score:{min:40,max:100},score_range:{min:30,max:100},_bt_score:{min:40,max:100}}},
];
...
const PRESETS_COIN_P3 = [
  // [v2.4] 4축 점수 기반 매수/관심/관망 3개 (희창 리퀘스트)
  //   KR과 동일 기준 — 점수는 시장 무관하게 0~100 정규화되어 있어 동일 임계 적용
  {id:'p3_coin_c_buy',  name:'매수',phase:'p3',desc:'4축 점수 매수급 — 반등≥60·강도≥60·추세≥50·전략≥60',locked:true,conditions:{_ready_score:{min:60,max:100},_entry_score:{min:60,max:100},score_range:{min:50,max:100},_bt_score:{min:60,max:100}}},
  {id:'p3_coin_c_watch',name:'관심',phase:'p3',desc:'4축 점수 관심급 — 반등≥50·강도≥50·추세≥40·전략≥50',locked:true,conditions:{_ready_score:{min:50,max:100},_entry_score:{min:50,max:100},score_range:{min:40,max:100},_bt_score:{min:50,max:100}}},
  {id:'p3_coin_c_observe',name:'관망',phase:'p3',desc:'4축 점수 관망급 — 반등≥40·강도≥40·추세≥30·전략≥40',locked:true,conditions:{_ready_score:{min:40,max:100},_entry_score:{min:40,max:100},score_range:{min:30,max:100},_bt_score:{min:40,max:100}}},
];
...
const PRESETS_US_P3 = [
  // [v2.4] 4축 점수 기반 매수/관심/관망 3개 (희창 리퀘스트)
  //   KR/COIN과 동일 기준 — 점수는 시장 무관하게 0~100 정규화되어 있어 동일 임계 적용
  {id:'p3_us_c_buy',  name:'매수',phase:'p3',desc:'4축 점수 매수급 — 반등≥60·강도≥60·추세≥50·전략≥60',locked:true,conditions:{_ready_score:{min:60,max:100},_entry_score:{min:60,max:100},score_range:{min:50,max:100},_bt_score:{min:60,max:100}}},
  {id:'p3_us_c_watch',name:'관심',phase:'p3',desc:'4축 점수 관심급 — 반등≥50·강도≥50·추세≥40·전략≥50',locked:true,conditions:{_ready_score:{min:50,max:100},_entry_score:{min:50,max:100},score_range:{min:40,max:100},_bt_score:{min:50,max:100}}},
  {id:'p3_us_c_observe',name:'관망',phase:'p3',desc:'4축 점수 관망급 — 반등≥40·강도≥40·추세≥30·전략≥40',locked:true,conditions:{_ready_score:{min:40,max:100},_entry_score:{min:40,max:100},score_range:{min:30,max:100},_bt_score:{min:40,max:100}}},
];
