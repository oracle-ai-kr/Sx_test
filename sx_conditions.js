...
const PRESETS_KR_P2 = [
  ...
  {id:'p2_kr_vol_extreme',name:'극단변동성 차단',phase:'p2',desc:'당일 변동 8%↓ + 상승갭 제외',locked:true,conditions:{intraday_range:{min:null,max:8}}},
...
const PRESETS_COIN_P2 = [
  ...
  {id:'p2_coin_vol_extreme',name:'극단변동성 차단',phase:'p2',desc:'당일 변동 15%↓',locked:true,conditions:{intraday_range:{min:null,max:15}}},
  // ── 환경 ──
...
const PRESETS_US_P2 = [
  ...
  {id:'p2_us_vol_extreme',name:'극단변동성 차단',phase:'p2',desc:'당일 변동 6%↓',locked:true,conditions:{intraday_range:{min:null,max:6}}},
  // ── 환경 ──
