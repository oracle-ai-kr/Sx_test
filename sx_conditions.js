...
const SX_CONDITIONS = [
  ...
  {id:'price_analysis',name:'시세분석',phase:'p1',groups:[
    ...
    {id:'intraday_cond',name:'당일 분봉 [KIS]',kisRequired:true,conditions:[
      ...
      {id:'program_realtime',name:'개인 실시간 순매수',type:'range',unit:'백만원',min:null,max:null,default:{min:null,max:null},source:'kis_program',kisRequired:true,desc:'KIS 투자자별 데이터 - 개인 순매수금액 (오늘 누적, 백만원 단위)'},
    ]},
  ]},
