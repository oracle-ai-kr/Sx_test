...
const SX_CONDITIONS = [
  ...
  {id:'engine_verdict',name:'엔진 판정',phase:'p3',groups:[
    {id:'ta_signal',name:'분석 판정',conditions:[
      ...
      {axis4:'buy',id:'_c_buy_marker',name:'매수마커 ▲',type:'select',options:['설정안함','매수마커 있음'],default:'설정안함',source:'calc_candle',desc:'A+안전필터 매수마커(▲) — 분석엔진 매수(qs.action=BUY, 안전필터 통과 시). 차트 보라 ▲와 동일. C 9종판정은 검토영역 참고 [S455]',recommend:'매수마커 있음 → 분석엔진 매수 후보 (안전필터 통과)'},
    ]},
  ]},
