// ════════════════════════════════════════════════════════════
//  SIGNAL X — Conditions & Presets v2.2 <!-- S100 -->
//  S100: 프리셋 정리 — 기본필터(P1) 프리셋 삭제, 맞는거같은데?/맞네!!! 삭제
//  S80: 3단 점수 필터(_ready_score/_entry_score/_trend_score)
//  S68: 조건트리 + 프리셋 Phase별 분리 + 조합 시스템
//  Phase 2: 기술분석 (캔들+지표 엔진)
//  Phase 3: 검증 (BT + 엔진 판정)
//  의존: currentMarket (글로벌)
// ════════════════════════════════════════════════════════════

// ── Phase 정의 (조건트리는 3Phase 유지, 프리셋 칩만 기술분석+검증) ──
const SX_PHASES = [
