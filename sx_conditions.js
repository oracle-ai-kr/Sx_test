...
const PRESETS_KR_P2 = [
  // ── 공격 ──
  {id:'p2_kr_trend',name:'추세 추종',phase:'p2',desc:'정배열 + HH/HL 상승 + MACD매수 + OBV상승 + RSI 50~70 + VHF추세장',locked:true,conditions:{ma_arrangement:'정배열 (3개)',swing_structure:'HH+HL (상승구조)',macd_signal:'MACD > Signal (매수)',obv_trend:'상승 추세',rsi_value:{min:50,max:70},vhf_state:'추세장 (>0.4)'}},
  ...
  {id:'p2_kr_candle_rev',name:'캔들 반전',phase:'p2',desc:'반전패턴 + RSI 과매도 + 거래량↑',locked:true,conditions:{reversal_pattern:['morning_star','bullish_engulfing','morning_doji_star','abandoned_baby_bull','hammer','piercing','tweezer_bottom','harami_bull','dragonfly_doji'],rsi_value:{min:null,max:35},volume_avg20_ratio:{min:150,max:null}}},
  // ── 준비 ──
  {id:'p2_kr_squeeze',name:'변동성 폭발 대기',phase:'p2',desc:'BB 스퀴즈 + VHF 횡보 + 거래량 연속증가 + OBV 상승',locked:true,conditions:{bb_width:'스퀴즈 (수축)',vhf_state:'횡보장 (<0.3)',volume_consec_inc:{min:5,max:null},obv_trend:'상승 추세'}},
  {id:'p2_kr_accumulation',name:'세력 매집',phase:'p2',desc:'OBV상승 + A/D매집 + Chaikin매집 + 횡보 + 거래량↑',locked:true,conditions:{obv_trend:'상승 추세',ad_trend:'상승 추세',chaikin_osc:'양수 (매집)',change_rate:{min:-2,max:2},volume_avg20_ratio:{min:120,max:null}}},
  ...
  {id:'p2_kr_chase_defense',name:'추격매수 방어',phase:'p2',desc:'5일변동 20%↓ + 거래량 300%↓ + 52주고점 -20%↓',locked:true,conditions:{period_change:{min:null,max:20},volume_avg20_ratio:{min:null,max:300},week52_high_ratio:{min:null,max:-20}}},
  {id:'p2_kr_sideways_avoid',name:'횡보장 회피',phase:'p2',desc:'ADX 20↑ + VHF 추세장 + MACD 매수',locked:true,conditions:{adx_value:{min:20,max:null},vhf_state:'추세장 (>0.4)',macd_signal:'MACD > Signal (매수)'}},
  {id:'p2_kr_vol_extreme',name:'극단변동성 차단',phase:'p2',desc:'당일 변동 8%↓ + 상승갭 제외',locked:true,conditions:{intraday_range:{min:null,max:8},gap_type:'상승갭 제외'}},
  ...
  // ── 환경 ──
  {id:'p2_kr_bull_env',name:'강세장 공격',phase:'p2',desc:'시장강세 + 정배열 + MACD매수 + 거래량폭발',locked:true,conditions:{mkt_env_state:'강세 포함 (mild_bull+bull)',ma_arrangement:'정배열 (3개)',macd_signal:'MACD > Signal (매수)',volume_avg20_ratio:{min:200,max:null}}},
  {id:'p2_kr_bear_env',name:'약세장 방어',phase:'p2',desc:'시장약세 + RSI반등 + MACD골든 + BB하단',locked:true,conditions:{mkt_env_state:'약세 포함 (mild_bear+bear)',rsi_value:{min:25,max:40},macd_signal:'골든크로스 (3일 이내)',bb_position:'하단 이탈'}},
];

const PRESETS_KR_P3 = [
  // S161: 5개 → 3개로 정리 (추세 점수 60↑, 안전 매수 제거 — 중복 및 단순 조건이라 직접 조건으로 담는 게 명확)
...
const PRESETS_COIN_P2 = [
  // ── 공격 ──
  {id:'p2_coin_trend',name:'추세 라이딩',phase:'p2',desc:'정배열 + MACD매수 + OBV상승 + RSI 50~70 + VHF추세장',locked:true,conditions:{ma_arrangement:'정배열 (3개)',macd_signal:'MACD > Signal (매수)',obv_trend:'상승 추세',rsi_value:{min:50,max:70},vhf_state:'추세장 (>0.4)'}},
  {id:'p2_coin_pullback',name:'눌림목 매수',phase:'p2',desc:'정배열 + MA20 근접 + RSI 40~55 + OBV상승 + VHF추세장',locked:true,conditions:{ma_arrangement:'정배열 (3개)',ma_disparity:'MA20 근접 (±2%)',rsi_value:{min:40,max:55},obv_trend:'상승 추세',vhf_state:'추세장 (>0.4)'}},
  {id:'p2_coin_reversal',name:'과매도 반등',phase:'p2',desc:'RSI 과매도 + MACD 골든 + BB 하단 + 심리도 과매도',locked:true,conditions:{rsi_value:{min:20,max:35},macd_signal:'골든크로스 (3일 이내)',bb_position:'하단 이탈',psycho_value:{min:null,max:25}}},
  {id:'p2_coin_breakout',name:'급등 시작',phase:'p2',desc:'등락률 5%↑ + 거래량 200%↑ + VWAP위 + MACD매수 + EOM매수',locked:true,conditions:{change_rate:{min:5,max:null},volume_avg20_ratio:{min:200,max:null},vwap_position:'VWAP 위 (강세)',macd_signal:'MACD > Signal (매수)',eom_trend:'매수세 (상승)'}},
  // ── 준비 ──
  {id:'p2_coin_accumulation',name:'매집 감지',phase:'p2',desc:'OBV상승 + A/D매집 + Chaikin매집 + 횡보 + 거래량↑',locked:true,conditions:{obv_trend:'상승 추세',ad_trend:'상승 추세',chaikin_osc:'양수 (매집)',change_rate:{min:-3,max:3},volume_avg20_ratio:{min:150,max:null}}},
  {id:'p2_coin_squeeze',name:'변동성 폭발 대기',phase:'p2',desc:'BB 스퀴즈 + VHF 횡보 + 거래량 연속증가 + OBV 상승',locked:true,conditions:{bb_width:'스퀴즈 (수축)',vhf_state:'횡보장 (<0.3)',volume_consec_inc:{min:5,max:null},obv_trend:'상승 추세'}},
  // ── 방어 (S161-2: 코인 맞춤 임계값 — KR 대비 완화) ──
  {id:'p2_coin_chase_defense',name:'추격매수 방어',phase:'p2',desc:'5일변동 40%↓ + 거래량 400%↓',locked:true,conditions:{period_change:{min:null,max:40},volume_avg20_ratio:{min:null,max:400}}},
  {id:'p2_coin_sideways_avoid',name:'횡보장 회피',phase:'p2',desc:'ADX 20↑ + VHF 추세장 + MACD 매수',locked:true,conditions:{adx_value:{min:20,max:null},vhf_state:'추세장 (>0.4)',macd_signal:'MACD > Signal (매수)'}},
  {id:'p2_coin_vol_extreme',name:'극단변동성 차단',phase:'p2',desc:'당일 변동 15%↓ + 상승갭 제외',locked:true,conditions:{intraday_range:{min:null,max:15},gap_type:'상승갭 제외'}},
  // ── 환경 ──
  {id:'p2_coin_bull_env',name:'강세장 공격',phase:'p2',desc:'BTC강세 + 정배열 + MACD매수 + 거래량폭발',locked:true,conditions:{mkt_env_state:'강세 포함 (mild_bull+bull)',ma_arrangement:'정배열 (3개)',macd_signal:'MACD > Signal (매수)',volume_avg20_ratio:{min:200,max:null},eom_trend:'매수세 (상승)'}},
  {id:'p2_coin_bear_env',name:'약세장 방어',phase:'p2',desc:'BTC약세 + RSI과매도 + MACD골든 + BB하단',locked:true,conditions:{mkt_env_state:'약세 포함 (mild_bear+bear)',rsi_value:{min:20,max:35},macd_signal:'골든크로스 (3일 이내)',bb_position:'하단 이탈'}},
];

const PRESETS_COIN_P3 = [
  // S161-2: KR과 동일 체제로 정리 — 추세 점수 60↑ 제거(단순조건은 직접 담는 게 명확), 회피 종목 추가
  {id:'p3_coin_bt_verified',name:'BT 검증',phase:'p3',desc:'매매전략 60↑ + 승률 50%↑ + 거래수 3↑',locked:true,conditions:{_bt_score:{min:60,max:null},_bt_winrate:{min:50,max:null},_bt_trades:{min:3,max:null}}},
  {id:'p3_coin_entry',name:'진입 적기',phase:'p3',desc:'종합행동지침 = 진입 적기',locked:true,conditions:{_bt_action:'진입 적기'}},
  {id:'p3_coin_avoid',name:'회피 종목',phase:'p3',desc:'종합행동지침 = 회피',locked:true,conditions:{_bt_action:'회피'}},
];
...
const PRESETS_US_P2 = [
  // ── 공격 ──
  {id:'p2_us_trend',name:'추세 추종',phase:'p2',desc:'정배열 + MACD매수 + OBV상승 + HH/HL + RSI 50~70 + VHF추세장',locked:true,conditions:{ma_arrangement:'정배열 (3개)',macd_signal:'MACD > Signal (매수)',obv_trend:'상승 추세',swing_structure:'HH+HL (상승구조)',rsi_value:{min:50,max:70},vhf_state:'추세장 (>0.4)'}},
  {id:'p2_us_pullback',name:'눌림목 매수',phase:'p2',desc:'정배열 + MA20 근접 + RSI 40~55 + OBV상승 + VHF추세장',locked:true,conditions:{ma_arrangement:'정배열 (3개)',ma_disparity:'MA20 근접 (±2%)',rsi_value:{min:40,max:55},obv_trend:'상승 추세',vhf_state:'추세장 (>0.4)'}},
  {id:'p2_us_reversal',name:'과매도 반등',phase:'p2',desc:'RSI 과매도 + MACD 골든 + BB 하단 + 심리도 과매도',locked:true,conditions:{rsi_value:{min:20,max:35},macd_signal:'골든크로스 (3일 이내)',bb_position:'하단 이탈',psycho_value:{min:null,max:25}}},
  {id:'p2_us_breakout',name:'급등 시작',phase:'p2',desc:'20일 신고가 + 거래량 200%↑ + VWAP위 + MACD매수 + EOM매수',locked:true,conditions:{new_high_low:'20일 신고가',volume_avg20_ratio:{min:200,max:null},vwap_position:'VWAP 위 (강세)',macd_signal:'MACD > Signal (매수)',eom_trend:'매수세 (상승)'}},
  {id:'p2_us_candle_rev',name:'캔들 반전',phase:'p2',desc:'반전패턴 + RSI 과매도 + 거래량↑',locked:true,conditions:{reversal_pattern:['morning_star','bullish_engulfing','morning_doji_star','abandoned_baby_bull','hammer','piercing','tweezer_bottom','harami_bull','dragonfly_doji'],rsi_value:{min:null,max:35},volume_avg20_ratio:{min:150,max:null}}},
  // ── 준비 (S161-2: 신규) ──
  {id:'p2_us_accumulation',name:'매집 감지',phase:'p2',desc:'OBV상승 + A/D매집 + Chaikin매집 + 횡보 + 거래량↑',locked:true,conditions:{obv_trend:'상승 추세',ad_trend:'상승 추세',chaikin_osc:'양수 (매집)',change_rate:{min:-2,max:2},volume_avg20_ratio:{min:120,max:null}}},
  {id:'p2_us_squeeze',name:'변동성 폭발 대기',phase:'p2',desc:'BB 스퀴즈 + VHF 횡보 + 거래량 연속증가 + OBV 상승',locked:true,conditions:{bb_width:'스퀴즈 (수축)',vhf_state:'횡보장 (<0.3)',volume_consec_inc:{min:5,max:null},obv_trend:'상승 추세'}},
  {id:'p2_us_gap_support',name:'갭상승 후 지지',phase:'p2',desc:'갭상승 후 지지 + 거래량↑ + EOM매수 + VWAP위',locked:true,conditions:{gap_type:'갭상승 후 지지',volume_avg20_ratio:{min:150,max:null},eom_trend:'매수세 (상승)',vwap_position:'VWAP 위 (강세)'}},
  // ── 방어 (S161-2: 신규, US 맞춤 임계값 — KR보다 타이트) ──
  {id:'p2_us_chase_defense',name:'추격매수 방어',phase:'p2',desc:'5일변동 15%↓ + 거래량 250%↓ + 52주고점 -15%↓',locked:true,conditions:{period_change:{min:null,max:15},volume_avg20_ratio:{min:null,max:250},week52_high_ratio:{min:null,max:-15}}},
  {id:'p2_us_sideways_avoid',name:'횡보장 회피',phase:'p2',desc:'ADX 20↑ + VHF 추세장 + MACD 매수',locked:true,conditions:{adx_value:{min:20,max:null},vhf_state:'추세장 (>0.4)',macd_signal:'MACD > Signal (매수)'}},
  {id:'p2_us_vol_extreme',name:'극단변동성 차단',phase:'p2',desc:'당일 변동 6%↓ + 상승갭 제외',locked:true,conditions:{intraday_range:{min:null,max:6},gap_type:'상승갭 제외'}},
  // ── 환경 ──
  {id:'p2_us_bull_env',name:'강세장 공격',phase:'p2',desc:'시장강세 + 정배열 + MACD매수 + HH/HL + VWAP위 + 거래량폭발',locked:true,conditions:{mkt_env_state:'강세 포함 (mild_bull+bull)',ma_arrangement:'정배열 (3개)',macd_signal:'MACD > Signal (매수)',swing_structure:'HH+HL (상승구조)',vwap_position:'VWAP 위 (강세)',volume_avg20_ratio:{min:200,max:null}}},
  {id:'p2_us_bear_env',name:'약세장 방어',phase:'p2',desc:'시장약세 + RSI과매도 + MACD골든 + BB하단 + PER저평가 + 배당',locked:true,conditions:{mkt_env_state:'약세 포함 (mild_bear+bear)',rsi_value:{min:0,max:30},macd_signal:'골든크로스 (3일 이내)',bb_position:'하단 이탈',per:{min:0,max:15},dividend_yield:{min:2,max:null}}},
];

const PRESETS_US_P3 = [
  // S161-2: KR/COIN과 동일 체제 — 추세 점수 60↑ 제거, 회피 종목 추가
  {id:'p3_us_bt_verified',name:'BT 검증',phase:'p3',desc:'매매전략 60↑ + 승률 50%↑ + 거래수 3↑',locked:true,conditions:{_bt_score:{min:60,max:null},_bt_winrate:{min:50,max:null},_bt_trades:{min:3,max:null}}},
  {id:'p3_us_entry',name:'진입 적기',phase:'p3',desc:'종합행동지침 = 진입 적기',locked:true,conditions:{_bt_action:'진입 적기'}},
  {id:'p3_us_avoid',name:'회피 종목',phase:'p3',desc:'종합행동지침 = 회피',locked:true,conditions:{_bt_action:'회피'}},
];
