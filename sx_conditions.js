...
const SX_CONDITIONS = [
  ...
  {id:'engine_verdict',name:'엔진 판정',phase:'p3',groups:[
    {id:'ta_signal',name:'분석 판정',conditions:[
      ...
      {id:'_engine_buy',name:'분석엔진 매수판정',type:'select',options:['설정안함','매수 판정'],default:'설정안함',source:'calc_candle',desc:'분석엔진 종합 판정이 매수인 종목 - 배너에 🟢매수 표시된 상태',recommend:'매수 판정 선택 → 현재 강력 진입 신호 종목만 필터'},
    ]},
  ]},
  {id:'backtest',name:'백테스트',phase:'p3',groups:[
    {id:'ta_bt',name:'백테스트 (실시간)',conditions:[
      ...
      {id:'_bt_buy_marker',name:'BT 매수마커',type:'select',options:['설정안함','매수마커 있음'],default:'설정안함',source:'calc_candle',desc:'BT엔진이 오늘 매수 신호를 낸 종목 - 차트에 ▲마커 표시된 상태 (_isBuySignal=true)',recommend:'매수마커 있음 → 당일 신규 매수 진입 신호 종목만 필터'},
    ]},
  ]},
];
