...
const PRESETS_KR_P2 = [
  ...
  {id:'p2_kr_chase_defense',name:'추격매수 방어',phase:'p2',desc:'연속상승 2봉↓ + 5일 변동 20%↓ + 당일 변동 15%↓',locked:true,conditions:{consecutive_up_down:{min:null,max:2},period_change:{min:null,max:20},intraday_range:{min:null,max:15}}},
  {id:'p2_kr_sideways_avoid',name:'횡보장 회피',phase:'p2',desc:'ADX 20↑ + VHF 추세장',locked:true,conditions:{adx_value:{min:20,max:null},vhf_state:'추세장 (>0.4)'}},
...
const PRESETS_COIN_P2 = [
  ...
  {id:'p2_coin_chase_defense',name:'추격매수 방어',phase:'p2',desc:'연속상승 2봉↓ + 5일 변동 40%↓ + 당일 변동 25%↓',locked:true,conditions:{consecutive_up_down:{min:null,max:2},period_change:{min:null,max:40},intraday_range:{min:null,max:25}}},
  {id:'p2_coin_sideways_avoid',name:'횡보장 회피',phase:'p2',desc:'ADX 20↑ + VHF 추세장',locked:true,conditions:{adx_value:{min:20,max:null},vhf_state:'추세장 (>0.4)'}},
...
const PRESETS_US_P2 = [
  ...
  {id:'p2_us_chase_defense',name:'추격매수 방어',phase:'p2',desc:'연속상승 2봉↓ + 5일 변동 15%↓ + 당일 변동 10%↓',locked:true,conditions:{consecutive_up_down:{min:null,max:2},period_change:{min:null,max:15},intraday_range:{min:null,max:10}}},
  {id:'p2_us_sideways_avoid',name:'횡보장 회피',phase:'p2',desc:'ADX 20↑ + VHF 추세장',locked:true,conditions:{adx_value:{min:20,max:null},vhf_state:'추세장 (>0.4)'}},
