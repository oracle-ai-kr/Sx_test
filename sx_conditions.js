...
const PRESETS_KR_P2 = [
  ...
  {id:'p2_kr_chase_defense',name:'추격매수 방어',phase:'p2',group:'defense',desc:'5일변동 20%↓ + 거래량 300%↓ + 52주고점 -20%↓',locked:true,conditions:{period_change:{min:null,max:20},volume_avg20_ratio:{min:null,max:300},week52_high_ratio:{min:null,max:-20}}},
  {id:'p2_kr_sideways_avoid',name:'횡보장 회피',phase:'p2',group:'defense',desc:'ADX 20↑ + VHF 추세장 + MACD 매수',locked:true,conditions:{adx_value:{min:20,max:null},vhf_state:'추세장 (>0.4)',macd_signal:'MACD > Signal (매수)'}},
  {id:'p2_kr_vol_extreme',name:'극단변동성 차단',phase:'p2',group:'defense',desc:'당일 변동 8%↓ + 상승갭 제외',locked:true,conditions:{intraday_range:{min:null,max:8},gap_type:'상승갭 제외'}},
  {id:'p2_kr_breakdown',name:'위험 감지',phase:'p2',group:'defense',desc:'MA60↓ + 역배열 + VWAP↓ + EOM매도 + RSI 과매수',locked:true,conditions:{price_vs_ma:'MA60 아래',ma_arrangement:'역배열 (3개)',vwap_position:'VWAP 아래 (약세)',eom_trend:'매도세 (하락)',rsi_value:{min:70,max:null}}},
  // ── 환경 ──
...
const PRESETS_KR_P3 = [
  ...
  {id:'p3_kr_c_buy',  name:'매수',phase:'p3',desc:'C판정 매수 + BT 손익비 1.5↑ + BT MDD 25%↓',locked:true,conditions:{_bt_action:'매수',_bt_pf:{min:1.5,max:null},_bt_mdd:{min:0,max:25}}},
  {id:'p3_kr_c_watch',name:'관심',phase:'p3',desc:'C판정 관심 + BT 손익비 1.5↑ + BT MDD 25%↓',locked:true,conditions:{_bt_action:'관심',_bt_pf:{min:1.5,max:null},_bt_mdd:{min:0,max:25}}},
];
...
const PRESETS_COIN_P2 = [
  ...
  {id:'p2_coin_chase_defense',name:'추격매수 방어',phase:'p2',group:'defense',desc:'5일변동 40%↓ + 거래량 400%↓',locked:true,conditions:{period_change:{min:null,max:40},volume_avg20_ratio:{min:null,max:400}}},
  {id:'p2_coin_sideways_avoid',name:'횡보장 회피',phase:'p2',group:'defense',desc:'ADX 20↑ + VHF 추세장 + MACD 매수',locked:true,conditions:{adx_value:{min:20,max:null},vhf_state:'추세장 (>0.4)',macd_signal:'MACD > Signal (매수)'}},
  {id:'p2_coin_vol_extreme',name:'극단변동성 차단',phase:'p2',group:'defense',desc:'당일 변동 15%↓ + 상승갭 제외',locked:true,conditions:{intraday_range:{min:null,max:15},gap_type:'상승갭 제외'}},
  // ── 환경 ──
...
const PRESETS_COIN_P3 = [
  ...
  {id:'p3_coin_c_buy',  name:'매수',phase:'p3',desc:'C판정 매수 + BT 손익비 1.5↑ + BT MDD 35%↓',locked:true,conditions:{_bt_action:'매수',_bt_pf:{min:1.5,max:null},_bt_mdd:{min:0,max:35}}},
  {id:'p3_coin_c_watch',name:'관심',phase:'p3',desc:'C판정 관심 + BT 손익비 1.5↑ + BT MDD 35%↓',locked:true,conditions:{_bt_action:'관심',_bt_pf:{min:1.5,max:null},_bt_mdd:{min:0,max:35}}},
];
...
const PRESETS_US_P2 = [
  ...
  {id:'p2_us_chase_defense',name:'추격매수 방어',phase:'p2',group:'defense',desc:'5일변동 15%↓ + 거래량 250%↓ + 52주고점 -15%↓',locked:true,conditions:{period_change:{min:null,max:15},volume_avg20_ratio:{min:null,max:250},week52_high_ratio:{min:null,max:-15}}},
  {id:'p2_us_sideways_avoid',name:'횡보장 회피',phase:'p2',group:'defense',desc:'ADX 20↑ + VHF 추세장 + MACD 매수',locked:true,conditions:{adx_value:{min:20,max:null},vhf_state:'추세장 (>0.4)',macd_signal:'MACD > Signal (매수)'}},
  {id:'p2_us_vol_extreme',name:'극단변동성 차단',phase:'p2',group:'defense',desc:'당일 변동 6%↓ + 상승갭 제외',locked:true,conditions:{intraday_range:{min:null,max:6},gap_type:'상승갭 제외'}},
  // ── 환경 ──
...
const PRESETS_US_P3 = [
  ...
  {id:'p3_us_c_buy',  name:'매수',phase:'p3',desc:'C판정 매수 + BT 손익비 1.5↑ + BT MDD 25%↓',locked:true,conditions:{_bt_action:'매수',_bt_pf:{min:1.5,max:null},_bt_mdd:{min:0,max:25}}},
  {id:'p3_us_c_watch',name:'관심',phase:'p3',desc:'C판정 관심 + BT 손익비 1.5↑ + BT MDD 25%↓',locked:true,conditions:{_bt_action:'관심',_bt_pf:{min:1.5,max:null},_bt_mdd:{min:0,max:25}}},
];
