...
const SX_CONDITIONS = [
  ...
  {id:'technical',name:'기술적분석',phase:'p2',groups:[
    ...
    {id:'ta_momentum',name:'모멘텀지표',conditions:[
      ...
      {id:'rs_value',name:'RS (시장대비 강도)',type:'range',unit:'%p',min:-50,max:50,default:{min:null,max:null},source:'calc_candle',desc:'상대강도(RSI 아님) - 시장지수 대비 20일 상대수익률. 양수=시장 아웃퍼폼(강세), +5%p↑=상대강세. 일봉만 평가',recommend:'+5%p↑ (시장 대비 강세)'},
...
const COIN_CONDITIONS = [
  ...
  {id:'technical',name:'기술적분석',phase:'p2',groups:[
    ...
    {id:'ta_momentum',name:'모멘텀지표',conditions:[
      {id:'rsi_value',name:'RSI',type:'range',unit:'',min:0,max:100,default:{min:null,max:null},source:'calc_candle',desc:'상대강도지수 - 30↓=과매도(매수기회), 70↑=과매수(매도기회), 50=중립',recommend:'30↓ (과매도 반등) / 70↑ (과매수 경고)'},
      {id:'rs_value',name:'RS (BTC대비 강도)',type:'range',unit:'%p',min:-50,max:50,default:{min:null,max:null},source:'calc_candle',desc:'상대강도(RSI 아님) - BTC 대비 20일 상대수익률. 양수=BTC 아웃퍼폼(강세). BTC 자체는 0. 일봉만 평가',recommend:'+5%p↑ (BTC 대비 강세)'},
      {id:'stoch_k',name:'Stochastic %K',type:'range',unit:'',min:0,max:100,default:{min:null,max:null},source:'calc_candle',desc:'스토캐스틱 - 20↓=과매도, 80↑=과매수 (RSI보다 민감)',recommend:'20↓ (과매도) / 80↑ (과매수)'},
      {id:'psycho_value',name:'심리도',type:'range',unit:'%',min:0,max:100,default:{min:null,max:null},source:'calc_candle',desc:'12일 중 상승일 비율 - 25↓=과매도, 75↑=과매수',recommend:'25↓ (과매도) / 75↑ (과매수)'},
      {id:'ab_ratio_trend',name:'AB Ratio',type:'select',options:['설정안함','매수세 우위 (A>B)','매도세 우위 (A<B)','균형'],default:'설정안함',source:'calc_candle',desc:'고가-시가 vs 시가-저가 - 매수세 우위=장중 강세'},
      {id:'chaikin_osc',name:'Chaikin Oscillator',type:'select',options:['설정안함','양수 (매집)','음수 (분산)'],default:'설정안함',source:'calc_candle',desc:'A/D선 모멘텀 - 양수=세력 매집중, 음수=분산중'},
...
const PRESETS_KR_P3 = [
  ...
  {id:'p3_kr_c_buy',  name:'매수',phase:'p3',desc:'순수 4축 60↑ (반등신호·반등강도·추세방향·추가상승 모두 합격) — 신규 진입 최적 후보',locked:true,conditions:{_ready_score:{min:60,max:100},_entry_score:{min:60,max:100},score_range:{min:60,max:100},_upside_score:{min:60,max:100}}},
...
const PRESETS_COIN_P3 = [
  ...
  {id:'p3_coin_c_buy',  name:'매수',phase:'p3',desc:'순수 4축 60↑ (반등신호·반등강도·추세방향·추가상승 모두 합격) — 신규 진입 최적 후보',locked:true,conditions:{_ready_score:{min:60,max:100},_entry_score:{min:60,max:100},score_range:{min:60,max:100},_upside_score:{min:60,max:100}}},
...
const PRESETS_US_P3 = [
  ...
  {id:'p3_us_c_buy',  name:'매수',phase:'p3',desc:'순수 4축 60↑ (반등신호·반등강도·추세방향·추가상승 모두 합격) — 신규 진입 최적 후보',locked:true,conditions:{_ready_score:{min:60,max:100},_entry_score:{min:60,max:100},score_range:{min:60,max:100},_upside_score:{min:60,max:100}}},
