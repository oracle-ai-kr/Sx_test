...
const SX_CONDITIONS = [
  ...
  {id:'pattern',name:'패턴분석',phase:'p2',groups:[
    ...
    {id:'pat_trend',name:'단기추세 매매 (실험)',conditions:[
      {id:'trend_ma',name:'MA 기간 (단기 ↔ 장기)',type:'range',unit:'봉',min:2,max:240,default:{min:5,max:9},source:'calc_candle',desc:'단기 MA(좌) × 장기 MA(우) 크로스 기간 — 분석탭 단기추세매매와 동일하게 입력. 기본 5↔9. 매수/매도는 아래에서 선택'},
      {id:'trend_signal',name:'단기추세 신호',type:'multi_check',options:[
        {id:'trend_buy',name:'매수 (골든크로스)'},{id:'trend_sell',name:'매도 (데드크로스)'},
      ],source:'calc_candle'},
    ]},
  ]},
  ...
  {id:'engine_verdict',name:'엔진 판정',phase:'p3',groups:[
    {id:'ta_signal',name:'분석 판정',conditions:[
      ...
      {axis4:'buy',id:'_c_buy_marker',name:'매수마커 ▲',type:'select',options:['설정안함','매수마커 있음'],default:'설정안함',source:'calc_candle',desc:'A 매수마커(▲) — A 진입신호(qs.action=BUY) = 분석탭 차트 보라 ▲와 동일(S513 정합). 안전필터 🔒 위반 시 action=HOLD로 자동 제외(깨끗한 매수만).',recommend:'매수마커 있음 → 분석엔진 매수 후보 (안전필터 통과)'},
    ]},
  ]},
