...
const SX_CONDITIONS = [
  ...
  {id:'scope',name:'범위지정',phase:'p1',groups:[
    ...
    {id:'scope_basic',name:'기본 정보',conditions:[
      {id:'market_cap',name:'시가총액',type:'range',unit:'억원',min:0,max:5000000,default:{min:100,max:null},source:'krx_market_cap',desc:'기업 규모 - 작을수록 변동성 큼, 클수록 안정적'},
    ]},
  ]},
  {id:'price_analysis',name:'시세분석',phase:'p1',groups:[
    {id:'price_cond',name:'가격 조건',conditions:[
      {id:'price_range',name:'현재가 범위',type:'range',unit:'원',min:0,max:10000000,default:{min:1000,max:500000},source:'kis_price',desc:'주가 범위 제한 - 저가주/우량주 등 분리 검색 시 활용'},
      {id:'change_rate',name:'전일대비 등락률',type:'range',unit:'%',min:-30,max:30,default:{min:null,max:null},source:'kis_price',desc:'오늘 등락률 - 양수=상승 종목, 음수=하락 종목'},
    ]},
    {id:'volume_cond',name:'거래량/거래대금',conditions:[
      {id:'volume_min',name:'거래량 (당일)',type:'range',unit:'주',min:0,max:null,default:{min:50000,max:null},source:'kis_price',desc:'오늘 거래된 주식 수 - 작으면 거래 부진'},
      {id:'trade_amount',name:'거래대금',type:'range',unit:'백만원',min:0,max:null,default:{min:500,max:null},source:'kis_price',desc:'오늘 거래된 금액 - 시장 관심도 지표 (높을수록 활발)'},
    ]},
    {id:'realtime_cond',name:'실시간 시세 [KIS]',kisRequired:true,conditions:[
      {id:'bid_ask_ratio',name:'매도매수잔량비',type:'range',unit:'%',min:0,max:500,default:{min:null,max:null},source:'kis_orderbook',desc:'매수잔량÷매도잔량×100 (100%↑=매수 우세, 100%↓=매도 우세)',kisRequired:true},
      {id:'total_bid_qty',name:'총 매수잔량',type:'range',unit:'주',min:0,max:null,default:{min:null,max:null},source:'kis_orderbook',desc:'사겠다고 대기 중인 주식 수 - 클수록 매수 의지 강함',kisRequired:true},
      {id:'total_ask_qty',name:'총 매도잔량',type:'range',unit:'주',min:0,max:null,default:{min:null,max:null},source:'kis_orderbook',desc:'팔겠다고 대기 중인 주식 수 - 클수록 매도 압박 강함',kisRequired:true},
      {id:'trade_strength',name:'체결강도',type:'range',unit:'%',min:0,max:300,default:{min:null,max:null},source:'kis_conclusion',desc:'매수체결÷매도체결×100 (약세장 평균 35~45%, 강세장 55~70%)',kisRequired:true},
      {id:'buy_ratio',name:'매수비율',type:'range',unit:'%',min:0,max:100,default:{min:null,max:null},source:'kis_conclusion',desc:'전체 체결 중 매수 비중 - 50% 초과=매수 우세',kisRequired:true},
    ]},
    {id:'intraday_cond',name:'당일 분봉 [KIS]',kisRequired:true,conditions:[
      ...
      {id:'program_realtime',name:'개인 실시간 순매수',type:'range',unit:'백만원',min:null,max:null,default:{min:null,max:null},source:'kis_program',kisRequired:true,desc:'개인 투자자 순매수 금액 - 양수=개인 매수 우세 (호구잡힘 주의)'},
    ]},
  ]},
  {id:'ranking',name:'순위분석',phase:'p1',groups:[
    {id:'rank_price',name:'시세 순위',conditions:[
      {id:'rank_volume',name:'거래량 상위',type:'range',unit:'위',min:1,max:500,default:{min:null,max:null},source:'krx_market_cap',desc:'거래량 기준 상위 종목 - 거래 활발한 종목 추출'},
      {id:'rank_trade_amount',name:'거래대금 상위',type:'range',unit:'위',min:1,max:500,default:{min:null,max:null},source:'krx_market_cap',desc:'거래대금 기준 상위 종목 - 시장 관심 집중 종목'},
      {id:'rank_market_cap',name:'시가총액 상위',type:'range',unit:'위',min:1,max:2000,default:{min:null,max:null},source:'krx_market_cap',desc:'시가총액 기준 상위 종목 - 대형주/중형주 분리'},
    ]},
  ]},
  // ── Phase 2: 엔진 기반 ──
  {id:'technical',name:'기술적분석',phase:'p2',groups:[
    {id:'ta_ma',name:'이동평균선',conditions:[
      ...
      {id:'_recent_n_bars',name:'최근 N봉',type:'range',unit:'봉',min:1,max:60,default:{min:1,max:1},source:'calc_candle',desc:'조건 평가 대상 범위. MA 크로스: N봉 사이 어딘가에 교차 발생 (오늘=N2, 일주일=N7~10, 한달=N20~25). 그 외 조건: N봉 중 한 봉이라도 동시 충족 시 통과'},
    ...
    {id:'ta_channel',name:'채널/밴드',conditions:[
      ...
      {id:'recent_high_proximity',name:'최근 N봉 고점 근접도',type:'range',unit:'%',min:0,max:100,default:{min:null,max:null},source:'calc_candle',desc:'현재가÷최근N봉 고가×100. 95% 이상=고점 근접 → max 90~95로 설정 시 추격 방어. 봉수는(기본 20봉)에서 조정'},
      {id:'recent_n_change',name:'최근 N봉 대비 상승률',type:'range',unit:'%',min:-50,max:100,default:{min:null,max:null},source:'calc_candle',desc:'(현재가-N봉전 시작가)÷N봉전×100. max 15~25% 설정 시 단기 급등 추격 방어. 봉수는(기본 5봉)에서 조정'},
    ]},
  ...
  {id:'engine_verdict',name:'엔진 판정',phase:'p3',groups:[
    {id:'ta_signal',name:'분석 판정',conditions:[
      {id:'score_range',name:'추세 방향 점수',type:'range',unit:'',min:0,max:100,default:{min:null,max:null},source:'calc_candle',desc:'추세 방향 0~100 (분석탭 "추세 방향")'},
      {id:'_ready_score',name:'반등 신호 점수',type:'range',unit:'',min:0,max:100,default:{min:null,max:null},source:'calc_candle',desc:'반등 신호 0~100 (분석탭 "반등 신호" — 과매도+수축+눌림)'},
      {id:'_entry_score',name:'반등 강도 점수',type:'range',unit:'',min:0,max:100,default:{min:null,max:null},source:'calc_candle',desc:'반등 강도 0~100 (분석탭 "반등 강도" — RSI반등+MACD전환)'},
  ...
  {id:'backtest',name:'백테스트',phase:'p3',groups:[
    {id:'ta_bt',name:'백테스트 (실시간)',conditions:[
      ...
      {id:'_bt_pf',name:'BT 손익비',type:'range',unit:'',min:0,max:10,default:{min:null,max:null},source:'calc_candle',desc:'총수익/총손실 비율 (Profit Factor — PF≥2 우수, ≥1.5 양호, <1 손실 우세)'},
...
const COIN_CONDITIONS = [
  ...
  {id:'technical',name:'기술적분석',phase:'p2',groups:[
    ...
    {id:'ta_channel',name:'채널/밴드',conditions:[
      ...
      {id:'recent_high_proximity',name:'최근 N봉 고점 근접도',type:'range',unit:'%',min:0,max:100,default:{min:null,max:null},source:'calc_candle',desc:'현재가÷최근N봉 고가×100. 95% 이상=고점 근접'},
      {id:'recent_n_change',name:'최근 N봉 대비 상승률',type:'range',unit:'%',min:-50,max:100,default:{min:null,max:null},source:'calc_candle',desc:'(현재가-N봉전)÷N봉전×100. 단기 급등 추격 방어'},
    ]},
    {id:'ta_other',name:'기타 지표',conditions:[
