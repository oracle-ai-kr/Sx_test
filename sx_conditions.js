...
const PRESETS_COIN_P2 = [
  ...
  {id:'p2_coin_pullback',name:'눌림목 매수',phase:'p2',desc:'정배열 + RSI 40~55 + OBV상승 + VHF추세장',locked:true,conditions:{ma_arrangement:'정배열 (3개)',rsi_value:{min:40,max:55},obv_trend:'상승 추세',vhf_state:'추세장 (>0.4)'}},
  {id:'p2_coin_reversal',name:'과매도 반등',phase:'p2',desc:'RSI 과매도 + MACD 골든 + BB 하단 + 심리도 과매도',locked:true,conditions:{rsi_value:{min:0,max:30},macd_signal:'골든크로스 (3일 이내)',bb_position:'하단 이탈',psycho_value:{min:null,max:25}}},
...
const PRESETS_US_P2 = [
  ...
  {id:'p2_us_reversal',name:'과매도 반등',phase:'p2',desc:'RSI 과매도 + MACD 골든 + BB 하단 + 심리도 과매도',locked:true,conditions:{rsi_value:{min:0,max:30},macd_signal:'골든크로스 (3일 이내)',bb_position:'하단 이탈',psycho_value:{min:null,max:25}}},
  ...
  // ── 준비 (S161-2: 신규) ──
  {id:'p2_us_accumulation',name:'매집 감지',phase:'p2',desc:'OBV상승 + 횡보 + Chaikin매집 + 거래량↑',locked:true,conditions:{obv_trend:'상승 추세',change_rate:{min:-2,max:2},chaikin_osc:'양수 (매집)',volume_avg20_ratio:{min:120,max:null}}},
  {id:'p2_us_squeeze',name:'변동성 수축',phase:'p2',desc:'BB 스퀴즈 + VHF 횡보 + RSI 중립 + OBV 상승',locked:true,conditions:{bb_width:'스퀴즈 (수축)',vhf_state:'횡보장 (<0.3)',rsi_value:{min:40,max:60},obv_trend:'상승 추세'}},
