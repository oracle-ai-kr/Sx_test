...
const SX_CONDITIONS = [
  ...
  {id:'technical',name:'기술적분석',phase:'p2',groups:[
    ...
    {id:'ta_channel',name:'채널/밴드',conditions:[
      ...
      {id:'recent_high_proximity',name:'최근 N봉 고점 근접도',type:'range',unit:'%',min:0,max:100,default:{min:null,max:null},source:'calc_candle',desc:'현재가÷최근N봉 고가×100. 95% 이상=고점 근접 → max 90~95로 설정 시 추격 방어 (BT 게이트 highProximity와 동기화). 봉수는 sx_scan_worker.js의 _RECENT_HIGH_PROX_N(기본 20봉)에서 조정'},
      {id:'recent_n_change',name:'최근 N봉 대비 상승률',type:'range',unit:'%',min:-50,max:100,default:{min:null,max:null},source:'calc_candle',desc:'(현재가-N봉전 시작가)÷N봉전×100. max 15~25% 설정 시 단기 급등 추격 방어 (BT 게이트 recentHigh와 동기화). 봉수는 _RECENT_N_CHANGE_N(기본 5봉)에서 조정'},
    ]},
...
const COIN_CONDITIONS = [
  ...
  {id:'technical',name:'기술적분석',phase:'p2',groups:[
    ...
    {id:'ta_channel',name:'채널/밴드',conditions:[
      ...
      {id:'recent_high_proximity',name:'최근 N봉 고점 근접도',type:'range',unit:'%',min:0,max:100,default:{min:null,max:null},source:'calc_candle',desc:'현재가÷최근N봉 고가×100. 95% 이상=고점 근접 (BT 게이트 highProximity와 동기화)'},
      {id:'recent_n_change',name:'최근 N봉 대비 상승률',type:'range',unit:'%',min:-50,max:100,default:{min:null,max:null},source:'calc_candle',desc:'(현재가-N봉전)÷N봉전×100. 단기 급등 추격 방어 (BT 게이트 recentHigh와 동기화)'},
    ]},
    {id:'ta_other',name:'기타 지표',conditions:[
