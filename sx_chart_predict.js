...
(function(){
  ...
  function predict(rows, opts){
    ...
    if(picked.length < minN) return { active:false, reason:(regimeOn?curRegimeKr+' ':'')+'유사패턴 부족('+picked.length+'<'+minN+')', regimeOn:regimeOn, curRegime:curRegime, curRegimeKr:curRegimeKr, regimeMatched:regimeMatched };
