/* ════════════════════════════════════════════════════════════════════
 * sx_recipe_signal.js — [S787] 레시피 신호감지 카드 (분석탭)
...
(function(){
  ...
  // ── 역배열 · 가짜반등 (하락신호) · auto-scan JSON [S787] ──
  {id:'dc_f_01', pool:'deadcat', kind:'fake', mode:'and', label:'거래량 OSC>22.87 + RSI 상승다이버전스 + OBV 상승추세',
  ...
  {id:'dc_f_02', pool:'deadcat', kind:'fake', mode:'and', label:'골든크로스 5×20 + RSI 상승다이버전스',
   conds:[{key:'gx5_20',type:'bin'}, {key:'rsiDiv',type:'bin'}], src:{n:50,late:-0.0156,n10:0.42,surv:0.466}},
  {id:'dc_f_03', pool:'deadcat', kind:'fake', mode:'and', label:'MA60 이격도%<-11.21 + MACD 골든크로스 + 골든크로스 5×9',
   conds:[{key:'dev60',type:'num',dir:'lt',th:-11.21}, {key:'macdGc',type:'bin'}, {key:'gx5_9',type:'bin'}], src:{n:53,late:-0.0112,n10:0.434,surv:0.453}},
  {id:'dc_f_04', pool:'deadcat', kind:'fake', mode:'and', label:'RSI 상승다이버전스 + 골든크로스 5×20 + 골든크로스 5×9',
   conds:[{key:'rsiDiv',type:'bin'}, {key:'gx5_20',type:'bin'}, {key:'gx5_9',type:'bin'}], src:{n:34,late:-0.0099,n10:0.382,surv:0.488}},
  {id:'dc_f_05', pool:'deadcat', kind:'fake', mode:'and', label:'MA60 이격도%<-11.21 + MA200 이격도%<-23.12 + 골든크로스 5×9',
  ...
  {id:'dc_f_06', pool:'deadcat', kind:'fake', mode:'and', label:'거래량 OSC>22.87 + MA200 이격도%<-23.12 + MACD 골든크로스',
  ...
  {id:'dc_f_07', pool:'deadcat', kind:'fake', mode:'and', label:'ADX<14.18 + MACD 골든크로스 + 골든크로스 5×60',
   conds:[{key:'adx',type:'num',dir:'lt',th:14.18}, {key:'macdGc',type:'bin'}, {key:'gx5_60',type:'bin'}], src:{n:30,late:-0.0095,n10:0.3,surv:0.41}},
  {id:'dc_f_08', pool:'deadcat', kind:'fake', mode:'and', label:'거래량 OSC>22.87 + RSI 상승다이버전스 + MACD 골든크로스',
  ...
  {id:'dc_f_09', pool:'deadcat', kind:'fake', mode:'and', label:'ADX<14.18 + BB 스퀴즈 + 골든크로스 5×20',
  ...
  {id:'dc_f_10', pool:'deadcat', kind:'fake', mode:'and', label:'MA60 이격도%<-11.21 + MA120 이격도%<-17.06 + 골든크로스 5×9',
  ...
  {id:'dc_f_11', pool:'deadcat', kind:'fake', mode:'and', label:'MA60 이격도%<-11.21 + MFI(자금흐름)<36.84 + MACD 골든크로스',
  ...
  {id:'dc_f_12', pool:'deadcat', kind:'fake', mode:'and', label:'MA5 기울기%<-2.57 + VR(거래량비율)>176.31 + OBV 상승추세',
  ...
  {id:'dc_f_13', pool:'deadcat', kind:'fake', mode:'and', label:'거래량 OSC>22.87 + MA200 이격도%<-23.12 + OBV 상승추세',
  ...
  {id:'dc_f_14', pool:'deadcat', kind:'fake', mode:'and', label:'ADX<14.18 + 골든크로스 5×60',
   conds:[{key:'adx',type:'num',dir:'lt',th:14.18}, {key:'gx5_60',type:'bin'}], src:{n:33,late:-0.0068,n10:0.303,surv:0.436}},
  {id:'dc_f_15', pool:'deadcat', kind:'fake', mode:'and', label:'RSI 상승다이버전스 + OBV 상승추세 + 골든크로스 5×20',
   conds:[{key:'rsiDiv',type:'bin'}, {key:'obvUp',type:'bin'}, {key:'gx5_20',type:'bin'}], src:{n:40,late:-0.0067,n10:0.425,surv:0.508}},
  {id:'dc_f_16', pool:'deadcat', kind:'fake', mode:'and', label:'거래량 OSC>22.87 + Stoch %K<37.33 + VR(거래량비율)>176.31',
  ...
  {id:'dc_f_17', pool:'deadcat', kind:'fake', mode:'and', label:'골든크로스 5×20 + MACD 골든크로스 + DI 하락우위',
   conds:[{key:'gx5_20',type:'bin'}, {key:'macdGc',type:'bin'}, {key:'diBear',type:'bin'}], src:{n:88,late:-0.0059,n10:0.511,surv:0.523}},
  {id:'dc_f_18', pool:'deadcat', kind:'fake', mode:'and', label:'MA20 이격도%<-6.57 + OBV 상승다이버전스 + DI 하락우위',
  ...
  {id:'dc_f_19', pool:'deadcat', kind:'fake', mode:'and', label:'MFI(자금흐름)<36.84 + MACD 골든크로스 + DI 하락우위',
