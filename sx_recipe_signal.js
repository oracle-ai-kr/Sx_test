/* ════════════════════════════════════════════════════════════════════
 * sx_recipe_signal.js — [S832] 레시피 신호감지 카드 (분석탭)
...
(function(){
  ...
  // ════ [S834] 확장풀(115종) beam-search 신규 — 합본 검증용(ext:1). 기존+새 겹침 robust 측정. ════
  // ── deadcat-real 신규(116) ──
  ...
  async function _populate(sym){
    ...
    if(_pbK>=4){ var _sm=document.getElementById('sxRecipeSummary'); if(_sm){ _sm.innerHTML='<span style="color:#2563eb;font-weight:800">🔵 겹침 '+_pbK+' · 적중 ~67% 강</span> <span style="color:var(--text3);font-weight:500">· '+rb.ltLabel+'</span>'; } }
