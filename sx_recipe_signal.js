/* ════════════════════════════════════════════════════════════════════
 * sx_recipe_signal.js — [S784] 레시피 신호감지 카드 (분석탭)
...
(function(){
  ...
  // ── 역배열 · 가짜반등 (하락신호) · auto-scan JSON [S784] ──
  ...
  {id:'dc_f_03', pool:'deadcat', kind:'fake', mode:'and', label:'RSI 상승다이버전스 + 골든크로스 5×20 + 골든크로스 5×9',
   conds:[{key:'rsiDiv',type:'bin'}, {key:'gx5_20',type:'bin'}, {key:'gx5_9',type:'bin'}], src:{n:34,late:-0.0099,n10:0.382,surv:0.488}},
  {id:'dc_f_04', pool:'deadcat', kind:'fake', mode:'and', label:'MA60 이격도%<-11.21 + MA200 이격도%<-23.12 + 골든크로스 5×9',
  ...
  {id:'dc_f_05', pool:'deadcat', kind:'fake', mode:'and', label:'ADX<14.18 + BB 스퀴즈 + 골든크로스 5×20',
  ...
  {id:'dc_f_06', pool:'deadcat', kind:'fake', mode:'and', label:'MA60 이격도%<-11.21 + MA120 이격도%<-17.06 + 골든크로스 5×9',
  ...
  {id:'dc_f_07', pool:'deadcat', kind:'fake', mode:'and', label:'거래량 OSC>22.87 + MA200 이격도%<-23.12 + OBV 상승추세',
  ...
  {id:'dc_f_08', pool:'deadcat', kind:'fake', mode:'and', label:'ADX<14.18 + 골든크로스 5×60',
   conds:[{key:'adx',type:'num',dir:'lt',th:14.18}, {key:'gx5_60',type:'bin'}], src:{n:33,late:-0.0068,n10:0.303,surv:0.436}},
  {id:'dc_f_09', pool:'deadcat', kind:'fake', mode:'and', label:'RSI 상승다이버전스 + OBV 상승추세 + 골든크로스 5×20',
