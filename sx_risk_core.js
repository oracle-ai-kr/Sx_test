// ═══════════════════ SIGNAL X — sx_risk_core.js · v1 [S1004] ═══════════════════
...
// ★캐논: 위험 시그니처는 시장별(KR 승자가 US/COIN서 무효 — 등급사다리 역전과 동급). 침체군(ADX<15·MA60저항·고점근접)=3시장 공통 안전이라 미수록. ATR%≥10=고변동 표지(대박 동반)라 차단용 아님 → 미수록.
