...
(function(global){
  ...
  function showDiag(){
    ...
    header.innerHTML = `
      ...
      <button onclick="document.getElementById('sxsStorageDiag').remove()" style="background:none;border:none;font-size:20px;cursor:pointer;color:var(--text2,#666);padding:0 4px">×</button>
    `;
  ...
  function resetAll(){
    ...
    if(!confirm('Signal X의 모든 데이터를 초기화하시겠습니까?\n(관심종목·종목풀·분석·BT·옵티마이저·설정 전부 삭제)')) return;
