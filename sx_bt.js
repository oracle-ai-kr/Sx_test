...
function btRenderBasicResult(stock, r){
  ...
  //   [현재 색상 팔레트]
  //     - #22c55e 녹색: 기본 긍정 (수익률/평균이익 — 양수, 승률 60%↑)
  //     - #3b82f6 파랑: 승률 40~59% (중간 긍정)
  //     - #f97316 주황: 승률 20~39% (경고)
  //     - #e8365a 빨강: 승률 0~19% (위험) / MDD 20%↑ (위험) / 음수값
  ...
  const mddColor = Math.abs(r.mdd) >= 20 ? COLOR_NEG : COLOR_PURPLE;
  ...
  const _evClr = _ev >= 0 ? COLOR_POS : COLOR_NEG;
