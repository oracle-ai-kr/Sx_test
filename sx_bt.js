...
async function btRunBasic(){
  ...
  try{
    ...
    if(_canReuse){
      ...
      await _btSleep(150);
      btRenderBasicResult(stock._btResult, _btTFVal, _curOpts, _targetCount, _curParams);
      result.style.display='block';
      console.log(`[S215] ★ 분석탭 BT 재사용 — ${_targetCount}봉, 거래 ${stock._btResult.totalTrades}, 승률 ${stock._btResult.winRate}%`);
      btn.disabled = false;
