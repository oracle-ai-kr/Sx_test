// ════════════════════════════════════════════════════════════
//  SIGNAL X — BT Module v1.8 <!-- S103-fix7 Phase3-A-1 _isBuySignal/sell_signal 판정 기준 교정(entryIdx vs _totalBars 기준축 불일치 근본버그 수정, _btGetRowsLen 헬퍼+fallback) --> v1.7 <!-- S103-fix5 -->
