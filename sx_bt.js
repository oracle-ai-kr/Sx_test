...
function _mtRenderTradeRow(t){
  ...
  if(isOpen){
    ...
    pnlHtml = `<button class="mt-trade-pnl" data-sell-id="${t.id}" onclick="event.stopPropagation();mtSellById('${t.id}')" style="background:var(--hold,#f59e0b);color:#fff;border:none;padding:4px 12px;border-radius:6px;font-weight:700;font-size:11px;cursor:pointer">매도</button>`;
  } else {
