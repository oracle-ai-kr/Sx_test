// ════════════════════════════════════════════════════════════
//  SIGNAL X — Diagnostic Module v1.2 <!-- S103-fix7 Phase3-B-0 프로젝트 C 정합 진단 카테고리 추가(관찰만, UI 영향 없음) --> v1.1 <!-- S78 -->
...
function _diagProjectC(){
  ...
  // ── 종목별 체크 (currentAnalStock 있을 때만) ──

  const _stock = typeof currentAnalStock !== 'undefined' ? currentAnalStock : null;
